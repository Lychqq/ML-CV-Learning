window.REFERENCES = [
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Массив из единиц. Аналогично zeros: shape — кортеж размеров, dtype по умолчанию float64. Удобно для инициализации весов или масок перед заполнением.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px; color: #e2e8f0;'>Пример 1: Базовое использование</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Простейший пример того, как вызвать эту команду.</p><div class='code-block-container' id='code-block-numpy-np-ones-2-code-1'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155; text-align: center;\"><a href=\"https://numpy.org/doc/stable/reference/generated/numpy.ones.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 12px 24px; border-radius: 8px; text-decoration: none; font-weight: bold; transition: background 0.2s; font-size: 1.1rem; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06);\">📖 Открыть официальную документацию</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
        "initialCode": "import numpy as np\nprint(np.ones((2, 3)))",
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Массив заданной формы, все элементы равны fill_value (здесь 7).</div><div style='background-color: #1e293b; border-left: 4px solid #f59e0b; padding: 15px; margin: 20px 0; border-radius: 4px;'><h4 style='margin: 0 0 10px 0; color: #fcd34d;'>💡 Нюансы и параметры:</h4><p style='margin: 0; font-size: 0.95rem; color: #cbd5e1;'>Параметры: shape, fill_value, dtype=None. Если fill_value — целое и dtype не указан, тип будет int. Полезно для константных матриц или заполнения \"пустышкой\".</p></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px; color: #e2e8f0;'>Пример 1: Базовое использование</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Простейший пример того, как вызвать эту команду.</p><div class='code-block-container' id='code-block-numpy-np-full-3-code-1'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155; text-align: center;\"><a href=\"https://numpy.org/doc/stable/reference/generated/numpy.full.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 12px 24px; border-radius: 8px; text-decoration: none; font-weight: bold; transition: background 0.2s; font-size: 1.1rem; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06);\">📖 Открыть официальную документацию</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
        "initialCode": "import numpy as np\nprint(np.full((2, 2), 7))",
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Единичная матрица: на главной диагонали 1, остальное 0.</div><div style='background-color: #1e293b; border-left: 4px solid #f59e0b; padding: 15px; margin: 20px 0; border-radius: 4px;'><h4 style='margin: 0 0 10px 0; color: #fcd34d;'>💡 Нюансы и параметры:</h4><p style='margin: 0; font-size: 0.95rem; color: #cbd5e1;'>Параметры: N (размер), M=None (если задать — прямоугольная матрица), k=0 (сдвиг диагонали: k>0 — выше главной, k<0 — ниже). Возвращает 2D массив. Используется в линейной алгебре (обратная, системы).</p></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px; color: #e2e8f0;'>Пример 1: Базовое использование</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Простейший пример того, как вызвать эту команду.</p><div class='code-block-container' id='code-block-numpy-np-eye-4-code-1'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155; text-align: center;\"><a href=\"https://numpy.org/doc/stable/reference/generated/numpy.eye.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 12px 24px; border-radius: 8px; text-decoration: none; font-weight: bold; transition: background 0.2s; font-size: 1.1rem; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06);\">📖 Открыть официальную документацию</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
        "initialCode": "import numpy as np\nprint(np.eye(3))",
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Аналог range(), но возвращает массив: [0, 2, 4, 6, 8].</div><div style='background-color: #1e293b; border-left: 4px solid #f59e0b; padding: 15px; margin: 20px 0; border-radius: 4px;'><h4 style='margin: 0 0 10px 0; color: #fcd34d;'>💡 Нюансы и параметры:</h4><p style='margin: 0; font-size: 0.95rem; color: #cbd5e1;'>Параметры: start (по умолчанию 0), stop (обязательный, не входит в результат!), step=1, dtype=None. Из-за погрешности float лучше для дробных шагов использовать np.linspace.</p></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px; color: #e2e8f0;'>Пример 1: Базовое использование</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Простейший пример того, как вызвать эту команду.</p><div class='code-block-container' id='code-block-numpy-np-arange-5-code-1'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155; text-align: center;\"><a href=\"https://numpy.org/doc/stable/reference/generated/numpy.arange.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 12px 24px; border-radius: 8px; text-decoration: none; font-weight: bold; transition: background 0.2s; font-size: 1.1rem; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06);\">📖 Открыть официальную документацию</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Равномерно распределённые числа от start до stop включительно (если endpoint=True). Здесь 5 точек: [0., 0.25, 0.5, 0.75, 1.].</div><div style='background-color: #1e293b; border-left: 4px solid #f59e0b; padding: 15px; margin: 20px 0; border-radius: 4px;'><h4 style='margin: 0 0 10px 0; color: #fcd34d;'>💡 Нюансы и параметры:</h4><p style='margin: 0; font-size: 0.95rem; color: #cbd5e1;'>Параметры: start, stop, num=50 (число точек), endpoint=True, retstep=False, dtype=None. Идеально для сеток по оси (графики, выборка).</p></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px; color: #e2e8f0;'>Пример 1: Базовое использование</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Простейший пример того, как вызвать эту команду.</p><div class='code-block-container' id='code-block-numpy-np-linspace-6-code-1'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155; text-align: center;\"><a href=\"https://numpy.org/doc/stable/reference/generated/numpy.linspace.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 12px 24px; border-radius: 8px; text-decoration: none; font-weight: bold; transition: background 0.2s; font-size: 1.1rem; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06);\">📖 Открыть официальную документацию</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Массив заданной формы без инициализации ячеек — в памяти остаётся \"мусор\". Быстрее zeros/ones, но значения непредсказуемы до записи. Используйте, когда сразу заполняете массив целиком (избегая лишнего обнуления).</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px; color: #e2e8f0;'>Пример 1: Базовое использование</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Простейший пример того, как вызвать эту команду.</p><div class='code-block-container' id='code-block-numpy-np-empty-7-code-1'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155; text-align: center;\"><a href=\"https://numpy.org/doc/stable/reference/generated/numpy.empty.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 12px 24px; border-radius: 8px; text-decoration: none; font-weight: bold; transition: background 0.2s; font-size: 1.1rem; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06);\">📖 Открыть официальную документацию</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
        "initialCode": "import numpy as np\nprint(np.empty((2, 3)))",
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Создаёт копию массива a. Изменения в копии не затрагивают исходный массив. Параметр order='K'. Если нужна копия с другой раскладкой в памяти — order='C' или 'F'.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px; color: #e2e8f0;'>Пример 1: Базовое использование</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Простейший пример того, как вызвать эту команду.</p><div class='code-block-container' id='code-block-numpy-np-copy-8-code-1'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155; text-align: center;\"><a href=\"https://numpy.org/doc/stable/reference/generated/numpy.copy.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 12px 24px; border-radius: 8px; text-decoration: none; font-weight: bold; transition: background 0.2s; font-size: 1.1rem; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06);\">📖 Открыть официальную документацию</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
        "initialCode": "import numpy as np\nprint(np.copy(a))",
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Случайные числа из равномерного распределения на [0, 1). Форма задаётся отдельными аргументами: rand(d0, d1, d2, ...). Возвращает массив формы (2, 3). Не передавайте кортеж: rand((2,3)) даст ошибку интерпретации. Для воспроизводимости перед этим вызовите np.random.seed(42).</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px; color: #e2e8f0;'>Пример 1: Базовое использование</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Простейший пример того, как вызвать эту команду.</p><div class='code-block-container' id='code-block-numpy-np-random-rand-9-code-1'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155; text-align: center;\"><a href=\"https://numpy.org/doc/stable/reference/generated/numpy.random.rand.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 12px 24px; border-radius: 8px; text-decoration: none; font-weight: bold; transition: background 0.2s; font-size: 1.1rem; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06);\">📖 Открыть официальную документацию</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Случайные целые числа. low (включительно), high (не входит!) — диапазон; size — число или кортеж формы. Здесь числа от 0 до 9, массив 3×4. Если передать только high — low считается 0. Возвращает int по умолчанию (платформозависимо).</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px; color: #e2e8f0;'>Пример 1: Базовое использование</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Простейший пример того, как вызвать эту команду.</p><div class='code-block-container' id='code-block-numpy-np-random-randint-11-code-1'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155; text-align: center;\"><a href=\"https://numpy.org/doc/stable/reference/generated/numpy.random.randint.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 12px 24px; border-radius: 8px; text-decoration: none; font-weight: bold; transition: background 0.2s; font-size: 1.1rem; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06);\">📖 Открыть официальную документацию</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Равномерное [0, 1). В отличие от rand, размер задаётся одним числом или кортежем: random((2, 3)) или random(6). Удобно когда форма в переменной: random(shape).</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px; color: #e2e8f0;'>Пример 1: Базовое использование</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Простейший пример того, как вызвать эту команду.</p><div class='code-block-container' id='code-block-numpy-np-random-random-12-code-1'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155; text-align: center;\"><a href=\"https://numpy.org/doc/stable/reference/generated/numpy.random.random.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 12px 24px; border-radius: 8px; text-decoration: none; font-weight: bold; transition: background 0.2s; font-size: 1.1rem; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06);\">📖 Открыть официальную документацию</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Случайная выборка из массива или из range(int).</div><div style='background-color: #1e293b; border-left: 4px solid #f59e0b; padding: 15px; margin: 20px 0; border-radius: 4px;'><h4 style='margin: 0 0 10px 0; color: #fcd34d;'>💡 Нюансы и параметры:</h4><p style='margin: 0; font-size: 0.95rem; color: #cbd5e1;'>Параметры: a (массив или int), size=None (число или форма), replace=True (с возвратом или без), p=None (вероятности элементов). Возвращает массив размера size. Для replace=False размер не может быть больше длины a.</p></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px; color: #e2e8f0;'>Пример 1: Базовое использование</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Простейший пример того, как вызвать эту команду.</p><div class='code-block-container' id='code-block-numpy-np-random-choice-13-code-1'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155; text-align: center;\"><a href=\"https://numpy.org/doc/stable/reference/generated/numpy.random.choice.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 12px 24px; border-radius: 8px; text-decoration: none; font-weight: bold; transition: background 0.2s; font-size: 1.1rem; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06);\">📖 Открыть официальную документацию</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
        "initialCode": "import numpy as np\nnp.random.choice([1, 2, 3], size=5)\nprint('Результат:\\n', np.random.choice([1, 2, 3], size)",
        "solution": "",
        "hints": [],
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Перемешивает массив x по первой оси на месте (исходный массив меняется). Возвращает None. Для 1D перемешиваются элементы; для 2D — порядок строк. Чтобы не портить исходный массив, используйте np.random.permutation(x) — он возвращает новую перемешанную копию.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px; color: #e2e8f0;'>Пример 1: Базовое использование</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Простейший пример того, как вызвать эту команду.</p><div class='code-block-container' id='code-block-numpy-np-random-shuffle-14-code-1'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155; text-align: center;\"><a href=\"https://numpy.org/doc/stable/reference/generated/numpy.random.shuffle.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 12px 24px; border-radius: 8px; text-decoration: none; font-weight: bold; transition: background 0.2s; font-size: 1.1rem; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06);\">📖 Открыть официальную документацию</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Устанавливает начальное состояние генератора случайных чисел. Один и тот же seed даёт одну и ту же последовательность. Вызывайте один раз в начале скрипта (или в начале цикла экспериментов) для воспроизводимости результатов. Число 42 — произвольное, любое фиксированное подойдёт.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px; color: #e2e8f0;'>Пример 1: Базовое использование</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Простейший пример того, как вызвать эту команду.</p><div class='code-block-container' id='code-block-numpy-np-random-seed-15-code-1'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155; text-align: center;\"><a href=\"https://numpy.org/doc/stable/reference/generated/numpy.random.Generator.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 12px 24px; border-radius: 8px; text-decoration: none; font-weight: bold; transition: background 0.2s; font-size: 1.1rem; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06);\">📖 Открыть официальную документацию</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Кортеж размеров по осям. Для матрицы 3×4 вернёт (3, 4). Это атрибут — вызывается без скобок: a.shape, не a.shape(). Для 1D массив из n элементов даст (n,). Удобно проверять размерности перед операциями.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px; color: #e2e8f0;'>Пример 1: Базовое использование</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Простейший пример того, как вызвать эту команду.</p><div class='code-block-container' id='code-block-numpy-a-shape-16-code-1'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155; text-align: center;\"><a href=\"https://numpy.org/doc/stable/reference/generated/numpy.ndarray.shape.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 12px 24px; border-radius: 8px; text-decoration: none; font-weight: bold; transition: background 0.2s; font-size: 1.1rem; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06);\">📖 Открыть официальную документацию</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
        "initialCode": "import numpy as np\nprint(a.shape)",
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Число измерений (осей). 1 — вектор, 2 — матрица, 3 — тензор и т.д. Атрибут, без скобок. len(a.shape) даёт то же значение.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px; color: #e2e8f0;'>Пример 1: Базовое использование</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Простейший пример того, как вызвать эту команду.</p><div class='code-block-container' id='code-block-numpy-a-ndim-17-code-1'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155; text-align: center;\"><a href=\"'https://numpy.org/doc/stable/reference/generated/numpy.ndarray.html'\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 12px 24px; border-radius: 8px; text-decoration: none; font-weight: bold; transition: background 0.2s; font-size: 1.1rem; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06);\">📖 Открыть официальную документацию</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
        "initialCode": "import numpy as np\nprint(a.ndim)",
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Общее число элементов в массиве (произведение всех размеров shape). Атрибут. Эквивалентно np.prod(a.shape).</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px; color: #e2e8f0;'>Пример 1: Базовое использование</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Простейший пример того, как вызвать эту команду.</p><div class='code-block-container' id='code-block-numpy-a-size-18-code-1'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155; text-align: center;\"><a href=\"'https://numpy.org/doc/stable/reference/generated/numpy.ndarray.html'\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 12px 24px; border-radius: 8px; text-decoration: none; font-weight: bold; transition: background 0.2s; font-size: 1.1rem; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06);\">📖 Открыть официальную документацию</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
        "initialCode": "import numpy as np\nprint(a.size)",
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Тип данных элементов: np.float64, np.int32, np.bool_ и т.д. Только чтение. Важно при смешивании с другими типами или при сохранении в файл.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px; color: #e2e8f0;'>Пример 1: Базовое использование</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Простейший пример того, как вызвать эту команду.</p><div class='code-block-container' id='code-block-numpy-a-dtype-19-code-1'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155; text-align: center;\"><a href=\"'https://numpy.org/doc/stable/reference/generated/numpy.ndarray.dtype.html'\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 12px 24px; border-radius: 8px; text-decoration: none; font-weight: bold; transition: background 0.2s; font-size: 1.1rem; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06);\">📖 Открыть официальную документацию</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
        "initialCode": "import numpy as np\nprint(a.dtype)",
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Метод: возвращает новый массив с приведением к типу dtype. Исходный массив не меняется.</div><div style='background-color: #1e293b; border-left: 4px solid #f59e0b; padding: 15px; margin: 20px 0; border-radius: 4px;'><h4 style='margin: 0 0 10px 0; color: #fcd34d;'>💡 Нюансы и параметры:</h4><p style='margin: 0; font-size: 0.95rem; color: #cbd5e1;'>Параметры: dtype (обязательный), copy=True. При приведении float → int дробная часть отбрасывается (не округление!).</p></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px; color: #e2e8f0;'>Пример 1: Базовое использование</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Простейший пример того, как вызвать эту команду.</p><div class='code-block-container' id='code-block-numpy-a-astype-20-code-1'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155; text-align: center;\"><a href=\"https://numpy.org/doc/stable/reference/generated/numpy.ndarray.astype.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 12px 24px; border-radius: 8px; text-decoration: none; font-weight: bold; transition: background 0.2s; font-size: 1.1rem; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06);\">📖 Открыть официальную документацию</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Транспонирование: строки и столбцы меняются местами. Для 2D (матрица) — атрибут, без скобок. Возвращает вид (view), где возможно — без копии данных. Для 1D массив не меняется (тот же вид).</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px; color: #e2e8f0;'>Пример 1: Базовое использование</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Простейший пример того, как вызвать эту команду.</p><div class='code-block-container' id='code-block-numpy-a-t-21-code-1'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155; text-align: center;\"><a href=\"https://numpy.org/doc/stable/reference/generated/numpy.ndarray.T.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 12px 24px; border-radius: 8px; text-decoration: none; font-weight: bold; transition: background 0.2s; font-size: 1.1rem; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06);\">📖 Открыть официальную документацию</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
        "initialCode": "import numpy as np\nprint(a.T)",
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Один элемент: a[0] — первый (индексы с нуля); для 2D a[i, j] — элемент в строке i, столбце j. Отрицательный индекс: a[-1] — последний элемент. Возвращает скаляр (тип np — int64, float64 и т.д.).</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px; color: #e2e8f0;'>Пример 1: Базовое использование</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Простейший пример того, как вызвать эту команду.</p><div class='code-block-container' id='code-block-numpy-a-0-na-i-j-2d-22-code-1'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155; text-align: center;\"><a href=\"'https://numpy.org/doc/stable/user/basics.indexing.html'\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 12px 24px; border-radius: 8px; text-decoration: none; font-weight: bold; transition: background 0.2s; font-size: 1.1rem; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06);\">📖 Открыть официальную документацию</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
        "initialCode": "import numpy as np\na[0]\nprint(a[i, j]  # 2D)",
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Срезы: start:stop:step. stop не входит! a[1:4] — индексы 1, 2, 3. Для 2D a[0:3, 1:4] — подматрица: строки 0,1,2 и столбцы 1,2,3. Пропуск start/stop: a[:4] — с начала, a[2:] — до конца. step: a[::2] — каждый второй. Срез возвращает вид (view), изменения влияют на исходный массив.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px; color: #e2e8f0;'>Пример 1: Базовое использование</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Простейший пример того, как вызвать эту команду.</p><div class='code-block-container' id='code-block-numpy-a-1-4-na-0-3-1-4-2d-23-code-1'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155; text-align: center;\"><a href=\"'https://numpy.org/doc/stable/user/basics.indexing.html'\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 12px 24px; border-radius: 8px; text-decoration: none; font-weight: bold; transition: background 0.2s; font-size: 1.1rem; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06);\">📖 Открыть официальную документацию</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Булева маска: в скобках выражение, дающее массив булевых той же формы (a > 0, a == 5 и т.д.). Возвращается 1D массив из элементов, где условие True. Удобно фильтровать данные. Результат — копия, не вид.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px; color: #e2e8f0;'>Пример 1: Базовое использование</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Простейший пример того, как вызвать эту команду.</p><div class='code-block-container' id='code-block-numpy-a-a-0-24-code-1'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155; text-align: center;\"><a href=\"'https://numpy.org/doc/stable/user/basics.indexing.html'\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 12px 24px; border-radius: 8px; text-decoration: none; font-weight: bold; transition: background 0.2s; font-size: 1.1rem; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06);\">📖 Открыть официальную документацию</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
        "initialCode": "import numpy as np\nprint(a[a > 0])",
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Fancy indexing: передаёте список или массив индексов — получаете массив из выбранных элементов (в 1D) или строк (в 2D). a[[0, 2, 4]] — элементы с индексами 0, 2, 4. Результат — копия. Порядок в списке может быть любым, повторения допустимы.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px; color: #e2e8f0;'>Пример 1: Базовое использование</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Простейший пример того, как вызвать эту команду.</p><div class='code-block-container' id='code-block-numpy-a-0-2-4-25-code-1'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155; text-align: center;\"><a href=\"'https://numpy.org/doc/stable/user/basics.indexing.html'\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 12px 24px; border-radius: 8px; text-decoration: none; font-weight: bold; transition: background 0.2s; font-size: 1.1rem; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06);\">📖 Открыть официальную документацию</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
        "initialCode": "import numpy as np\nprint(a[[0, 2, 4]])",
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Склеивает массивы вдоль заданной оси. Первый аргумент — последовательность массивов (кортеж или список). axis=0 — добавлять по строкам (вертикально); axis=1 — по столбцам (горизонтально). Размеры по остальным осям должны совпадать. Возвращает новый массив.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px; color: #e2e8f0;'>Пример 1: Базовое использование</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Простейший пример того, как вызвать эту команду.</p><div class='code-block-container' id='code-block-numpy-np-concatenate-28-code-1'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155; text-align: center;\"><a href=\"https://numpy.org/doc/stable/reference/generated/numpy.concatenate.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 12px 24px; border-radius: 8px; text-decoration: none; font-weight: bold; transition: background 0.2s; font-size: 1.1rem; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06);\">📖 Открыть официальную документацию</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>vstack — вертикальное объединение (по оси 0): массивы ставятся друг под другом. hstack — горизонтальное (по оси 1): друг рядом. Удобные обёртки над concatenate. Для 1D массивов vstack сделает из них строки матрицы.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px; color: #e2e8f0;'>Пример 1: Базовое использование</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Простейший пример того, как вызвать эту команду.</p><div class='code-block-container' id='code-block-numpy-np-vstack-29-code-1'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155; text-align: center;\"><a href=\"https://numpy.org/doc/stable/reference/generated/numpy.vstack.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 12px 24px; border-radius: 8px; text-decoration: none; font-weight: bold; transition: background 0.2s; font-size: 1.1rem; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06);\">📖 Открыть официальную документацию</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
        "initialCode": "import numpy as np\nnp.vstack((a, b))\nprint(np.hstack((a, b)))",
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Операторы +, -, *, /, ** применяются поэлементно (element-wise). Для a * b каждый элемент умножается с соответствующим. Формы массивов должны быть совместимы: одинаковые или по правилам broadcasting (например массив (3,4) + массив (4,) — столбец повторяется по строкам). Результат — массив.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px; color: #e2e8f0;'>Пример 1: Базовое использование</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Простейший пример того, как вызвать эту команду.</p><div class='code-block-container' id='code-block-numpy-a-b-na-b-30-code-1'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155; text-align: center;\"><a href=\"'https://numpy.org/doc/stable/user/basics.broadcasting.html'\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 12px 24px; border-radius: 8px; text-decoration: none; font-weight: bold; transition: background 0.2s; font-size: 1.1rem; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06);\">📖 Открыть официальную документацию</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
        "initialCode": "import numpy as np\na + b\nprint(a * b)",
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Матричное умножение. Для 2D массивов: (A @ B)[i,j] = сумма по k A[i,k]*B[k,j]. Размеры: (n, k) @ (k, m) = (n, m). Оператор @ — то же для матриц. np.dot для 1D — скалярное произведение; для 2D — произведение матриц. Не путать с поэлементным умножением *.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px; color: #e2e8f0;'>Пример 1: Базовое использование</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Простейший пример того, как вызвать эту команду.</p><div class='code-block-container' id='code-block-numpy-np-dot-32-code-1'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155; text-align: center;\"><a href=\"https://numpy.org/doc/stable/reference/generated/numpy.dot.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 12px 24px; border-radius: 8px; text-decoration: none; font-weight: bold; transition: background 0.2s; font-size: 1.1rem; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06);\">📖 Открыть официальную документацию</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Обратная матрица A⁻¹ такая, что A @ inv(A) ≈ I. A должна быть квадратной и невырожденной (определитель ≠ 0). При плохой обусловленности возможны численные ошибки. Для решения систем лучше использовать solve.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px; color: #e2e8f0;'>Пример 1: Базовое использование</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Простейший пример того, как вызвать эту команду.</p><div class='code-block-container' id='code-block-numpy-np-linalg-inv-33-code-1'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155; text-align: center;\"><a href=\"https://numpy.org/doc/stable/reference/generated/numpy.linalg.inv.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 12px 24px; border-radius: 8px; text-decoration: none; font-weight: bold; transition: background 0.2s; font-size: 1.1rem; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06);\">📖 Открыть официальную документацию</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Решает систему линейных уравнений Ax = b. Возвращает x.</div><div style='background-color: #1e293b; border-left: 4px solid #f59e0b; padding: 15px; margin: 20px 0; border-radius: 4px;'><h4 style='margin: 0 0 10px 0; color: #fcd34d;'>💡 Нюансы и параметры:</h4><p style='margin: 0; font-size: 0.95rem; color: #cbd5e1;'>Параметры: A (матрица коэффициентов), b (вектор или матрица правых частей). Численно устойчивее, чем x = inv(A) @ b. Если b 2D, решается несколько систем с разными правыми частями.</p></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px; color: #e2e8f0;'>Пример 1: Базовое использование</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Простейший пример того, как вызвать эту команду.</p><div class='code-block-container' id='code-block-numpy-np-linalg-solve-34-code-1'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155; text-align: center;\"><a href=\"https://numpy.org/doc/stable/reference/generated/numpy.linalg.solve.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 12px 24px; border-radius: 8px; text-decoration: none; font-weight: bold; transition: background 0.2s; font-size: 1.1rem; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06);\">📖 Открыть официальную документацию</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Норма вектора или матрицы. По умолчанию ord=None — L2-норма (евклидова).</div><div style='background-color: #1e293b; border-left: 4px solid #f59e0b; padding: 15px; margin: 20px 0; border-radius: 4px;'><h4 style='margin: 0 0 10px 0; color: #fcd34d;'>💡 Нюансы и параметры:</h4><p style='margin: 0; font-size: 0.95rem; color: #cbd5e1;'>Параметры: x, ord (например 2, 1, np.inf), axis (по какой оси считать). Для вектора norm(x) — длина. Для матрицы — норма Фробениуса.</p></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px; color: #e2e8f0;'>Пример 1: Базовое использование</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Простейший пример того, как вызвать эту команду.</p><div class='code-block-container' id='code-block-numpy-np-linalg-norm-35-code-1'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155; text-align: center;\"><a href=\"https://numpy.org/doc/stable/reference/generated/numpy.linalg.norm.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 12px 24px; border-radius: 8px; text-decoration: none; font-weight: bold; transition: background 0.2s; font-size: 1.1rem; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06);\">📖 Открыть официальную документацию</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Сумма и среднее арифметическое по всем элементам (или по оси).</div><div style='background-color: #1e293b; border-left: 4px solid #f59e0b; padding: 15px; margin: 20px 0; border-radius: 4px;'><h4 style='margin: 0 0 10px 0; color: #fcd34d;'>💡 Нюансы и параметры:</h4><p style='margin: 0; font-size: 0.95rem; color: #cbd5e1;'>Параметры: a, axis=None (None — по всем элементам), dtype, keepdims. axis=0 — по столбцам (результат по строкам); axis=1 — по строкам. Вызов через np.sum(a), не a.sum() (хотя метод тоже есть).</p></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px; color: #e2e8f0;'>Пример 1: Базовое использование</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Простейший пример того, как вызвать эту команду.</p><div class='code-block-container' id='code-block-numpy-np-sum-36-code-1'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155; text-align: center;\"><a href=\"https://numpy.org/doc/stable/reference/generated/numpy.sum.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 12px 24px; border-radius: 8px; text-decoration: none; font-weight: bold; transition: background 0.2s; font-size: 1.1rem; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06);\">📖 Открыть официальную документацию</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
        "initialCode": "import numpy as np\nnp.sum(a)\nprint(np.mean(a))",
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>min/max — минимальное и максимальное значение; с axis — по оси. argmin/argmax — индекс первого минимума/максимума (в плоском виде, если axis не задан). Для 2D с axis=1 argmax по строкам даёт индекс максимума в каждой строке. Полезно для классификации (индекс класса).</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px; color: #e2e8f0;'>Пример 1: Базовое использование</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Простейший пример того, как вызвать эту команду.</p><div class='code-block-container' id='code-block-numpy-np-min-37-code-1'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155; text-align: center;\"><a href=\"https://numpy.org/doc/stable/reference/generated/numpy.min.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 12px 24px; border-radius: 8px; text-decoration: none; font-weight: bold; transition: background 0.2s; font-size: 1.1rem; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06);\">📖 Открыть официальную документацию</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
        "initialCode": "import numpy as np\nnp.min(a)\nnp.max(a)\nnp.argmin(a)\nprint(np.argmax(a))",
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Стандартное отклонение и дисперсия. Параметр ddof: ddof=0 (по умолчанию) — деление на N; ddof=1 — на N−1 (несмещённая оценка для выборки). axis — по какой оси считать. Для выборки из генеральной совокупности обычно ddof=1.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px; color: #e2e8f0;'>Пример 1: Базовое использование</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Простейший пример того, как вызвать эту команду.</p><div class='code-block-container' id='code-block-numpy-np-std-38-code-1'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155; text-align: center;\"><a href=\"https://numpy.org/doc/stable/reference/generated/numpy.std.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 12px 24px; border-radius: 8px; text-decoration: none; font-weight: bold; transition: background 0.2s; font-size: 1.1rem; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06);\">📖 Открыть официальную документацию</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
        "initialCode": "import numpy as np\nnp.std(a)\nprint(np.var(a))",
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Стандартный импорт: все функции вызываются через префикс np. (np.array, np.zeros и т.д.). NumPy — это модуль, не класс: не создаёте объект, а вызываете функции модуля. Сокращение \"np\" принято во всей документации и примерах.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px; color: #e2e8f0;'>Пример 1: Базовое использование</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Простейший пример того, как вызвать эту команду.</p><div class='code-block-container' id='code-block-numpy-import-numpy-as-np-e-39-code-1'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155; text-align: center;\"><a href=\"'https://numpy.org/doc/stable/user/absolute_beginners.html'\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 12px 24px; border-radius: 8px; text-decoration: none; font-weight: bold; transition: background 0.2s; font-size: 1.1rem; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06);\">📖 Открыть официальную документацию</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
        "initialCode": "import numpy as np\nimport numpy as np\nprint('Готово')",
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>np.sort(a) — возвращает отсортированную копию массива; исходный массив не меняется. a.sort() — сортировка на месте (исходный массив перезаписывается), возвращает None. Параметр axis: по умолчанию -1 (последняя ось). Для 2D axis=0 сортирует каждую колонку, axis=1 — каждую строку. Порядок по возрастанию.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px; color: #e2e8f0;'>Пример 1: Базовое использование</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Простейший пример того, как вызвать эту команду.</p><div class='code-block-container' id='code-block-numpy-np-sort-e-40-code-1'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155; text-align: center;\"><a href=\"https://numpy.org/doc/stable/reference/generated/numpy.sort.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 12px 24px; border-radius: 8px; text-decoration: none; font-weight: bold; transition: background 0.2s; font-size: 1.1rem; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06);\">📖 Открыть официальную документацию</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
        "initialCode": "import numpy as np\nnp.sort(a)\nprint(a.sort())",
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Возвращает массив индексов, задающих порядок сортировки по возрастанию. То есть a[np.argsort(a)] даёт отсортированный массив. Используется для сортировки по одному массиву и перестановки другого (например сортировка меток по оценкам). axis — по какой оси.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px; color: #e2e8f0;'>Пример 1: Базовое использование</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Простейший пример того, как вызвать эту команду.</p><div class='code-block-container' id='code-block-numpy-np-argsort-e-41-code-1'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155; text-align: center;\"><a href=\"https://numpy.org/doc/stable/reference/generated/numpy.argsort.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 12px 24px; border-radius: 8px; text-decoration: none; font-weight: bold; transition: background 0.2s; font-size: 1.1rem; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06);\">📖 Открыть официальную документацию</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
        "initialCode": "import numpy as np\nprint(np.argsort(a))",
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Возвращает кортеж массивов индексов, где condition истинно. Для 1D один массив: np.where(a > 0) — индексы положительных элементов. Для 2D два массива (индексы строк и столбцов). Трёхаргументная форма: np.where(cond, x, y) — где cond истинно взять x, иначе y (поэлементно).</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px; color: #e2e8f0;'>Пример 1: Базовое использование</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Простейший пример того, как вызвать эту команду.</p><div class='code-block-container' id='code-block-numpy-np-where-e-42-code-1'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155; text-align: center;\"><a href=\"https://numpy.org/doc/stable/reference/generated/numpy.where.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 12px 24px; border-radius: 8px; text-decoration: none; font-weight: bold; transition: background 0.2s; font-size: 1.1rem; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06);\">📖 Открыть официальную документацию</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Возвращает отсортированный массив уникальных значений.</div><div style='background-color: #1e293b; border-left: 4px solid #f59e0b; padding: 15px; margin: 20px 0; border-radius: 4px;'><h4 style='margin: 0 0 10px 0; color: #fcd34d;'>💡 Нюансы и параметры:</h4><p style='margin: 0; font-size: 0.95rem; color: #cbd5e1;'>Параметры: return_index (индексы первого вхождения), return_inverse (обратные индексы для восстановления), return_counts (сколько раз каждый элемент). Полезно для категориальных признаков и подсчёта уникальных меток.</p></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px; color: #e2e8f0;'>Пример 1: Базовое использование</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Простейший пример того, как вызвать эту команду.</p><div class='code-block-container' id='code-block-numpy-np-unique-e-43-code-1'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155; text-align: center;\"><a href=\"https://numpy.org/doc/stable/reference/generated/numpy.unique.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 12px 24px; border-radius: 8px; text-decoration: none; font-weight: bold; transition: background 0.2s; font-size: 1.1rem; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06);\">📖 Открыть официальную документацию</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
        "initialCode": "import numpy as np\nprint(np.unique(a))",
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Стандартный импорт: все классы и функции вызываются через pd. (pd.DataFrame, pd.read_csv, pd.Series и т.д.). Сокращение \"pd\" принято во всей документации.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px; color: #e2e8f0;'>Пример 1: Базовое использование</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Простейший пример того, как вызвать эту команду.</p><div class='code-block-container' id='code-block-pandas-import-pandas-as-pd-e-44-code-1'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155; text-align: center;\"><a href=\"'https://pandas.pydata.org/docs/getting_started/index.html'\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 12px 24px; border-radius: 8px; text-decoration: none; font-weight: bold; transition: background 0.2s; font-size: 1.1rem; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06);\">📖 Открыть официальную документацию</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Series — одномерная структура с метками (индексом). data — список или массив; index — метки (по умолчанию 0, 1, 2, ...). Один столбец DataFrame по сути Series. Используется для одной переменной или для результата выборки одного столбца.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px; color: #e2e8f0;'>Пример 1: Базовое использование</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Простейший пример того, как вызвать эту команду.</p><div class='code-block-container' id='code-block-pandas-pd-series-e-46-code-1'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155; text-align: center;\"><a href=\"https://pandas.pydata.org/docs/reference/api/pandas.Series.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 12px 24px; border-radius: 8px; text-decoration: none; font-weight: bold; transition: background 0.2s; font-size: 1.1rem; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06);\">📖 Открыть официальную документацию</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Читает лист Excel. sheet_name — номер листа (0, 1, ...) или имя листа (строка). Требует установленный openpyxl (для .xlsx) или xlrd (для .xls). Возвращает DataFrame. Несколько листов: sheet_name=None возвращает словарь {имя_листа: DataFrame}.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px; color: #e2e8f0;'>Пример 1: Базовое использование</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Простейший пример того, как вызвать эту команду.</p><div class='code-block-container' id='code-block-pandas-pd-read-excel-e-48-code-1'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155; text-align: center;\"><a href=\"https://pandas.pydata.org/docs/reference/api/pandas.read_excel.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 12px 24px; border-radius: 8px; text-decoration: none; font-weight: bold; transition: background 0.2s; font-size: 1.1rem; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06);\">📖 Открыть официальную документацию</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Методы DataFrame: сохраняют таблицу в файл. to_csv: sep=\",\", index=True (писать ли индекс), encoding. to_excel: нужен openpyxl. Возвращают None. Для больших данных to_csv быстрее и компактнее.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px; color: #e2e8f0;'>Пример 1: Базовое использование</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Простейший пример того, как вызвать эту команду.</p><div class='code-block-container' id='code-block-pandas-df-to-csv-e-49-code-1'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155; text-align: center;\"><a href=\"https://pandas.pydata.org/docs/reference/api/pandas.DataFrame.to_csv.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 12px 24px; border-radius: 8px; text-decoration: none; font-weight: bold; transition: background 0.2s; font-size: 1.1rem; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06);\">📖 Открыть официальную документацию</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Методы: первые или последние n строк таблицы. head(n=5), tail(n=5). Удобно для быстрого просмотра без вывода всего датасета. Возвращают DataFrame.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px; color: #e2e8f0;'>Пример 1: Базовое использование</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Простейший пример того, как вызвать эту команду.</p><div class='code-block-container' id='code-block-pandas-df-head-e-50-code-1'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155; text-align: center;\"><a href=\"https://pandas.pydata.org/docs/reference/api/pandas.DataFrame.head.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 12px 24px; border-radius: 8px; text-decoration: none; font-weight: bold; transition: background 0.2s; font-size: 1.1rem; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06);\">📖 Открыть официальную документацию</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
        "initialCode": "import pandas as pd\nimport numpy as np\ndf.head(5)\nprint(df.tail(5))",
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Атрибуты (без скобок). shape — кортеж (число строк, число столбцов). columns — индекс с именами столбцов (можно перебирать или df.columns = [\"a\",\"b\"]). dtypes — тип каждого столбца (int64, float64, object и т.д.).</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px; color: #e2e8f0;'>Пример 1: Базовое использование</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Простейший пример того, как вызвать эту команду.</p><div class='code-block-container' id='code-block-pandas-df-shape-ndf-columns-ndf-dtypes-e-51-code-1'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155; text-align: center;\"><a href=\"'https://pandas.pydata.org/docs/reference/api/pandas.DataFrame.html'\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 12px 24px; border-radius: 8px; text-decoration: none; font-weight: bold; transition: background 0.2s; font-size: 1.1rem; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06);\">📖 Открыть официальную документацию</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
        "initialCode": "import pandas as pd\nimport numpy as np\ndf.shape\ndf.columns\nprint(df.dtypes)",
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>info() — краткая сводка: число строк, список столбцов, типы, число непустых значений, использование памяти. describe() — статистика по числовым столбцам (count, mean, std, min, квантили, max). Для категориальных describe(include=\"object\"). Вызов: df.info(), df.describe().</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px; color: #e2e8f0;'>Пример 1: Базовое использование</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Простейший пример того, как вызвать эту команду.</p><div class='code-block-container' id='code-block-pandas-df-info-e-52-code-1'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155; text-align: center;\"><a href=\"https://pandas.pydata.org/docs/reference/api/pandas.DataFrame.info.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 12px 24px; border-radius: 8px; text-decoration: none; font-weight: bold; transition: background 0.2s; font-size: 1.1rem; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06);\">📖 Открыть официальную документацию</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
        "initialCode": "import pandas as pd\nimport numpy as np\ndf.info()\nprint(df.describe())",
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Один столбец: возвращает Series. Синтаксис df[\"col\"] работает всегда (в т.ч. если имя с пробелами). df.col — только если имя столбца без пробелов и не конфликтует с методом. Результат — ссылка на данные; изменение может изменить исходный df (осторожно с присваиванием).</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px; color: #e2e8f0;'>Пример 1: Базовое использование</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Простейший пример того, как вызвать эту команду.</p><div class='code-block-container' id='code-block-pandas-df-col-ndf-col-e-53-code-1'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155; text-align: center;\"><a href=\"'https://pandas.pydata.org/docs/user_guide/indexing.html'\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 12px 24px; border-radius: 8px; text-decoration: none; font-weight: bold; transition: background 0.2s; font-size: 1.1rem; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06);\">📖 Открыть официальную документацию</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
        "initialCode": "import pandas as pd\nimport numpy as np\ndf[\"col\"]\nprint(df.col)",
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Несколько столбцов: передаёте список имён — возвращается DataFrame с этими столбцами в указанном порядке. Удобно для подмножества признаков или перестановки столбцов.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px; color: #e2e8f0;'>Пример 1: Базовое использование</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Простейший пример того, как вызвать эту команду.</p><div class='code-block-container' id='code-block-pandas-df-col1-col2-e-54-code-1'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155; text-align: center;\"><a href=\"'https://pandas.pydata.org/docs/user_guide/indexing.html'\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 12px 24px; border-radius: 8px; text-decoration: none; font-weight: bold; transition: background 0.2s; font-size: 1.1rem; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06);\">📖 Открыть официальную документацию</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
        "initialCode": "import pandas as pd\nimport numpy as np\nprint(df[[\"col1\", \"col2\"]])",
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Доступ по меткам (labels): loc[индекс_строки, индекс_столбца]. Одна метка — скаляр; срез — подтаблица. df.loc[df[\"x\"] > 0] — фильтр строк: оставить только те, где в столбце \"x\" значение больше 0. Можно передать список меток, срез меток или булев Series (длина как у индекса).</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px; color: #e2e8f0;'>Пример 1: Базовое использование</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Простейший пример того, как вызвать эту команду.</p><div class='code-block-container' id='code-block-pandas-df-loc-0-a-ndf-loc-df-x-0-e-55-code-1'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155; text-align: center;\"><a href=\"https://pandas.pydata.org/docs/reference/api/pandas.DataFrame.loc.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 12px 24px; border-radius: 8px; text-decoration: none; font-weight: bold; transition: background 0.2s; font-size: 1.1rem; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06);\">📖 Открыть официальную документацию</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
        "initialCode": "import pandas as pd\nimport numpy as np\ndf.loc[0, \"A\"]\nprint(df.loc[df[\"x\"] > 0])",
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>isna() — DataFrame той же формы с True там, где пропуск (NaN, None). dropna() — удаляет строки (axis=0) или столбцы (axis=1) с пропусками. how=\"any\" — удалить если есть хотя бы один пропуск; how=\"all\" — только если все значения в строке/столбце пропуски. inplace=False — по умолчанию возвращает новый DataFrame.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px; color: #e2e8f0;'>Пример 1: Базовое использование</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Простейший пример того, как вызвать эту команду.</p><div class='code-block-container' id='code-block-pandas-df-isna-e-57-code-1'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155; text-align: center;\"><a href=\"https://pandas.pydata.org/docs/reference/api/pandas.DataFrame.dropna.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 12px 24px; border-radius: 8px; text-decoration: none; font-weight: bold; transition: background 0.2s; font-size: 1.1rem; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06);\">📖 Открыть официальную документацию</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Заполняет пропуски. fillna(0) — константой 0. fillna(method=\"ffill\") — forward fill: предыдущее известное значение (по столбцу). method=\"bfill\" — backward fill. limit — максимум подряд заполняемых пропусков. Возвращает новый DataFrame (или меняет inplace=True).</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px; color: #e2e8f0;'>Пример 1: Базовое использование</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Простейший пример того, как вызвать эту команду.</p><div class='code-block-container' id='code-block-pandas-df-fillna-e-58-code-1'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155; text-align: center;\"><a href=\"https://pandas.pydata.org/docs/reference/api/pandas.DataFrame.fillna.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 12px 24px; border-radius: 8px; text-decoration: none; font-weight: bold; transition: background 0.2s; font-size: 1.1rem; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06);\">📖 Открыть официальную документацию</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>groupby(\"col\") — разбивает DataFrame на группы по значениям столбца \"col\". Дальше вызывают агрегаты: .sum(), .mean(), .agg({\"other\": \"mean\", \"x\": \"sum\"}) — для каждого столбца своя функция. Результат — DataFrame с индексом по уникальным значениям \"col\". Несколько столбцов группировки: groupby([\"col1\", \"col2\"]).</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px; color: #e2e8f0;'>Пример 1: Базовое использование</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Простейший пример того, как вызвать эту команду.</p><div class='code-block-container' id='code-block-pandas-df-groupby-e-60-code-1'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155; text-align: center;\"><a href=\"https://pandas.pydata.org/docs/reference/api/pandas.DataFrame.groupby.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 12px 24px; border-radius: 8px; text-decoration: none; font-weight: bold; transition: background 0.2s; font-size: 1.1rem; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06);\">📖 Открыть официальную документацию</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Методы по умолчанию считают по столбцам (axis=0): каждая строка результата — одно число по столбцу. mean(), sum() — среднее и сумма; пропуски пропускаются. corr() — корреляционная матрица между числовыми столбцами. axis=1 — считать по строкам. Возвращают Series или DataFrame.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px; color: #e2e8f0;'>Пример 1: Базовое использование</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Простейший пример того, как вызвать эту команду.</p><div class='code-block-container' id='code-block-pandas-df-mean-e-61-code-1'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155; text-align: center;\"><a href=\"https://pandas.pydata.org/docs/reference/api/pandas.DataFrame.mean.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 12px 24px; border-radius: 8px; text-decoration: none; font-weight: bold; transition: background 0.2s; font-size: 1.1rem; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06);\">📖 Открыть официальную документацию</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
        "initialCode": "import pandas as pd\nimport numpy as np\ndf.mean()\ndf.sum()\nprint(df.corr())",
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Биологически мотивированные модели зрения: сетчатка, адаптация к освещению. Исследовательские и специализированные задачи.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px; color: #e2e8f0;'>Пример 1: Базовое использование</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Простейший пример того, как вызвать эту команду.</p><div class='code-block-container' id='code-block-opencv-bioinspired-biologically-inspired-visi-e-117-code-1'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155; text-align: center;\"><a href=\"https://docs.opencv.org/4.x/d1/dd9/group__bioinspired.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 12px 24px; border-radius: 8px; text-decoration: none; font-weight: bold; transition: background 0.2s; font-size: 1.1rem; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06);\">📖 Открыть официальную документацию</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>dnn_objdetect — готовые DNN-модели для детекции объектов (в т.ч. специфичные форматы). dnn_superres — супер-разрешение на основе нейросетей (увеличение разрешения изображения). Требуют загрузки весов; удобны для быстрого прототипа.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px; color: #e2e8f0;'>Пример 1: Базовое использование</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Простейший пример того, как вызвать эту команду.</p><div class='code-block-container' id='code-block-opencv-dnn-objdetect-dnn-superres-e-119-code-1'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155; text-align: center;\"><a href=\"https://docs.opencv.org/4.x/d2/d58/group__dnn.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 12px 24px; border-radius: 8px; text-decoration: none; font-weight: bold; transition: background 0.2s; font-size: 1.1rem; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06);\">📖 Открыть официальную документацию</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Сравнение и сопоставление форм контуров: расстояния между формами, матчинг. Для распознавания по форме объекта.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px; color: #e2e8f0;'>Пример 1: Базовое использование</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Простейший пример того, как вызвать эту команду.</p><div class='code-block-container' id='code-block-opencv-shape-shape-distance-and-matching-e-131-code-1'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155; text-align: center;\"><a href=\"https://docs.opencv.org/4.x/d1/dd9/group__shape.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 12px 24px; border-radius: 8px; text-decoration: none; font-weight: bold; transition: background 0.2s; font-size: 1.1rem; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06);\">📖 Открыть официальную документацию</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Стереосоответствие: построение карты глубины из стереопары. Алгоритмы блочного матчинга и др. Дополняет calib3d для полного стереопайплайна.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px; color: #e2e8f0;'>Пример 1: Базовое использование</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Простейший пример того, как вызвать эту команду.</p><div class='code-block-container' id='code-block-opencv-stereo-stereo-correspondence-e-132-code-1'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155; text-align: center;\"><a href=\"https://docs.opencv.org/4.x/d1/dd9/group__stereo.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 12px 24px; border-radius: 8px; text-decoration: none; font-weight: bold; transition: background 0.2s; font-size: 1.1rem; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06);\">📖 Открыть официальную документацию</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
        "initialCode": "import cv2\nimport numpy as np\n\n# Создаем фейковые стерео-изображения\nimgL = np.random.randint(0, 256, (100, 100), dtype=np.uint8)\nimgR = np.random.randint(0, 256, (100, 100), dtype=np.uint8)\n\n# Block Matching\nstereo = cv2.StereoBM_create(numDisparities=16, blockSize=15)\ndisparity = stereo.compute(imgL, imgR)\n\nprint('Карта глубин вычислена!')\nprint('Shape:', disparity.shape)",
        "solution": "",
        "hints": [],
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Дополнительные 2D-признаки: SIFT, SURF (в non-free части), BRIEF, FREAK и др. Расширяет features2d; часть алгоритмов может требовать отдельной сборки (contrib).</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px; color: #e2e8f0;'>Пример 1: Базовое использование</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Простейший пример того, как вызвать эту команду.</p><div class='code-block-container' id='code-block-opencv-xfeatures2d-extra-2d-features-e-141-code-1'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155; text-align: center;\"><a href=\"https://docs.opencv.org/4.x/d1/dd9/group__xfeatures2d.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 12px 24px; border-radius: 8px; text-decoration: none; font-weight: bold; transition: background 0.2s; font-size: 1.1rem; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06);\">📖 Открыть официальную документацию</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Дополнительные алгоритмы обработки фото: коррекция баланса белого, инпейнтинг, тонирование. Расширяет модуль photo.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px; color: #e2e8f0;'>Пример 1: Базовое использование</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Простейший пример того, как вызвать эту команду.</p><div class='code-block-container' id='code-block-opencv-xphoto-additional-photo-processing-e-143-code-1'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155; text-align: center;\"><a href=\"https://docs.opencv.org/4.x/d1/dd9/group__xphoto.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 12px 24px; border-radius: 8px; text-decoration: none; font-weight: bold; transition: background 0.2s; font-size: 1.1rem; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06);\">📖 Открыть официальную документацию</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Регрессия с предсказанием не только среднего, но и дисперсии. Вход: предсказание и дисперсия (или лог-дисперсия); target — истинное значение. Полезно для оценки неопределённости.<br><strong>Когда использовать:</strong> когда нужна уверенность модели (uncertainty).</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px; color: #e2e8f0;'>Пример 1: Базовое использование</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Простейший пример того, как вызвать эту команду.</p><div class='code-block-container' id='code-block-pytorch-nn-gaussiannllloss-e-153-code-1'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155; text-align: center;\"><a href=\"PT_G + 'torch.nn.GaussianNLLLoss.html'\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 12px 24px; border-radius: 8px; text-decoration: none; font-weight: bold; transition: background 0.2s; font-size: 1.1rem; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06);\">📖 Открыть официальную документацию</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Kullback–Leibler divergence между двумя распределениями. Вход — логарифмы вероятностей (логиты после log_softmax), target — вероятности. Reduction: \"batchmean\" для совместимости с формулой. Используется в VAE, дистилляции, когда нужно приблизить одно распределение к другому.<br><strong>Когда использовать:</strong> дистилляция моделей, VAE.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px; color: #e2e8f0;'>Пример 1: Базовое использование</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Простейший пример того, как вызвать эту команду.</p><div class='code-block-container' id='code-block-pytorch-nn-kldivloss-e-154-code-1'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155; text-align: center;\"><a href=\"PT_G + 'torch.nn.KLDivLoss.html'\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 12px 24px; border-radius: 8px; text-decoration: none; font-weight: bold; transition: background 0.2s; font-size: 1.1rem; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06);\">📖 Открыть официальную документацию</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
        "initialCode": "import torch\nimport torch.nn as nn\nprint(nn.KLDivLoss())",
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Ranking: на входе два тензора x1, x2 и метки target (1 или −1). Loss поощряет: если target=1, то x1 > x2; если −1, то x1 < x2. Используется в рекомендациях, ранжировании.<br><strong>Когда использовать:</strong> learning to rank, рекомендации.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px; color: #e2e8f0;'>Пример 1: Базовое использование</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Простейший пример того, как вызвать эту команду.</p><div class='code-block-container' id='code-block-pytorch-nn-marginrankingloss-e-157-code-1'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155; text-align: center;\"><a href=\"PT_G + 'torch.nn.MarginRankingLoss.html'\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 12px 24px; border-radius: 8px; text-decoration: none; font-weight: bold; transition: background 0.2s; font-size: 1.1rem; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06);\">📖 Открыть официальную документацию</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Для меток ±1: если target=1, loss = max(0, margin − x); если −1, loss = max(0, x). Параметр margin по умолчанию 1. Используется в метрическом обучении, эмбеддингах.<br><strong>Когда использовать:</strong> когда нужны эмбеддинги с большим отступом между классами.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px; color: #e2e8f0;'>Пример 1: Базовое использование</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Простейший пример того, как вызвать эту команду.</p><div class='code-block-container' id='code-block-pytorch-nn-hingeembeddingloss-e-158-code-1'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155; text-align: center;\"><a href=\"PT_G + 'torch.nn.HingeEmbeddingLoss.html'\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 12px 24px; border-radius: 8px; text-decoration: none; font-weight: bold; transition: background 0.2s; font-size: 1.1rem; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06);\">📖 Открыть официальную документацию</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Multi-label классификация с margin: у одного объекта может быть несколько правильных классов. Вход — 2D тензор, target — индексы правильных классов (не one-hot). Специфичный формат target; см. документацию.<br><strong>Когда использовать:</strong> несколько меток на объект (теги, категории).</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px; color: #e2e8f0;'>Пример 1: Базовое использование</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Простейший пример того, как вызвать эту команду.</p><div class='code-block-container' id='code-block-pytorch-nn-multilabelmarginloss-e-159-code-1'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155; text-align: center;\"><a href=\"PT_G + 'torch.nn.MultiLabelMarginLoss.html'\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 12px 24px; border-radius: 8px; text-decoration: none; font-weight: bold; transition: background 0.2s; font-size: 1.1rem; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06);\">📖 Открыть официальную документацию</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Похож на Huber: при |error| < beta — квадратичная часть, иначе линейная. Регрессия, устойчивость к выбросам. Параметр beta (по умолчанию 1). Часто используется в детекции объектов (bounding box regression).<br><strong>Когда использовать:</strong> регрессия координат, боксов.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px; color: #e2e8f0;'>Пример 1: Базовое использование</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Простейший пример того, как вызвать эту команду.</p><div class='code-block-container' id='code-block-pytorch-nn-smoothl1loss-e-161-code-1'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155; text-align: center;\"><a href=\"PT_G + 'torch.nn.SmoothL1Loss.html'\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 12px 24px; border-radius: 8px; text-decoration: none; font-weight: bold; transition: background 0.2s; font-size: 1.1rem; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06);\">📖 Открыть официальную документацию</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Двухклассовый логистический loss. Метки target: +1 или −1. Вход — один тензор (разность или оценка). Реже используется чем BCEWithLogitsLoss.<br><strong>Когда использовать:</strong> бинарная классификация с метками ±1.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px; color: #e2e8f0;'>Пример 1: Базовое использование</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Простейший пример того, как вызвать эту команду.</p><div class='code-block-container' id='code-block-pytorch-nn-softmarginloss-e-162-code-1'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155; text-align: center;\"><a href=\"PT_G + 'torch.nn.SoftMarginLoss.html'\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 12px 24px; border-radius: 8px; text-decoration: none; font-weight: bold; transition: background 0.2s; font-size: 1.1rem; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06);\">📖 Открыть официальную документацию</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Multi-label классификация: для каждого класса своя бинарная задача (one-vs-rest). Вход — логиты [N, C], target — бинарная матрица [N, C] (0 или 1).</div><div style='background-color: #1e293b; border-left: 4px solid #f59e0b; padding: 15px; margin: 20px 0; border-radius: 4px;'><h4 style='margin: 0 0 10px 0; color: #fcd34d;'>💡 Нюансы и параметры:</h4><p style='margin: 0; font-size: 0.95rem; color: #cbd5e1;'>Параметры: weight, reduction.<br><strong>Когда использовать:</strong> несколько независимых меток на объект.</p></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px; color: #e2e8f0;'>Пример 1: Базовое использование</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Простейший пример того, как вызвать эту команду.</p><div class='code-block-container' id='code-block-pytorch-nn-multilabelsoftmarginloss-e-163-code-1'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155; text-align: center;\"><a href=\"PT_G + 'torch.nn.MultiLabelSoftMarginLoss.html'\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 12px 24px; border-radius: 8px; text-decoration: none; font-weight: bold; transition: background 0.2s; font-size: 1.1rem; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06);\">📖 Открыть официальную документацию</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Измеряет косинусное сходство между векторами x1 и x2. Target: 1 — векторы должны быть похожи, −1 — различаться. Параметр margin. Используется в эмбеддингах, сравнении пар.<br><strong>Когда использовать:</strong> сходство текстов/изображений, siamese сети.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px; color: #e2e8f0;'>Пример 1: Базовое использование</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Простейший пример того, как вызвать эту команду.</p><div class='code-block-container' id='code-block-pytorch-nn-cosineembeddingloss-e-164-code-1'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155; text-align: center;\"><a href=\"PT_G + 'torch.nn.CosineEmbeddingLoss.html'\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 12px 24px; border-radius: 8px; text-decoration: none; font-weight: bold; transition: background 0.2s; font-size: 1.1rem; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06);\">📖 Открыть официальную документацию</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Тот же triplet, но функцию расстояния можно задать своей (distance_function). По умолчанию — Lp. Гибкость для кастомных метрик.<br><strong>Когда использовать:</strong> когда нужно своё расстояние в triplet loss.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px; color: #e2e8f0;'>Пример 1: Базовое использование</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Простейший пример того, как вызвать эту команду.</p><div class='code-block-container' id='code-block-pytorch-nn-tripletmarginwithdistanceloss-e-167-code-1'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155; text-align: center;\"><a href=\"PT_G + 'torch.nn.TripletMarginWithDistanceLoss.html'\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 12px 24px; border-radius: 8px; text-decoration: none; font-weight: bold; transition: background 0.2s; font-size: 1.1rem; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06);\">📖 Открыть официальную документацию</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Adagrad: уменьшает lr для параметров с большей историей градиентов.</div><div style='background-color: #1e293b; border-left: 4px solid #f59e0b; padding: 15px; margin: 20px 0; border-radius: 4px;'><h4 style='margin: 0 0 10px 0; color: #fcd34d;'>💡 Нюансы и параметры:</h4><p style='margin: 0; font-size: 0.95rem; color: #cbd5e1;'>Параметры: lr, lr_decay, eps. Подходит для разрежённых данных (NLP); для плотных данных часто lr падает слишком сильно.<br><strong>Когда использовать:</strong> разрежённые градиенты, рекомендации.</p></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px; color: #e2e8f0;'>Пример 1: Базовое использование</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Простейший пример того, как вызвать эту команду.</p><div class='code-block-container' id='code-block-pytorch-torch-optim-adagrad-e-171-code-1'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155; text-align: center;\"><a href=\"PT_G + 'torch.optim.Adagrad.html'\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 12px 24px; border-radius: 8px; text-decoration: none; font-weight: bold; transition: background 0.2s; font-size: 1.1rem; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06);\">📖 Открыть официальную документацию</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>RMSprop: скользящее среднее квадратов градиентов; lr делится на корень из этого среднего.</div><div style='background-color: #1e293b; border-left: 4px solid #f59e0b; padding: 15px; margin: 20px 0; border-radius: 4px;'><h4 style='margin: 0 0 10px 0; color: #fcd34d;'>💡 Нюансы и параметры:</h4><p style='margin: 0; font-size: 0.95rem; color: #cbd5e1;'>Параметры: lr, alpha (затухание), eps. Популярен в reinforcement learning; основа для Adam.<br><strong>Когда использовать:</strong> RL, RNN; иногда как замена Adam.</p></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px; color: #e2e8f0;'>Пример 1: Базовое использование</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Простейший пример того, как вызвать эту команду.</p><div class='code-block-container' id='code-block-pytorch-torch-optim-rmsprop-e-173-code-1'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155; text-align: center;\"><a href=\"PT_G + 'torch.optim.RMSprop.html'\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 12px 24px; border-radius: 8px; text-decoration: none; font-weight: bold; transition: background 0.2s; font-size: 1.1rem; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06);\">📖 Открыть официальную документацию</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
        "initialCode": "import torch\nimport torch.nn as nn\ntorch.optim.RMSprop(params, lr=1e-2, alpha=0.99)\nprint('Результат:\\n', torch.optim.RMSprop(params, lr)",
        "solution": "",
        "hints": [],
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Rprop: обновление только по знаку градиента; размер шага адаптируется отдельно. Работает только с батчем (не мини-батчем). В PyTorch редко используется.<br><strong>Когда использовать:</strong> полный батч, маленькие сети.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px; color: #e2e8f0;'>Пример 1: Базовое использование</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Простейший пример того, как вызвать эту команду.</p><div class='code-block-container' id='code-block-pytorch-torch-optim-rprop-e-174-code-1'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155; text-align: center;\"><a href=\"PT_G + 'torch.optim.Rprop.html'\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 12px 24px; border-radius: 8px; text-decoration: none; font-weight: bold; transition: background 0.2s; font-size: 1.1rem; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06);\">📖 Открыть официальную документацию</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
        "initialCode": "import torch\nimport torch.nn as nn\ntorch.optim.Rprop(params, lr=1e-2)\nprint('Результат:\\n', torch.optim.Rprop(params, lr)",
        "solution": "",
        "hints": [],
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Adamax: вариант Adam на основе бесконечной нормы (max) вместо L2.</div><div style='background-color: #1e293b; border-left: 4px solid #f59e0b; padding: 15px; margin: 20px 0; border-radius: 4px;'><h4 style='margin: 0 0 10px 0; color: #fcd34d;'>💡 Нюансы и параметры:</h4><p style='margin: 0; font-size: 0.95rem; color: #cbd5e1;'>Параметры: lr, betas, eps. Иногда более стабилен при очень длинных последовательностях.<br><strong>Когда использовать:</strong> длинные последовательности, когда Adam нестабилен.</p></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px; color: #e2e8f0;'>Пример 1: Базовое использование</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Простейший пример того, как вызвать эту команду.</p><div class='code-block-container' id='code-block-pytorch-torch-optim-adamax-e-175-code-1'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155; text-align: center;\"><a href=\"PT_G + 'torch.optim.Adamax.html'\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 12px 24px; border-radius: 8px; text-decoration: none; font-weight: bold; transition: background 0.2s; font-size: 1.1rem; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06);\">📖 Открыть официальную документацию</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
        "initialCode": "import torch\nimport torch.nn as nn\ntorch.optim.Adamax(params, lr=2e-3)\nprint('Результат:\\n', torch.optim.Adamax(params, lr)",
        "solution": "",
        "hints": [],
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>NAdam: Adam + Nesterov momentum (look-ahead).</div><div style='background-color: #1e293b; border-left: 4px solid #f59e0b; padding: 15px; margin: 20px 0; border-radius: 4px;'><h4 style='margin: 0 0 10px 0; color: #fcd34d;'>💡 Нюансы и параметры:</h4><p style='margin: 0; font-size: 0.95rem; color: #cbd5e1;'>Параметры: lr, betas, eps. Часто чуть быстрее сходится чем Adam.<br><strong>Когда использовать:</strong> альтернатива Adam с Nesterov.</p></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px; color: #e2e8f0;'>Пример 1: Базовое использование</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Простейший пример того, как вызвать эту команду.</p><div class='code-block-container' id='code-block-pytorch-torch-optim-nadam-e-178-code-1'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155; text-align: center;\"><a href=\"PT_G + 'torch.optim.NAdam.html'\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 12px 24px; border-radius: 8px; text-decoration: none; font-weight: bold; transition: background 0.2s; font-size: 1.1rem; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06);\">📖 Открыть официальную документацию</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
        "initialCode": "import torch\nimport torch.nn as nn\ntorch.optim.NAdam(params, lr=2e-3)\nprint('Результат:\\n', torch.optim.NAdam(params, lr)",
        "solution": "",
        "hints": [],
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Rectified Adam: корректирует дисперсию в начале обучения (warmup по сути встроен).</div><div style='background-color: #1e293b; border-left: 4px solid #f59e0b; padding: 15px; margin: 20px 0; border-radius: 4px;'><h4 style='margin: 0 0 10px 0; color: #fcd34d;'>💡 Нюансы и параметры:</h4><p style='margin: 0; font-size: 0.95rem; color: #cbd5e1;'>Параметры: lr, betas, eps. Уменьшает необходимость в ручном warmup.<br><strong>Когда использовать:</strong> когда не хотите настраивать warmup вручную.</p></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px; color: #e2e8f0;'>Пример 1: Базовое использование</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Простейший пример того, как вызвать эту команду.</p><div class='code-block-container' id='code-block-pytorch-torch-optim-radam-e-179-code-1'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155; text-align: center;\"><a href=\"PT_G + 'torch.optim.RAdam.html'\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 12px 24px; border-radius: 8px; text-decoration: none; font-weight: bold; transition: background 0.2s; font-size: 1.1rem; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06);\">📖 Открыть официальную документацию</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
        "initialCode": "import torch\nimport torch.nn as nn\ntorch.optim.RAdam(params, lr=1e-3)\nprint('Результат:\\n', torch.optim.RAdam(params, lr)",
        "solution": "",
        "hints": [],
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Adam для разрежённых градиентов: обновляет только те параметры, у которых градиент ненулевой. Экономит память и время при очень разрежённых обновлениях.<br><strong>Когда использовать:</strong> эмбеддинги с огромным словарём, разрежённые обновления.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px; color: #e2e8f0;'>Пример 1: Базовое использование</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Простейший пример того, как вызвать эту команду.</p><div class='code-block-container' id='code-block-pytorch-torch-optim-sparseadam-e-180-code-1'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155; text-align: center;\"><a href=\"PT_G + 'torch.optim.SparseAdam.html'\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 12px 24px; border-radius: 8px; text-decoration: none; font-weight: bold; transition: background 0.2s; font-size: 1.1rem; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06);\">📖 Открыть официальную документацию</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
        "initialCode": "import torch\nimport torch.nn as nn\ntorch.optim.SparseAdam(params, lr=1e-3)\nprint('Результат:\\n', torch.optim.SparseAdam(params, lr)",
        "solution": "",
        "hints": [],
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Adafactor: адаптивный метод с меньшим числом гиперпараметров и меньшим потреблением памяти (моменты хранятся в факторизованном виде). Подходит для очень больших моделей.<br><strong>Когда использовать:</strong> большие трансформеры, нехватка памяти.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px; color: #e2e8f0;'>Пример 1: Базовое использование</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Простейший пример того, как вызвать эту команду.</p><div class='code-block-container' id='code-block-pytorch-torch-optim-adafactor-e-181-code-1'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155; text-align: center;\"><a href=\"PT_G + 'torch.optim.Adafactor.html'\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 12px 24px; border-radius: 8px; text-decoration: none; font-weight: bold; transition: background 0.2s; font-size: 1.1rem; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06);\">📖 Открыть официальную документацию</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Muon: новый оптимизатор из PyTorch (на основе теории динамики).</div><div style='background-color: #1e293b; border-left: 4px solid #f59e0b; padding: 15px; margin: 20px 0; border-radius: 4px;'><h4 style='margin: 0 0 10px 0; color: #fcd34d;'>💡 Нюансы и параметры:</h4><p style='margin: 0; font-size: 0.95rem; color: #cbd5e1;'>Параметры: lr, momentum и др. Экспериментальный; см. актуальную документацию.<br><strong>Когда использовать:</strong> эксперименты, сравнение с Adam/SGD.</p></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px; color: #e2e8f0;'>Пример 1: Базовое использование</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Простейший пример того, как вызвать эту команду.</p><div class='code-block-container' id='code-block-pytorch-torch-optim-muon-e-182-code-1'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155; text-align: center;\"><a href=\"PT_G + 'torch.optim.Muon.html'\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 12px 24px; border-radius: 8px; text-decoration: none; font-weight: bold; transition: background 0.2s; font-size: 1.1rem; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06);\">📖 Открыть официальную документацию</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
        "initialCode": "import torch\nimport torch.nn as nn\ntorch.optim.Muon(params, lr=1e-3)\nprint('Результат:\\n', torch.optim.Muon(params, lr)",
        "solution": "",
        "hints": [],
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Базовые активации. ReLU(x) = max(0, x) — стандартная, но страдает от \"умирающих\" нейронов. LeakyReLU — пропускает небольшой градиент для x<0. ELU — сглаживает излом в нуле (улучшает сходимость, но чуть медленнее вычисляется).</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px; color: #e2e8f0;'>Пример 1: Базовое использование</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Простейший пример того, как вызвать эту команду.</p><div class='code-block-container' id='code-block-pytorch-import-torch-nimport-torch-nn-as-nn-nx-e-188-code-1'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155; text-align: center;\"><a href=\"https://pytorch.org/docs/stable/nn.html#non-linear-activations-weighted-sum-nonlinearity, true\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 12px 24px; border-radius: 8px; text-decoration: none; font-weight: bold; transition: background 0.2s; font-size: 1.1rem; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06);\">📖 Открыть официальную документацию</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Современные гладкие активации (стандарт для трансформеров и глубоких CNN). SiLU (Swish): x * sigmoid(x), используется в YOLOv5/v8, EfficientNet. GELU: x * Phi(x), стандарт в BERT, GPT, ViT. Mish: x * tanh(softplus(x)), показывает отличные результаты в комп. зрении.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px; color: #e2e8f0;'>Пример 1: Базовое использование</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Простейший пример того, как вызвать эту команду.</p><div class='code-block-container' id='code-block-pytorch-import-torch-nimport-torch-nn-as-nn-nx-e-189-code-1'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155; text-align: center;\"><a href=\"https://pytorch.org/docs/stable/nn.html#non-linear-activations-weighted-sum-nonlinearity, true\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 12px 24px; border-radius: 8px; text-decoration: none; font-weight: bold; transition: background 0.2s; font-size: 1.1rem; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06);\">📖 Открыть официальную документацию</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Ограничивающие активации. Sigmoid -> [0, 1] — для бинарной классификации (выходного слоя) или шлюзов (LSTM). Tanh -> [-1, 1] — центрирует данные, лучше сигмоиды для скрытых слоев. Softmax -> сумма=1 (распределение вероятностей по классам).</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px; color: #e2e8f0;'>Пример 1: Базовое использование</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Простейший пример того, как вызвать эту команду.</p><div class='code-block-container' id='code-block-pytorch-import-torch-nimport-torch-nn-as-nn-nx-e-190-code-1'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155; text-align: center;\"><a href=\"https://pytorch.org/docs/stable/nn.html#non-linear-activations-weighted-sum-nonlinearity, true\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 12px 24px; border-radius: 8px; text-decoration: none; font-weight: bold; transition: background 0.2s; font-size: 1.1rem; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06);\">📖 Открыть официальную документацию</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Стандартный цикл обучения в PyTorch. Обязательно model.train() перед эпохой (важно для Dropout/BatchNorm). Сначала zero_grad(), иначе градиенты будут накапливаться с предыдущего шага.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px; color: #e2e8f0;'>Пример 1: Базовое использование</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Простейший пример того, как вызвать эту команду.</p><div class='code-block-container' id='code-block-pytorch-import-torch-nimport-torch-nn-as-nn-n-m-e-191-code-1'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155; text-align: center;\"><a href=\"https://pytorch.org/docs/stable/optim.html, true\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 12px 24px; border-radius: 8px; text-decoration: none; font-weight: bold; transition: background 0.2s; font-size: 1.1rem; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06);\">📖 Открыть официальную документацию</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Стандартный цикл валидации или инференса. Обязательно torch.no_grad() — чтобы не тратить память на сохранение вычислительного графа. model.eval() переводит слои в режим тестирования.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px; color: #e2e8f0;'>Пример 1: Базовое использование</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Простейший пример того, как вызвать эту команду.</p><div class='code-block-container' id='code-block-pytorch-import-torch-n-model-eval-e-192-code-1'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155; text-align: center;\"><a href=\"https://pytorch.org/docs/stable/autograd.html, true\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 12px 24px; border-radius: 8px; text-decoration: none; font-weight: bold; transition: background 0.2s; font-size: 1.1rem; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06);\">📖 Открыть официальную документацию</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Свой класс Dataset. Нужно реализовать __len__ (сколько всего элементов) и __getitem__ (как получить элемент по индексу). Можно в __getitem__ читать картинки с диска, чтобы не грузить всё в ОЗУ.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px; color: #e2e8f0;'>Пример 1: Базовое использование</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Простейший пример того, как вызвать эту команду.</p><div class='code-block-container' id='code-block-pytorch-import-torch-nfrom-torch-utils-data-impo-e-193-code-1'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155; text-align: center;\"><a href=\"https://pytorch.org/docs/stable/data.html, true\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 12px 24px; border-radius: 8px; text-decoration: none; font-weight: bold; transition: background 0.2s; font-size: 1.1rem; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06);\">📖 Открыть официальную документацию</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>DataLoader — оборачивает Dataset и разбивает на батчи (куски данных). shuffle=True — перемешивание (для train). num_workers — загрузка данных в несколько потоков (параллельно).</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px; color: #e2e8f0;'>Пример 1: Базовое использование</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Простейший пример того, как вызвать эту команду.</p><div class='code-block-container' id='code-block-pytorch-import-torch-nfrom-torch-utils-data-impo-e-194-code-1'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155; text-align: center;\"><a href=\"https://pytorch.org/docs/stable/data.html, true\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 12px 24px; border-radius: 8px; text-decoration: none; font-weight: bold; transition: background 0.2s; font-size: 1.1rem; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06);\">📖 Открыть официальную документацию</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Простая свёрточная сеть (CNN). Conv2d(входы, выходы, ядро). MaxPool2d(2,2) уменьшает картинку в 2 раза по осям H,W. Перед Linear нужно сплющить (flatten) тензор с помощью .view(B, -1) или nn.Flatten.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px; color: #e2e8f0;'>Пример 1: Базовое использование</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Простейший пример того, как вызвать эту команду.</p><div class='code-block-container' id='code-block-pytorch-import-torch-nimport-torch-nn-as-nn-ncla-e-196-code-1'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155; text-align: center;\"><a href=\"https://pytorch.org/docs/stable/nn.html, true\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 12px 24px; border-radius: 8px; text-decoration: none; font-weight: bold; transition: background 0.2s; font-size: 1.1rem; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06);\">📖 Открыть официальную документацию</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Рекуррентные сети (RNN/GRU/LSTM). input_size — размер одного слова/шага. hidden_size — скрытое состояние. batch_first=True означает, что батч идёт первой осью (по умолчанию он второй!).</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px; color: #e2e8f0;'>Пример 1: Базовое использование</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Простейший пример того, как вызвать эту команду.</p><div class='code-block-container' id='code-block-pytorch-import-torch-nimport-torch-nn-as-nn-n-l-e-197-code-1'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155; text-align: center;\"><a href=\"https://pytorch.org/docs/stable/nn.html, true\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 12px 24px; border-radius: 8px; text-decoration: none; font-weight: bold; transition: background 0.2s; font-size: 1.1rem; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06);\">📖 Открыть официальную документацию</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Использование предобученных сетей через torchvision. Загружаем веса ImageNet, замораживаем слои (при необходимости), меняем последний Linear/classifier слой под кол-во классов в датасете.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px; color: #e2e8f0;'>Пример 1: Базовое использование</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Простейший пример того, как вызвать эту команду.</p><div class='code-block-container' id='code-block-pytorch-import-torch-nimport-torch-nn-as-nn-nimp-e-199-code-1'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155; text-align: center;\"><a href=\"https://pytorch.org/docs/stable/hub.html, true\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 12px 24px; border-radius: 8px; text-decoration: none; font-weight: bold; transition: background 0.2s; font-size: 1.1rem; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06);\">📖 Открыть официальную документацию</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>max/min — максимум/минимум. argmax/argmin — индекс. topk(k) — k наибольших. clamp(min, max) — обрезка (как np.clip). abs, ceil, floor, round — привычные математические.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px; color: #e2e8f0;'>Пример 1: Базовое использование</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Простейший пример того, как вызвать эту команду.</p><div class='code-block-container' id='code-block-pytorch-import-torch-na-torch-randn-3-3-npri-e-204-code-1'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155; text-align: center;\"><a href=\"PT_G + 'torch.max.html', true\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 12px 24px; border-radius: 8px; text-decoration: none; font-weight: bold; transition: background 0.2s; font-size: 1.1rem; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06);\">📖 Открыть официальную документацию</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>dot — скалярное произведение (1D). matmul / @ — матричное умножение (как np.dot). mm — строго 2D×2D. bmm — батч матричное (3D). einsum — обобщённая запись Эйнштейна.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px; color: #e2e8f0;'>Пример 1: Базовое использование</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Простейший пример того, как вызвать эту команду.</p><div class='code-block-container' id='code-block-pytorch-import-torch-na-torch-tensor-1-0-2-0-e-205-code-1'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155; text-align: center;\"><a href=\"PT_G + 'torch.matmul.html', true\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 12px 24px; border-radius: 8px; text-decoration: none; font-weight: bold; transition: background 0.2s; font-size: 1.1rem; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06);\">📖 Открыть официальную документацию</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Создание тензоров: zeros, ones, randn (нормальное), rand (равномерное [0,1]), arange, linspace, eye (единичная матрица), full(size, val), empty (без инициализации). _like — как другой тензор (zeros_like, randn_like).</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px; color: #e2e8f0;'>Пример 1: Базовое использование</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Простейший пример того, как вызвать эту команду.</p><div class='code-block-container' id='code-block-pytorch-import-torch-nprint-zeros-torch-zero-e-206-code-1'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155; text-align: center;\"><a href=\"PT_G + 'torch.zeros.html', true\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 12px 24px; border-radius: 8px; text-decoration: none; font-weight: bold; transition: background 0.2s; font-size: 1.1rem; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06);\">📖 Открыть официальную документацию</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Инициализация весов: xavier_uniform_ — для tanh/sigmoid. kaiming_normal_ — для ReLU. zeros_ — для bias. model.apply(fn) — применяет функцию рекурсивно ко всем подмодулям. Правильная инициализация ускоряет обучение.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px; color: #e2e8f0;'>Пример 1: Базовое использование</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Простейший пример того, как вызвать эту команду.</p><div class='code-block-container' id='code-block-pytorch-import-torch-nimport-torch-nn-as-nn-n-n-e-207-code-1'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155; text-align: center;\"><a href=\"https://pytorch.org/docs/stable/nn.init.html, true\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 12px 24px; border-radius: 8px; text-decoration: none; font-weight: bold; transition: background 0.2s; font-size: 1.1rem; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06);\">📖 Открыть официальную документацию</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Mixed Precision Training — FP16 для прямого прохода (быстрее на GPU), FP32 для градиентов (точнее). autocast — автоматически выбирает точность. GradScaler — масштабирует loss для предотвращения underflow. Ускорение 2-3× на NVIDIA Tensor Cores.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px; color: #e2e8f0;'>Пример 1: Базовое использование</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Простейший пример того, как вызвать эту команду.</p><div class='code-block-container' id='code-block-pytorch-import-torch-nimport-torch-nn-as-nn-n-n-e-208-code-1'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155; text-align: center;\"><a href=\"https://pytorch.org/docs/stable/amp.html, true\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 12px 24px; border-radius: 8px; text-decoration: none; font-weight: bold; transition: background 0.2s; font-size: 1.1rem; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06);\">📖 Открыть официальную документацию</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Замораживание параметров: requires_grad = False — параметр не обновляется. named_parameters() — итерация с именами. Передавайте в optimizer только обучаемые. Для fine-tuning: заморозить всё кроме последних слоёв.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px; color: #e2e8f0;'>Пример 1: Базовое использование</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Простейший пример того, как вызвать эту команду.</p><div class='code-block-container' id='code-block-pytorch-import-torch-nimport-torch-nn-as-nn-n-n-e-209-code-1'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155; text-align: center;\"><a href=\"https://pytorch.org/docs/stable/autograd.html, true\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 12px 24px; border-radius: 8px; text-decoration: none; font-weight: bold; transition: background 0.2s; font-size: 1.1rem; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06);\">📖 Открыть официальную документацию</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Early Stopping — останавливаем обучение если val_loss не улучшается patience эпох. Сохраняем лучшую модель. Предотвращает переобучение. В sklearn — через callbacks или вручную. В PyTorch — реализуется вручную (нет встроенного).</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px; color: #e2e8f0;'>Пример 1: Базовое использование</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Простейший пример того, как вызвать эту команду.</p><div class='code-block-container' id='code-block-pytorch-import-torch-nimport-torch-nn-as-nn-n-n-e-210-code-1'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155; text-align: center;\"><a href=\"https://pytorch.org/docs/stable/nn.html, true\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 12px 24px; border-radius: 8px; text-decoration: none; font-weight: bold; transition: background 0.2s; font-size: 1.1rem; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06);\">📖 Открыть официальную документацию</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>nn.Sequential — контейнер, вызывает слои по порядку. Для простых сетей. nn.ModuleList — список модулей (регистрирует параметры), но forward пишете сами. Для сложных архитектур (skip connections, разветвления). nn.ModuleDict — по именам.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px; color: #e2e8f0;'>Пример 1: Базовое использование</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Простейший пример того, как вызвать эту команду.</p><div class='code-block-container' id='code-block-pytorch-import-torch-nimport-torch-nn-as-nn-n-n-e-211-code-1'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155; text-align: center;\"><a href=\"https://pytorch.org/docs/stable/nn.html#containers, true\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 12px 24px; border-radius: 8px; text-decoration: none; font-weight: bold; transition: background 0.2s; font-size: 1.1rem; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06);\">📖 Открыть официальную документацию</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Низкоуровневый API для регистрации пользовательских операторов (операций) в C++ и привязки их к PyTorch. Нужен для кастомных ядер, интеграции с другими библиотеками или оптимизации под железо. Новичку обычно не требуется; используется при расширении PyTorch или написании своих CUDA-операций.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px; color: #e2e8f0;'>Пример 1: Базовое использование</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Простейший пример того, как вызвать эту команду.</p><div class='code-block-container' id='code-block-pytorch-torch-library-e-218-code-1'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155; text-align: center;\"><a href=\"https://pytorch.org/docs/stable/library.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 12px 24px; border-radius: 8px; text-decoration: none; font-weight: bold; transition: background 0.2s; font-size: 1.1rem; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06);\">📖 Открыть официальную документацию</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
        "initialCode": "import torch\nimport torch.nn as nn\nprint(torch.library)",
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Управление памятью GPU: память выделяется под тензоры автоматически; при нехватке — OOM. Функции: torch.cuda.empty_cache() — освободить кэш неиспользуемой памяти; memory_allocated(), max_memory_allocated() — статистика; set_per_process_memory_fraction() — лимит. Полезно при отладке OOM и при многопроцессном обучении. torch.mtia.memory — аналогично для MTIA.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px; color: #e2e8f0;'>Пример 1: Базовое использование</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Простейший пример того, как вызвать эту команду.</p><div class='code-block-container' id='code-block-pytorch-torch-cuda-memory-torch-mtia-memory-e-221-code-1'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155; text-align: center;\"><a href=\"https://pytorch.org/docs/stable/cuda.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 12px 24px; border-radius: 8px; text-decoration: none; font-weight: bold; transition: background 0.2s; font-size: 1.1rem; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06);\">📖 Открыть официальную документацию</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Бэкенды для низкоуровневых библиотек: cuDNN (torch.backends.cudnn), CUDA (cuda), MPS, MKL и т.д. Настройки: cudnn.benchmark = True — авто-подбор быстрых алгоритмов свёртки (рекомендуется при фиксированном размере входа); cudnn.deterministic — воспроизводимость в ущерб скорости. Меняют глобальное поведение PyTorch на выбранном устройстве.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px; color: #e2e8f0;'>Пример 1: Базовое использование</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Простейший пример того, как вызвать эту команду.</p><div class='code-block-container' id='code-block-pytorch-torch-backends-e-223-code-1'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155; text-align: center;\"><a href=\"https://pytorch.org/docs/stable/backends.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 12px 24px; border-radius: 8px; text-decoration: none; font-weight: bold; transition: background 0.2s; font-size: 1.1rem; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06);\">📖 Открыть официальную документацию</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Экспорт модели в формат вне PyTorch: ONNX, TorchScript, другие графы. export() строит граф из модели и примера входа; затем граф можно сохранить и запускать без Python (деплой на сервер, мобильные устройства). Связано с torch.onnx и torch.jit; документация описывает ограничения и поддерживаемые конструкции.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px; color: #e2e8f0;'>Пример 1: Базовое использование</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Простейший пример того, как вызвать эту команду.</p><div class='code-block-container' id='code-block-pytorch-torch-export-e-224-code-1'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155; text-align: center;\"><a href=\"https://pytorch.org/docs/stable/export.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 12px 24px; border-radius: 8px; text-decoration: none; font-weight: bold; transition: background 0.2s; font-size: 1.1rem; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06);\">📖 Открыть официальную документацию</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
        "initialCode": "import torch\nimport torch.nn as nn\nprint(torch.export)",
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>FSDP (Fully Sharded Data Parallel): параметры модели разбиваются между процессами; каждый процесс хранит только свою часть. Позволяет обучать модели, не помещающиеся в память одного GPU. Альтернатива классическому DDP при огромном числе параметров. Требует понимания распределённого обучения.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px; color: #e2e8f0;'>Пример 1: Базовое использование</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Простейший пример того, как вызвать эту команду.</p><div class='code-block-container' id='code-block-pytorch-torch-distributed-fsdp-fully-shard-e-226-code-1'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155; text-align: center;\"><a href=\"https://pytorch.org/docs/stable/fsdp.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 12px 24px; border-radius: 8px; text-decoration: none; font-weight: bold; transition: background 0.2s; font-size: 1.1rem; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06);\">📖 Открыть официальную документацию</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Распределения вероятностей: Normal, Bernoulli, Categorical, Uniform, MultivariateNormal и многие другие. Методы: .sample(), .log_prob(x), .entropy(). Нужны для VAE, reinforcement learning (политики), байесовских моделей и любого кода, где явно работают с распределениями. Интеграция с autograd: градиенты по параметрам распределения.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px; color: #e2e8f0;'>Пример 1: Базовое использование</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Простейший пример того, как вызвать эту команду.</p><div class='code-block-container' id='code-block-pytorch-torch-distributions-e-228-code-1'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155; text-align: center;\"><a href=\"https://pytorch.org/docs/stable/distributions.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 12px 24px; border-radius: 8px; text-decoration: none; font-weight: bold; transition: background 0.2s; font-size: 1.1rem; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06);\">📖 Открыть официальную документацию</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Быстрое преобразование Фурье: fft.fft(), fft.ifft(), fft.rfft() (для вещественных сигналов), fft.fft2() для 2D (изображения). Используется в обработке сигналов, спектральном анализе, некоторых слоях в нейросетях. Возвращает комплексные тензоры; для вещественного входа rfft экономит память.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px; color: #e2e8f0;'>Пример 1: Базовое использование</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Простейший пример того, как вызвать эту команду.</p><div class='code-block-container' id='code-block-pytorch-torch-fft-e-230-code-1'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155; text-align: center;\"><a href=\"https://pytorch.org/docs/stable/fft.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 12px 24px; border-radius: 8px; text-decoration: none; font-weight: bold; transition: background 0.2s; font-size: 1.1rem; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06);\">📖 Открыть официальную документацию</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
        "initialCode": "import torch\nimport torch.nn as nn\nprint(torch.fft)",
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Функциональные трансформации: vmap (векторизация по дополнительному измерению), grad, jacrev/jacfwd (якобианы), hessian, checkpoint (экономия памяти). Удобно для кастомной логики с градиентами без явного цикла по батчу или для вторых производных. Замена части устаревшего torch.autograd.functional.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px; color: #e2e8f0;'>Пример 1: Базовое использование</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Простейший пример того, как вызвать эту команду.</p><div class='code-block-container' id='code-block-pytorch-torch-func-e-231-code-1'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155; text-align: center;\"><a href=\"https://pytorch.org/docs/stable/func.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 12px 24px; border-radius: 8px; text-decoration: none; font-weight: bold; transition: background 0.2s; font-size: 1.1rem; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06);\">📖 Открыть официальную документацию</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
        "initialCode": "import torch\nimport torch.nn as nn\nprint(torch.func)",
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Framework для трансформации графов моделей: трассировка nn.Module в граф (symbolic trace), замена/вставка узлов, вывод оптимизированного кода. Нужен для квантизации, кастомных компиляторов, анализа графа. Продвинутый инструмент; обычно не требуется на старте.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px; color: #e2e8f0;'>Пример 1: Базовое использование</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Простейший пример того, как вызвать эту команду.</p><div class='code-block-container' id='code-block-pytorch-torch-fx-e-233-code-1'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155; text-align: center;\"><a href=\"https://pytorch.org/docs/stable/fx.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 12px 24px; border-radius: 8px; text-decoration: none; font-weight: bold; transition: background 0.2s; font-size: 1.1rem; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06);\">📖 Открыть официальную документацию</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
        "initialCode": "import torch\nimport torch.nn as nn\nprint(torch.fx)",
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Загрузка предобученных моделей и скриптов с репозитория (GitHub). torch.hub.load(\"pytorch/vision\", \"resnet18\", pretrained=True) — пример. Удобно для воспроизведения чужих моделей и быстрого прототипирования. Документация: список моделей, кэш, свои репозитории.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px; color: #e2e8f0;'>Пример 1: Базовое использование</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Простейший пример того, как вызвать эту команду.</p><div class='code-block-container' id='code-block-pytorch-torch-hub-e-234-code-1'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155; text-align: center;\"><a href=\"https://pytorch.org/docs/stable/hub.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 12px 24px; border-radius: 8px; text-decoration: none; font-weight: bold; transition: background 0.2s; font-size: 1.1rem; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06);\">📖 Открыть официальную документацию</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
        "initialCode": "import torch\nimport torch.nn as nn\nprint(torch.hub)",
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>TorchScript: компиляция моделей в граф, независимый от Python, для деплоя (C++, мобильные устройства) и оптимизации. trace — запись графа по примеру входа; script — разбор кода с аннотациями. Ограничения: не весь Python поддерживается. Используется при экспорте в production.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px; color: #e2e8f0;'>Пример 1: Базовое использование</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Простейший пример того, как вызвать эту команду.</p><div class='code-block-container' id='code-block-pytorch-torch-jit-e-235-code-1'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155; text-align: center;\"><a href=\"https://pytorch.org/docs/stable/jit.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 12px 24px; border-radius: 8px; text-decoration: none; font-weight: bold; transition: background 0.2s; font-size: 1.1rem; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06);\">📖 Открыть официальную документацию</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
        "initialCode": "import torch\nimport torch.nn as nn\nprint(torch.jit)",
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Линейная алгебра: решения систем (solve, lstsq), разложения (cholesky, svd, qr), нормы (norm), определитель, собственные значения. Аналог numpy.linalg с поддержкой GPU и autograd. Используется в моделях с матричными операциями и в научных расчётах.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px; color: #e2e8f0;'>Пример 1: Базовое использование</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Простейший пример того, как вызвать эту команду.</p><div class='code-block-container' id='code-block-pytorch-torch-linalg-e-236-code-1'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155; text-align: center;\"><a href=\"https://pytorch.org/docs/stable/linalg.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 12px 24px; border-radius: 8px; text-decoration: none; font-weight: bold; transition: background 0.2s; font-size: 1.1rem; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06);\">📖 Открыть официальную документацию</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
        "initialCode": "import torch\nimport torch.nn as nn\nprint(torch.linalg)",
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Специальные математические функции: гамма, бета, эрфи, логическая сумма (logsumexp) и т.д. Нужны в вероятностных моделях и некоторых формулах потерь.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px; color: #e2e8f0;'>Пример 1: Базовое использование</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Простейший пример того, как вызвать эту команду.</p><div class='code-block-container' id='code-block-pytorch-torch-special-e-239-code-1'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155; text-align: center;\"><a href=\"https://pytorch.org/docs/stable/special.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 12px 24px; border-radius: 8px; text-decoration: none; font-weight: bold; transition: background 0.2s; font-size: 1.1rem; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06);\">📖 Открыть официальную документацию</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
        "initialCode": "import torch\nimport torch.nn as nn\nprint(torch.special)",
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Переопределение поведения встроенных функций PyTorch для своих типов тензоров (кастомные классы с __torch_function__). Продвинутое использование при разработке библиотек поверх PyTorch.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px; color: #e2e8f0;'>Пример 1: Базовое использование</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Простейший пример того, как вызвать эту команду.</p><div class='code-block-container' id='code-block-pytorch-torch-overrides-e-240-code-1'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155; text-align: center;\"><a href=\"https://pytorch.org/docs/stable/overrides.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 12px 24px; border-radius: 8px; text-decoration: none; font-weight: bold; transition: background 0.2s; font-size: 1.1rem; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06);\">📖 Открыть официальную документацию</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Нативный рантайм для скомпилированных моделей (деплой без Python). Специфичная тема деплоя.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px; color: #e2e8f0;'>Пример 1: Базовое использование</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Простейший пример того, как вызвать эту команду.</p><div class='code-block-container' id='code-block-pytorch-torch-nativert-e-241-code-1'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155; text-align: center;\"><a href=\"https://pytorch.org/docs/stable/nativert.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 12px 24px; border-radius: 8px; text-decoration: none; font-weight: bold; transition: background 0.2s; font-size: 1.1rem; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06);\">📖 Открыть официальную документацию</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Профилирование: замер времени выполнения операций, использование памяти, узкие места. Контекст torch.profiler.profile() с schedule и on_trace_ready; экспорт в Chrome trace. Необходим при оптимизации скорости и памяти.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px; color: #e2e8f0;'>Пример 1: Базовое использование</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Простейший пример того, как вызвать эту команду.</p><div class='code-block-container' id='code-block-pytorch-torch-profiler-e-243-code-1'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155; text-align: center;\"><a href=\"https://pytorch.org/docs/stable/profiler.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 12px 24px; border-radius: 8px; text-decoration: none; font-weight: bold; transition: background 0.2s; font-size: 1.1rem; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06);\">📖 Открыть официальную документацию</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Инициализация весов слоёв: init.xavier_uniform_(), init.kaiming_normal_(), init.orthogonal_() и др. Применяются к параметрам модели после создания; влияют на сходимость. По умолчанию многие слои уже имеют разумную инициализацию; кастомная нужна для нестандартных архитектур.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px; color: #e2e8f0;'>Пример 1: Базовое использование</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Простейший пример того, как вызвать эту команду.</p><div class='code-block-container' id='code-block-pytorch-torch-nn-init-e-244-code-1'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155; text-align: center;\"><a href=\"https://pytorch.org/docs/stable/nn.init.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 12px 24px; border-radius: 8px; text-decoration: none; font-weight: bold; transition: background 0.2s; font-size: 1.1rem; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06);\">📖 Открыть официальную документацию</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
        "initialCode": "import torch\nimport torch.nn as nn\nprint(torch.nn.init)",
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Слои и утилиты для механизма внимания (attention): scaled dot-product, multihead и т.д. Используется в трансформерах. В документации — форматы входа/выхода и параметры (num_heads, dropout).</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px; color: #e2e8f0;'>Пример 1: Базовое использование</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Простейший пример того, как вызвать эту команду.</p><div class='code-block-container' id='code-block-pytorch-torch-nn-attention-e-245-code-1'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155; text-align: center;\"><a href=\"https://pytorch.org/docs/stable/nn.attention.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 12px 24px; border-radius: 8px; text-decoration: none; font-weight: bold; transition: background 0.2s; font-size: 1.1rem; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06);\">📖 Открыть официальную документацию</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Поддержка комплексных тензоров (dtype complex64, complex128): арифметика, fft, linalg. Нужно в физике, обработке сигналов и части моделей.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px; color: #e2e8f0;'>Пример 1: Базовое использование</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Простейший пример того, как вызвать эту команду.</p><div class='code-block-container' id='code-block-pytorch-complex-numbers-e-247-code-1'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155; text-align: center;\"><a href=\"https://pytorch.org/docs/stable/complex_numbers.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 12px 24px; border-radius: 8px; text-decoration: none; font-weight: bold; transition: background 0.2s; font-size: 1.1rem; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06);\">📖 Открыть официальную документацию</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Удалённый вызов процедур (RPC) между процессами: запуск функций на других узлах, передача тензоров. Используется в сложных распределённых сценариях (например части модели на разных машинах).</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px; color: #e2e8f0;'>Пример 1: Базовое использование</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Простейший пример того, как вызвать эту команду.</p><div class='code-block-container' id='code-block-pytorch-distributed-rpc-framework-e-250-code-1'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155; text-align: center;\"><a href=\"https://pytorch.org/docs/stable/rpc.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 12px 24px; border-radius: 8px; text-decoration: none; font-weight: bold; transition: background 0.2s; font-size: 1.1rem; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06);\">📖 Открыть официальную документацию</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Генерация случайных чисел: torch.manual_seed(), torch.randn(), torch.randint() и т.д.; генераторы для воспроизводимости (torch.Generator). Документация по всем случайным функциям и лучшим практикам (установка seed на каждом процессе при DDP).</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px; color: #e2e8f0;'>Пример 1: Базовое использование</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Простейший пример того, как вызвать эту команду.</p><div class='code-block-container' id='code-block-pytorch-torch-random-e-251-code-1'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155; text-align: center;\"><a href=\"https://pytorch.org/docs/stable/random.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 12px 24px; border-radius: 8px; text-decoration: none; font-weight: bold; transition: background 0.2s; font-size: 1.1rem; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06);\">📖 Открыть официальную документацию</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
        "initialCode": "import torch\nimport torch.nn as nn\nprint(torch.random)",
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Вложенные тензоры (nested tensor): последовательности переменной длины в одном тензоре без паддинга. Экономия памяти и упрощение кода для NLP и аудио.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px; color: #e2e8f0;'>Пример 1: Базовое использование</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Простейший пример того, как вызвать эту команду.</p><div class='code-block-container' id='code-block-pytorch-torch-nested-e-253-code-1'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155; text-align: center;\"><a href=\"https://pytorch.org/docs/stable/nested.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 12px 24px; border-radius: 8px; text-decoration: none; font-weight: bold; transition: background 0.2s; font-size: 1.1rem; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06);\">📖 Открыть официальную документацию</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
        "initialCode": "import torch\nimport torch.nn as nn\nprint(torch.nested)",
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Класс размера тензора: результат .shape, поддерживает индексацию и арифметику (например size[0] * size[1]). Используется при проверке форм и динамическом построении слоёв.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px; color: #e2e8f0;'>Пример 1: Базовое использование</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Простейший пример того, как вызвать эту команду.</p><div class='code-block-container' id='code-block-pytorch-torch-size-e-254-code-1'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155; text-align: center;\"><a href=\"https://pytorch.org/docs/stable/tensors.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 12px 24px; border-radius: 8px; text-decoration: none; font-weight: bold; transition: background 0.2s; font-size: 1.1rem; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06);\">📖 Открыть официальную документацию</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
        "initialCode": "import torch\nimport torch.nn as nn\nprint(torch.Size)",
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Разрежённые тензоры: хранение только ненулевых элементов. Экономия памяти для графов, эмбеддингов с очень большим числом нулей. Операции: sparse_coo_tensor(), to_dense(); не все операции поддерживают sparse.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px; color: #e2e8f0;'>Пример 1: Базовое использование</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Простейший пример того, как вызвать эту команду.</p><div class='code-block-container' id='code-block-pytorch-torch-sparse-e-255-code-1'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155; text-align: center;\"><a href=\"https://pytorch.org/docs/stable/sparse.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 12px 24px; border-radius: 8px; text-decoration: none; font-weight: bold; transition: background 0.2s; font-size: 1.1rem; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06);\">📖 Открыть официальную документацию</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
        "initialCode": "import torch\nimport torch.nn as nn\nprint(torch.sparse)",
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Низкоуровневое хранилище данных тензора (1D непрерывный буфер). Обычно не используется напрямую; нужно при работе с .data_ptr() или при написании своих расширений.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px; color: #e2e8f0;'>Пример 1: Базовое использование</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Простейший пример того, как вызвать эту команду.</p><div class='code-block-container' id='code-block-pytorch-torch-storage-e-256-code-1'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155; text-align: center;\"><a href=\"https://pytorch.org/docs/stable/storage.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 12px 24px; border-radius: 8px; text-decoration: none; font-weight: bold; transition: background 0.2s; font-size: 1.1rem; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06);\">📖 Открыть официальную документацию</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
        "initialCode": "import torch\nimport torch.nn as nn\nprint(torch.Storage)",
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Утилиты для тестирования: сравнение тензоров (assert_close), проверка градиентов. Удобно в unit-тестах моделей и слоёв.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px; color: #e2e8f0;'>Пример 1: Базовое использование</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Простейший пример того, как вызвать эту команду.</p><div class='code-block-container' id='code-block-pytorch-torch-testing-e-257-code-1'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155; text-align: center;\"><a href=\"https://pytorch.org/docs/stable/testing.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 12px 24px; border-radius: 8px; text-decoration: none; font-weight: bold; transition: background 0.2s; font-size: 1.1rem; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06);\">📖 Открыть официальную документацию</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
        "initialCode": "import torch\nimport torch.nn as nn\nprint(torch.testing)",
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Dataset, DataLoader, Sampler и подклассы. Dataset — абстракция датасета (__len__, __getitem__); DataLoader — батчи, shuffle, num_workers; IterableDataset для потоковых данных. Документация по кастомным датасетам, коллайтам (обработка батча) и многопроцессной загрузке.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px; color: #e2e8f0;'>Пример 1: Базовое использование</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Простейший пример того, как вызвать эту команду.</p><div class='code-block-container' id='code-block-pytorch-torch-utils-data-e-258-code-1'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155; text-align: center;\"><a href=\"https://pytorch.org/docs/stable/data.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 12px 24px; border-radius: 8px; text-decoration: none; font-weight: bold; transition: background 0.2s; font-size: 1.1rem; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06);\">📖 Открыть официальную документацию</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Интеграция с TensorBoard: логирование скаляров, графиков, изображений, гистограмм весов. Writer.add_scalar(), add_histogram() и т.д. Стандартный способ визуализации обучения.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px; color: #e2e8f0;'>Пример 1: Базовое использование</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Простейший пример того, как вызвать эту команду.</p><div class='code-block-container' id='code-block-pytorch-torch-utils-tensorboard-e-260-code-1'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155; text-align: center;\"><a href=\"https://pytorch.org/docs/stable/tensorboard.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 12px 24px; border-radius: 8px; text-decoration: none; font-weight: bold; transition: background 0.2s; font-size: 1.1rem; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06);\">📖 Открыть официальную документацию</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>benchmark — точный замер времени операций (Timer); collect_env — вывод информации о системе и версиях для отчётов об ошибках; flop_counter — подсчёт FLOP; cpp_extension — компиляция своих C++/CUDA расширений; deterministic — включение детерминированных алгоритмов для воспроизводимости. Утилиты для отладки, бенчмарков и расширения PyTorch.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px; color: #e2e8f0;'>Пример 1: Базовое использование</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Простейший пример того, как вызвать эту команду.</p><div class='code-block-container' id='code-block-pytorch-torch-utils-benchmark-collect-env-fl-e-261-code-1'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155; text-align: center;\"><a href=\"https://pytorch.org/docs/stable/utils.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 12px 24px; border-radius: 8px; text-decoration: none; font-weight: bold; transition: background 0.2s; font-size: 1.1rem; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06);\">📖 Открыть официальную документацию</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Тензоры с именованными осями: например tensor(\"batch\", \"channel\", \"height\", \"width\"). Удобно для читаемости и уменьшения ошибок с порядком размерностей. Поддержка в операциях и постепенное расширение покрытия.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px; color: #e2e8f0;'>Пример 1: Базовое использование</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Простейший пример того, как вызвать эту команду.</p><div class='code-block-container' id='code-block-pytorch-named-tensors-e-262-code-1'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155; text-align: center;\"><a href=\"https://pytorch.org/docs/stable/named_tensor.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 12px 24px; border-radius: 8px; text-decoration: none; font-weight: bold; transition: background 0.2s; font-size: 1.1rem; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06);\">📖 Открыть официальную документацию</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
        "initialCode": "import torch\nimport torch.nn as nn\nprint(Named Tensors)",
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Type Info — аннотации типов для статической проверки. __config__ — информация о сборке PyTorch. Переменные окружения управляют поведением (CUDA_VISIBLE_DEVICES, TORCH_*, и т.д.). Документация по конфигурации и отладке окружения.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px; color: #e2e8f0;'>Пример 1: Базовое использование</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Простейший пример того, как вызвать эту команду.</p><div class='code-block-container' id='code-block-pytorch-type-info-torch-config-environme-e-263-code-1'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155; text-align: center;\"><a href=\"https://pytorch.org/docs/stable/index.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 12px 24px; border-radius: 8px; text-decoration: none; font-weight: bold; transition: background 0.2s; font-size: 1.1rem; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06);\">📖 Открыть официальную документацию</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",

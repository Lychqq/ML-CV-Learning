window.REFERENCES = [
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Создаёт массив ndarray из списка Python.</div><div style='background-color: #1e293b; border-left: 4px solid #f59e0b; padding: 15px; margin: 20px 0; border-radius: 4px;'><h4 style='margin: 0 0 10px 0; color: #fcd34d;'>💡 Нюансы и параметры:</h4><p style='margin: 0; font-size: 0.95rem; color: #cbd5e1;'>Параметры: object (обязательный — список или вложенные списки), dtype=None (тип элементов — подбирается автоматически), copy=True, order='K', ndmin=0. Возвращает ndarray. Для 2D передаёте список списков; если в данных есть float — dtype станет float64. Нюанс: вложенные списки должны иметь одинаковую длину по каждому уровню.</p></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-numpy-np-array-0-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-numpy-np-array-0-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-numpy-np-array-0-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"https://numpy.org/doc/stable/reference/generated/numpy.array.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
      ...
      {
        "type": "runnable",
        "initialCode": "import numpy as np\n\n# Практическое применение в пайплайне\nprint('Запуск: np.array')\ntry:\n    # Инкапсулируем в функцию\n    def process_data():\n        val = np.array([[1,2],[3,4]])\n        return val\n    \n    out = process_data()\n    print('Успешное выполнение. Тип:', type(out))\nexcept Exception as e:\n    print('Ошибка выполнения:', e)",
        "solution": "",
        "hints": [],
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Массив из нулей заданной формы. Форма — кортеж: (3, 4) значит 3 строки, 4 столбца.</div><div style='background-color: #1e293b; border-left: 4px solid #f59e0b; padding: 15px; margin: 20px 0; border-radius: 4px;'><h4 style='margin: 0 0 10px 0; color: #fcd34d;'>💡 Нюансы и параметры:</h4><p style='margin: 0; font-size: 0.95rem; color: #cbd5e1;'>Параметры: shape (обязательный), dtype=float64, order='C'. Возвращает ndarray. По умолчанию тип float64 — для целых укажите dtype=np.int32. Вызов всегда через np.zeros(...), не от массива.</p></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-numpy-np-zeros-1-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-numpy-np-zeros-1-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-numpy-np-zeros-1-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"https://numpy.org/doc/stable/reference/generated/numpy.zeros.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
        "initialCode": "import numpy as np\nprint(np.zeros((3, 4)))",
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Массив из единиц. Аналогично zeros: shape — кортеж размеров, dtype по умолчанию float64. Удобно для инициализации весов или масок перед заполнением.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-numpy-np-ones-2-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-numpy-np-ones-2-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-numpy-np-ones-2-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"https://numpy.org/doc/stable/reference/generated/numpy.ones.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
        "initialCode": "import numpy as np\nprint(np.ones((2, 3)))",
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Массив заданной формы, все элементы равны fill_value (здесь 7).</div><div style='background-color: #1e293b; border-left: 4px solid #f59e0b; padding: 15px; margin: 20px 0; border-radius: 4px;'><h4 style='margin: 0 0 10px 0; color: #fcd34d;'>💡 Нюансы и параметры:</h4><p style='margin: 0; font-size: 0.95rem; color: #cbd5e1;'>Параметры: shape, fill_value, dtype=None. Если fill_value — целое и dtype не указан, тип будет int. Полезно для константных матриц или заполнения \"пустышкой\".</p></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-numpy-np-full-3-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-numpy-np-full-3-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-numpy-np-full-3-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"https://numpy.org/doc/stable/reference/generated/numpy.full.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
        "initialCode": "import numpy as np\nprint(np.full((2, 2), 7))",
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Единичная матрица: на главной диагонали 1, остальное 0.</div><div style='background-color: #1e293b; border-left: 4px solid #f59e0b; padding: 15px; margin: 20px 0; border-radius: 4px;'><h4 style='margin: 0 0 10px 0; color: #fcd34d;'>💡 Нюансы и параметры:</h4><p style='margin: 0; font-size: 0.95rem; color: #cbd5e1;'>Параметры: N (размер), M=None (если задать — прямоугольная матрица), k=0 (сдвиг диагонали: k>0 — выше главной, k<0 — ниже). Возвращает 2D массив. Используется в линейной алгебре (обратная, системы).</p></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-numpy-np-eye-4-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-numpy-np-eye-4-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-numpy-np-eye-4-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"https://numpy.org/doc/stable/reference/generated/numpy.eye.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
        "initialCode": "import numpy as np\nprint(np.eye(3))",
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Аналог range(), но возвращает массив: [0, 2, 4, 6, 8].</div><div style='background-color: #1e293b; border-left: 4px solid #f59e0b; padding: 15px; margin: 20px 0; border-radius: 4px;'><h4 style='margin: 0 0 10px 0; color: #fcd34d;'>💡 Нюансы и параметры:</h4><p style='margin: 0; font-size: 0.95rem; color: #cbd5e1;'>Параметры: start (по умолчанию 0), stop (обязательный, не входит в результат!), step=1, dtype=None. Из-за погрешности float лучше для дробных шагов использовать np.linspace.</p></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-numpy-np-arange-5-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-numpy-np-arange-5-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-numpy-np-arange-5-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"https://numpy.org/doc/stable/reference/generated/numpy.arange.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
      ...
      {
        "type": "runnable",
        "initialCode": "import numpy as np\n\n# Практическое применение в пайплайне\nprint('Запуск: np.arange')\ntry:\n    # Инкапсулируем в функцию\n    def process_data():\n        val = np.arange(0, 10, 2)\n        return val\n    \n    out = process_data()\n    print('Успешное выполнение. Тип:', type(out))\nexcept Exception as e:\n    print('Ошибка выполнения:', e)",
        "solution": "",
        "hints": [],
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Равномерно распределённые числа от start до stop включительно (если endpoint=True). Здесь 5 точек: [0., 0.25, 0.5, 0.75, 1.].</div><div style='background-color: #1e293b; border-left: 4px solid #f59e0b; padding: 15px; margin: 20px 0; border-radius: 4px;'><h4 style='margin: 0 0 10px 0; color: #fcd34d;'>💡 Нюансы и параметры:</h4><p style='margin: 0; font-size: 0.95rem; color: #cbd5e1;'>Параметры: start, stop, num=50 (число точек), endpoint=True, retstep=False, dtype=None. Идеально для сеток по оси (графики, выборка).</p></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-numpy-np-linspace-6-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-numpy-np-linspace-6-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-numpy-np-linspace-6-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"https://numpy.org/doc/stable/reference/generated/numpy.linspace.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Массив заданной формы без инициализации ячеек — в памяти остаётся \"мусор\". Быстрее zeros/ones, но значения непредсказуемы до записи. Используйте, когда сразу заполняете массив целиком (избегая лишнего обнуления).</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-numpy-np-empty-7-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-numpy-np-empty-7-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-numpy-np-empty-7-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"https://numpy.org/doc/stable/reference/generated/numpy.empty.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
        "initialCode": "import numpy as np\nprint(np.empty((2, 3)))",
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Создаёт копию массива a. Изменения в копии не затрагивают исходный массив. Параметр order='K'. Если нужна копия с другой раскладкой в памяти — order='C' или 'F'.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-numpy-np-copy-8-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-numpy-np-copy-8-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-numpy-np-copy-8-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"https://numpy.org/doc/stable/reference/generated/numpy.copy.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
        "initialCode": "import numpy as np\nprint(np.copy(a))",
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Случайные числа из равномерного распределения на [0, 1). Форма задаётся отдельными аргументами: rand(d0, d1, d2, ...). Возвращает массив формы (2, 3). Не передавайте кортеж: rand((2,3)) даст ошибку интерпретации. Для воспроизводимости перед этим вызовите np.random.seed(42).</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-numpy-np-random-rand-9-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-numpy-np-random-rand-9-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-numpy-np-random-rand-9-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"https://numpy.org/doc/stable/reference/generated/numpy.random.rand.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Стандартное нормальное распределение (среднее 0, дисперсия 1). Форма — отдельные аргументы, как у rand. Используется для инициализации весов нейросетей, генерации шума.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-numpy-np-random-randn-10-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-numpy-np-random-randn-10-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-numpy-np-random-randn-10-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"https://numpy.org/doc/stable/reference/generated/numpy.random.randn.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Случайные целые числа. low (включительно), high (не входит!) — диапазон; size — число или кортеж формы. Здесь числа от 0 до 9, массив 3×4. Если передать только high — low считается 0. Возвращает int по умолчанию (платформозависимо).</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-numpy-np-random-randint-11-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-numpy-np-random-randint-11-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-numpy-np-random-randint-11-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"https://numpy.org/doc/stable/reference/generated/numpy.random.randint.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
      ...
      {
        "type": "runnable",
        "initialCode": "import numpy as np\n\n# Практическое применение в пайплайне\nprint('Запуск: np.random.randint')\ntry:\n    # Инкапсулируем в функцию\n    def process_data():\n        val = np.random.randint(0, 10, size=(3, 4))\n        return val\n    \n    out = process_data()\n    print('Успешное выполнение. Тип:', type(out))\nexcept Exception as e:\n    print('Ошибка выполнения:', e)",
        "solution": "",
        "hints": [],
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Равномерное [0, 1). В отличие от rand, размер задаётся одним числом или кортежем: random((2, 3)) или random(6). Удобно когда форма в переменной: random(shape).</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-numpy-np-random-random-12-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-numpy-np-random-random-12-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-numpy-np-random-random-12-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"https://numpy.org/doc/stable/reference/generated/numpy.random.random.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Случайная выборка из массива или из range(int).</div><div style='background-color: #1e293b; border-left: 4px solid #f59e0b; padding: 15px; margin: 20px 0; border-radius: 4px;'><h4 style='margin: 0 0 10px 0; color: #fcd34d;'>💡 Нюансы и параметры:</h4><p style='margin: 0; font-size: 0.95rem; color: #cbd5e1;'>Параметры: a (массив или int), size=None (число или форма), replace=True (с возвратом или без), p=None (вероятности элементов). Возвращает массив размера size. Для replace=False размер не может быть больше длины a.</p></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-numpy-np-random-choice-13-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-numpy-np-random-choice-13-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-numpy-np-random-choice-13-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"https://numpy.org/doc/stable/reference/generated/numpy.random.choice.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
      ...
      {
        "type": "runnable",
        "initialCode": "import numpy as np\n\n# Практическое применение в пайплайне\nprint('Запуск: np.random.choice')\ntry:\n    # Инкапсулируем в функцию\n    def process_data():\n        val = np.random.choice([1, 2, 3], size=5)\n        return val\n    \n    out = process_data()\n    print('Успешное выполнение. Тип:', type(out))\nexcept Exception as e:\n    print('Ошибка выполнения:', e)",
        "solution": "",
        "hints": [],
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Перемешивает массив x по первой оси на месте (исходный массив меняется). Возвращает None. Для 1D перемешиваются элементы; для 2D — порядок строк. Чтобы не портить исходный массив, используйте np.random.permutation(x) — он возвращает новую перемешанную копию.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-numpy-np-random-shuffle-14-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-numpy-np-random-shuffle-14-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-numpy-np-random-shuffle-14-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"https://numpy.org/doc/stable/reference/generated/numpy.random.shuffle.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
      ...
      {
        "type": "runnable",
        "initialCode": "import numpy as np\n\n# Практическое применение в пайплайне\nprint('Запуск: np.random.shuffle')\ntry:\n    # Инкапсулируем в функцию\n    def process_data():\n        val = np.random.shuffle(x)\n        return val\n    \n    out = process_data()\n    print('Успешное выполнение. Тип:', type(out))\nexcept Exception as e:\n    print('Ошибка выполнения:', e)",
        "solution": "",
        "hints": [],
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Устанавливает начальное состояние генератора случайных чисел. Один и тот же seed даёт одну и ту же последовательность. Вызывайте один раз в начале скрипта (или в начале цикла экспериментов) для воспроизводимости результатов. Число 42 — произвольное, любое фиксированное подойдёт.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-numpy-np-random-seed-15-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-numpy-np-random-seed-15-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-numpy-np-random-seed-15-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"https://numpy.org/doc/stable/reference/generated/numpy.random.Generator.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
      ...
      {
        "type": "runnable",
        "initialCode": "import numpy as np\n\n# Практическое применение в пайплайне\nprint('Запуск: np.random.seed')\ntry:\n    # Инкапсулируем в функцию\n    def process_data():\n        val = np.random.seed(42)\n        return val\n    \n    out = process_data()\n    print('Успешное выполнение. Тип:', type(out))\nexcept Exception as e:\n    print('Ошибка выполнения:', e)",
        "solution": "",
        "hints": [],
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Кортеж размеров по осям. Для матрицы 3×4 вернёт (3, 4). Это атрибут — вызывается без скобок: a.shape, не a.shape(). Для 1D массив из n элементов даст (n,). Удобно проверять размерности перед операциями.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-numpy-a-shape-16-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-numpy-a-shape-16-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-numpy-a-shape-16-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"https://numpy.org/doc/stable/reference/generated/numpy.ndarray.shape.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
        "initialCode": "import numpy as np\nprint(a.shape)",
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Число измерений (осей). 1 — вектор, 2 — матрица, 3 — тензор и т.д. Атрибут, без скобок. len(a.shape) даёт то же значение.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-numpy-a-ndim-17-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-numpy-a-ndim-17-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-numpy-a-ndim-17-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"'https://numpy.org/doc/stable/reference/generated/numpy.ndarray.html'\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
        "initialCode": "import numpy as np\nprint(a.ndim)",
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Общее число элементов в массиве (произведение всех размеров shape). Атрибут. Эквивалентно np.prod(a.shape).</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-numpy-a-size-18-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-numpy-a-size-18-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-numpy-a-size-18-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"'https://numpy.org/doc/stable/reference/generated/numpy.ndarray.html'\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
        "initialCode": "import numpy as np\nprint(a.size)",
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Тип данных элементов: np.float64, np.int32, np.bool_ и т.д. Только чтение. Важно при смешивании с другими типами или при сохранении в файл.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-numpy-a-dtype-19-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-numpy-a-dtype-19-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-numpy-a-dtype-19-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"'https://numpy.org/doc/stable/reference/generated/numpy.ndarray.dtype.html'\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
        "initialCode": "import numpy as np\nprint(a.dtype)",
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Метод: возвращает новый массив с приведением к типу dtype. Исходный массив не меняется.</div><div style='background-color: #1e293b; border-left: 4px solid #f59e0b; padding: 15px; margin: 20px 0; border-radius: 4px;'><h4 style='margin: 0 0 10px 0; color: #fcd34d;'>💡 Нюансы и параметры:</h4><p style='margin: 0; font-size: 0.95rem; color: #cbd5e1;'>Параметры: dtype (обязательный), copy=True. При приведении float → int дробная часть отбрасывается (не округление!).</p></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-numpy-a-astype-20-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-numpy-a-astype-20-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-numpy-a-astype-20-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"https://numpy.org/doc/stable/reference/generated/numpy.ndarray.astype.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Транспонирование: строки и столбцы меняются местами. Для 2D (матрица) — атрибут, без скобок. Возвращает вид (view), где возможно — без копии данных. Для 1D массив не меняется (тот же вид).</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-numpy-a-t-21-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-numpy-a-t-21-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-numpy-a-t-21-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"https://numpy.org/doc/stable/reference/generated/numpy.ndarray.T.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
        "initialCode": "import numpy as np\nprint(a.T)",
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Один элемент: a[0] — первый (индексы с нуля); для 2D a[i, j] — элемент в строке i, столбце j. Отрицательный индекс: a[-1] — последний элемент. Возвращает скаляр (тип np — int64, float64 и т.д.).</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-numpy-a-0-na-i-j-2d-22-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-numpy-a-0-na-i-j-2d-22-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-numpy-a-0-na-i-j-2d-22-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"'https://numpy.org/doc/stable/user/basics.indexing.html'\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
        "initialCode": "import numpy as np\na[0]\nprint(a[i, j]  # 2D)",
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Срезы: start:stop:step. stop не входит! a[1:4] — индексы 1, 2, 3. Для 2D a[0:3, 1:4] — подматрица: строки 0,1,2 и столбцы 1,2,3. Пропуск start/stop: a[:4] — с начала, a[2:] — до конца. step: a[::2] — каждый второй. Срез возвращает вид (view), изменения влияют на исходный массив.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-numpy-a-1-4-na-0-3-1-4-2d-23-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-numpy-a-1-4-na-0-3-1-4-2d-23-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-numpy-a-1-4-na-0-3-1-4-2d-23-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"'https://numpy.org/doc/stable/user/basics.indexing.html'\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Булева маска: в скобках выражение, дающее массив булевых той же формы (a > 0, a == 5 и т.д.). Возвращается 1D массив из элементов, где условие True. Удобно фильтровать данные. Результат — копия, не вид.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-numpy-a-a-0-24-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-numpy-a-a-0-24-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-numpy-a-a-0-24-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"'https://numpy.org/doc/stable/user/basics.indexing.html'\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
        "initialCode": "import numpy as np\nprint(a[a > 0])",
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Fancy indexing: передаёте список или массив индексов — получаете массив из выбранных элементов (в 1D) или строк (в 2D). a[[0, 2, 4]] — элементы с индексами 0, 2, 4. Результат — копия. Порядок в списке может быть любым, повторения допустимы.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-numpy-a-0-2-4-25-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-numpy-a-0-2-4-25-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-numpy-a-0-2-4-25-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"'https://numpy.org/doc/stable/user/basics.indexing.html'\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
        "initialCode": "import numpy as np\nprint(a[[0, 2, 4]])",
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Метод: придаёт массиву новую форму. Общее число элементов должно совпадать (например 3×4 = 12 и 6×2 = 12). Параметр shape можно передать отдельными аргументами или кортежем. reshape(-1) — \"развернуть\" в 1D (одна строка). reshape(-1, 2) — неизвестное число строк, 2 столбца. Возвращает вид, если память непрерывна; иначе копию.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-numpy-a-reshape-26-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-numpy-a-reshape-26-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-numpy-a-reshape-26-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"https://numpy.org/doc/stable/reference/generated/numpy.ndarray.reshape.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
        "initialCode": "import numpy as np\nprint(a.reshape(6, 2))",
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Метод: возвращает копию массива, сведённую к одному измерению (все элементы подряд, порядок C — по строкам). Всегда копия. Для вида используйте ravel() (но ravel может вернуть вид или копию).</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-numpy-a-flatten-27-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-numpy-a-flatten-27-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-numpy-a-flatten-27-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"https://numpy.org/doc/stable/reference/generated/numpy.ndarray.flatten.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
        "initialCode": "import numpy as np\nprint(a.flatten())",
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Склеивает массивы вдоль заданной оси. Первый аргумент — последовательность массивов (кортеж или список). axis=0 — добавлять по строкам (вертикально); axis=1 — по столбцам (горизонтально). Размеры по остальным осям должны совпадать. Возвращает новый массив.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-numpy-np-concatenate-28-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-numpy-np-concatenate-28-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-numpy-np-concatenate-28-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"https://numpy.org/doc/stable/reference/generated/numpy.concatenate.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>vstack — вертикальное объединение (по оси 0): массивы ставятся друг под другом. hstack — горизонтальное (по оси 1): друг рядом. Удобные обёртки над concatenate. Для 1D массивов vstack сделает из них строки матрицы.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-numpy-np-vstack-29-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-numpy-np-vstack-29-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-numpy-np-vstack-29-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"https://numpy.org/doc/stable/reference/generated/numpy.vstack.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
        "initialCode": "import numpy as np\nnp.vstack((a, b))\nprint(np.hstack((a, b)))",
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Операторы +, -, *, /, ** применяются поэлементно (element-wise). Для a * b каждый элемент умножается с соответствующим. Формы массивов должны быть совместимы: одинаковые или по правилам broadcasting (например массив (3,4) + массив (4,) — столбец повторяется по строкам). Результат — массив.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-numpy-a-b-na-b-30-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-numpy-a-b-na-b-30-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-numpy-a-b-na-b-30-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"'https://numpy.org/doc/stable/user/basics.broadcasting.html'\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
        "initialCode": "import numpy as np\na + b\nprint(a * b)",
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Универсальные функции (ufunc): один массив на вход, массив той же формы на выход. np.sqrt(a) — корень из каждого элемента (для отрицательных — nan). np.abs(a) — модуль. Вызов через np., не через точку от массива. Другие: np.exp, np.log, np.sin, np.round.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-numpy-np-sqrt-31-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-numpy-np-sqrt-31-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-numpy-np-sqrt-31-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"https://numpy.org/doc/stable/reference/generated/numpy.sqrt.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
        "initialCode": "import numpy as np\nnp.sqrt(a)\nprint(np.abs(a))",
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Матричное умножение. Для 2D массивов: (A @ B)[i,j] = сумма по k A[i,k]*B[k,j]. Размеры: (n, k) @ (k, m) = (n, m). Оператор @ — то же для матриц. np.dot для 1D — скалярное произведение; для 2D — произведение матриц. Не путать с поэлементным умножением *.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-numpy-np-dot-32-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-numpy-np-dot-32-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-numpy-np-dot-32-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"https://numpy.org/doc/stable/reference/generated/numpy.dot.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Обратная матрица A⁻¹ такая, что A @ inv(A) ≈ I. A должна быть квадратной и невырожденной (определитель ≠ 0). При плохой обусловленности возможны численные ошибки. Для решения систем лучше использовать solve.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-numpy-np-linalg-inv-33-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-numpy-np-linalg-inv-33-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-numpy-np-linalg-inv-33-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"https://numpy.org/doc/stable/reference/generated/numpy.linalg.inv.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Решает систему линейных уравнений Ax = b. Возвращает x.</div><div style='background-color: #1e293b; border-left: 4px solid #f59e0b; padding: 15px; margin: 20px 0; border-radius: 4px;'><h4 style='margin: 0 0 10px 0; color: #fcd34d;'>💡 Нюансы и параметры:</h4><p style='margin: 0; font-size: 0.95rem; color: #cbd5e1;'>Параметры: A (матрица коэффициентов), b (вектор или матрица правых частей). Численно устойчивее, чем x = inv(A) @ b. Если b 2D, решается несколько систем с разными правыми частями.</p></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-numpy-np-linalg-solve-34-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-numpy-np-linalg-solve-34-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-numpy-np-linalg-solve-34-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"https://numpy.org/doc/stable/reference/generated/numpy.linalg.solve.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Норма вектора или матрицы. По умолчанию ord=None — L2-норма (евклидова).</div><div style='background-color: #1e293b; border-left: 4px solid #f59e0b; padding: 15px; margin: 20px 0; border-radius: 4px;'><h4 style='margin: 0 0 10px 0; color: #fcd34d;'>💡 Нюансы и параметры:</h4><p style='margin: 0; font-size: 0.95rem; color: #cbd5e1;'>Параметры: x, ord (например 2, 1, np.inf), axis (по какой оси считать). Для вектора norm(x) — длина. Для матрицы — норма Фробениуса.</p></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-numpy-np-linalg-norm-35-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-numpy-np-linalg-norm-35-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-numpy-np-linalg-norm-35-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"https://numpy.org/doc/stable/reference/generated/numpy.linalg.norm.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Сумма и среднее арифметическое по всем элементам (или по оси).</div><div style='background-color: #1e293b; border-left: 4px solid #f59e0b; padding: 15px; margin: 20px 0; border-radius: 4px;'><h4 style='margin: 0 0 10px 0; color: #fcd34d;'>💡 Нюансы и параметры:</h4><p style='margin: 0; font-size: 0.95rem; color: #cbd5e1;'>Параметры: a, axis=None (None — по всем элементам), dtype, keepdims. axis=0 — по столбцам (результат по строкам); axis=1 — по строкам. Вызов через np.sum(a), не a.sum() (хотя метод тоже есть).</p></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-numpy-np-sum-36-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-numpy-np-sum-36-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-numpy-np-sum-36-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"https://numpy.org/doc/stable/reference/generated/numpy.sum.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
        "initialCode": "import numpy as np\nnp.sum(a)\nprint(np.mean(a))",
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>min/max — минимальное и максимальное значение; с axis — по оси. argmin/argmax — индекс первого минимума/максимума (в плоском виде, если axis не задан). Для 2D с axis=1 argmax по строкам даёт индекс максимума в каждой строке. Полезно для классификации (индекс класса).</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-numpy-np-min-37-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-numpy-np-min-37-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-numpy-np-min-37-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"https://numpy.org/doc/stable/reference/generated/numpy.min.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
        "initialCode": "import numpy as np\nnp.min(a)\nnp.max(a)\nnp.argmin(a)\nprint(np.argmax(a))",
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Стандартное отклонение и дисперсия. Параметр ddof: ddof=0 (по умолчанию) — деление на N; ddof=1 — на N−1 (несмещённая оценка для выборки). axis — по какой оси считать. Для выборки из генеральной совокупности обычно ddof=1.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-numpy-np-std-38-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-numpy-np-std-38-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-numpy-np-std-38-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"https://numpy.org/doc/stable/reference/generated/numpy.std.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
        "initialCode": "import numpy as np\nnp.std(a)\nprint(np.var(a))",
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Стандартный импорт: все функции вызываются через префикс np. (np.array, np.zeros и т.д.). NumPy — это модуль, не класс: не создаёте объект, а вызываете функции модуля. Сокращение \"np\" принято во всей документации и примерах.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-numpy-import-numpy-as-np-e-39-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-numpy-import-numpy-as-np-e-39-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-numpy-import-numpy-as-np-e-39-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"'https://numpy.org/doc/stable/user/absolute_beginners.html'\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
        "initialCode": "import numpy as np\nimport numpy as np",
      ...
      {
        "type": "runnable",
        "initialCode": "import numpy as np\n\n# Практическое применение в пайплайне\nprint('Запуск: import numpy as np')\ntry:\n    # Инкапсулируем в функцию\n    def process_data():\n        val = import numpy as np\n        return val\n    \n    out = process_data()\n    print('Успешное выполнение. Тип:', type(out))\nexcept Exception as e:\n    print('Ошибка выполнения:', e)",
        "solution": "",
        "hints": [],
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>np.sort(a) — возвращает отсортированную копию массива; исходный массив не меняется. a.sort() — сортировка на месте (исходный массив перезаписывается), возвращает None. Параметр axis: по умолчанию -1 (последняя ось). Для 2D axis=0 сортирует каждую колонку, axis=1 — каждую строку. Порядок по возрастанию.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-numpy-np-sort-e-40-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-numpy-np-sort-e-40-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-numpy-np-sort-e-40-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"https://numpy.org/doc/stable/reference/generated/numpy.sort.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
        "initialCode": "import numpy as np\nnp.sort(a)\nprint(a.sort())",
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Возвращает массив индексов, задающих порядок сортировки по возрастанию. То есть a[np.argsort(a)] даёт отсортированный массив. Используется для сортировки по одному массиву и перестановки другого (например сортировка меток по оценкам). axis — по какой оси.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-numpy-np-argsort-e-41-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-numpy-np-argsort-e-41-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-numpy-np-argsort-e-41-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"https://numpy.org/doc/stable/reference/generated/numpy.argsort.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
        "initialCode": "import numpy as np\nprint(np.argsort(a))",
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Возвращает кортеж массивов индексов, где condition истинно. Для 1D один массив: np.where(a > 0) — индексы положительных элементов. Для 2D два массива (индексы строк и столбцов). Трёхаргументная форма: np.where(cond, x, y) — где cond истинно взять x, иначе y (поэлементно).</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-numpy-np-where-e-42-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-numpy-np-where-e-42-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-numpy-np-where-e-42-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"https://numpy.org/doc/stable/reference/generated/numpy.where.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
      ...
      {
        "type": "runnable",
        "initialCode": "import numpy as np\n\n# Практическое применение в пайплайне\nprint('Запуск: np.where')\ntry:\n    # Инкапсулируем в функцию\n    def process_data():\n        val = np.where(condition)\n        return val\n    \n    out = process_data()\n    print('Успешное выполнение. Тип:', type(out))\nexcept Exception as e:\n    print('Ошибка выполнения:', e)",
        "solution": "",
        "hints": [],
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Возвращает отсортированный массив уникальных значений.</div><div style='background-color: #1e293b; border-left: 4px solid #f59e0b; padding: 15px; margin: 20px 0; border-radius: 4px;'><h4 style='margin: 0 0 10px 0; color: #fcd34d;'>💡 Нюансы и параметры:</h4><p style='margin: 0; font-size: 0.95rem; color: #cbd5e1;'>Параметры: return_index (индексы первого вхождения), return_inverse (обратные индексы для восстановления), return_counts (сколько раз каждый элемент). Полезно для категориальных признаков и подсчёта уникальных меток.</p></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-numpy-np-unique-e-43-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-numpy-np-unique-e-43-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-numpy-np-unique-e-43-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"https://numpy.org/doc/stable/reference/generated/numpy.unique.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
        "initialCode": "import numpy as np\nprint(np.unique(a))",
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Стандартный импорт: все классы и функции вызываются через pd. (pd.DataFrame, pd.read_csv, pd.Series и т.д.). Сокращение \"pd\" принято во всей документации.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-pandas-import-pandas-as-pd-e-44-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-pandas-import-pandas-as-pd-e-44-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-pandas-import-pandas-as-pd-e-44-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"'https://pandas.pydata.org/docs/getting_started/index.html'\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
      ...
      {
        "type": "runnable",
        "initialCode": "import pandas as pd\nimport numpy as np\n\n# Практическое применение в пайплайне\nprint('Запуск: import pandas as pd')\ntry:\n    # Инкапсулируем в функцию\n    def process_data():\n        val = import pandas as pd\n        return val\n    \n    out = process_data()\n    print('Успешное выполнение. Тип:', type(out))\nexcept Exception as e:\n    print('Ошибка выполнения:', e)",
        "solution": "",
        "hints": [],
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>DataFrame — таблица с именованными столбцами и индексом строк. Создание: из словаря (ключи — имена столбцов, значения — списки/массивы данных), из списка списков с указанием columns, из ndarray. index — метки строк (по умолчанию 0, 1, 2, ...). columns задаёт порядок и набор столбцов. Возвращает DataFrame.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-pandas-pd-dataframe-e-45-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-pandas-pd-dataframe-e-45-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-pandas-pd-dataframe-e-45-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"https://pandas.pydata.org/docs/reference/api/pandas.DataFrame.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
      ...
      {
        "type": "runnable",
        "initialCode": "import pandas as pd\nimport numpy as np\n\n# Практическое применение в пайплайне\nprint('Запуск: pd.DataFrame')\ntry:\n    # Инкапсулируем в функцию\n    def process_data():\n        val = df = pd.DataFrame(data, columns=[\"x\", \"y\"], index=[0, 1])\n        return val\n    \n    out = process_data()\n    print('Успешное выполнение. Тип:', type(out))\nexcept Exception as e:\n    print('Ошибка выполнения:', e)",
        "solution": "",
        "hints": [],
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Series — одномерная структура с метками (индексом). data — список или массив; index — метки (по умолчанию 0, 1, 2, ...). Один столбец DataFrame по сути Series. Используется для одной переменной или для результата выборки одного столбца.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-pandas-pd-series-e-46-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-pandas-pd-series-e-46-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-pandas-pd-series-e-46-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"https://pandas.pydata.org/docs/reference/api/pandas.Series.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
      ...
      {
        "type": "runnable",
        "initialCode": "import pandas as pd\nimport numpy as np\n\n# Практическое применение в пайплайне\nprint('Запуск: pd.Series')\ntry:\n    # Инкапсулируем в функцию\n    def process_data():\n        val = pd.Series([1, 2, 3], index=[\"a\", \"b\", \"c\"])\n        return val\n    \n    out = process_data()\n    print('Успешное выполнение. Тип:', type(out))\nexcept Exception as e:\n    print('Ошибка выполнения:', e)",
        "solution": "",
        "hints": [],
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Читает CSV в DataFrame.</div><div style='background-color: #1e293b; border-left: 4px solid #f59e0b; padding: 15px; margin: 20px 0; border-radius: 4px;'><h4 style='margin: 0 0 10px 0; color: #fcd34d;'>💡 Нюансы и параметры:</h4><p style='margin: 0; font-size: 0.95rem; color: #cbd5e1;'>Параметры: filepath_or_buffer (путь или URL), sep=\",\" (разделитель), header=0 (какая строка — заголовки; None если заголовков нет), encoding=\"utf-8\" (для кириллицы часто utf-8 или cp1251), usecols (какие столбцы читать), na_values (что считать пропуском). Возвращает DataFrame. Для больших файлов: chunksize — читать по кускам.</p></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-pandas-pd-read-csv-e-47-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-pandas-pd-read-csv-e-47-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-pandas-pd-read-csv-e-47-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"https://pandas.pydata.org/docs/reference/api/pandas.read_csv.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
      ...
      {
        "type": "runnable",
        "initialCode": "import pandas as pd\nimport numpy as np\n\n# Практическое применение в пайплайне\nprint('Запуск: pd.read_csv')\ntry:\n    # Инкапсулируем в функцию\n    def process_data():\n        val = pd.read_csv(\"file.csv\", sep=\",\", header=0, encoding=\"utf-8\")\n        return val\n    \n    out = process_data()\n    print('Успешное выполнение. Тип:', type(out))\nexcept Exception as e:\n    print('Ошибка выполнения:', e)",
        "solution": "",
        "hints": [],
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Читает лист Excel. sheet_name — номер листа (0, 1, ...) или имя листа (строка). Требует установленный openpyxl (для .xlsx) или xlrd (для .xls). Возвращает DataFrame. Несколько листов: sheet_name=None возвращает словарь {имя_листа: DataFrame}.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-pandas-pd-read-excel-e-48-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-pandas-pd-read-excel-e-48-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-pandas-pd-read-excel-e-48-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"https://pandas.pydata.org/docs/reference/api/pandas.read_excel.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
      ...
      {
        "type": "runnable",
        "initialCode": "import pandas as pd\nimport numpy as np\n\n# Практическое применение в пайплайне\nprint('Запуск: pd.read_excel')\ntry:\n    # Инкапсулируем в функцию\n    def process_data():\n        val = pd.read_excel(\"file.xlsx\", sheet_name=0)\n        return val\n    \n    out = process_data()\n    print('Успешное выполнение. Тип:', type(out))\nexcept Exception as e:\n    print('Ошибка выполнения:', e)",
        "solution": "",
        "hints": [],
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Методы DataFrame: сохраняют таблицу в файл. to_csv: sep=\",\", index=True (писать ли индекс), encoding. to_excel: нужен openpyxl. Возвращают None. Для больших данных to_csv быстрее и компактнее.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-pandas-df-to-csv-e-49-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-pandas-df-to-csv-e-49-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-pandas-df-to-csv-e-49-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"https://pandas.pydata.org/docs/reference/api/pandas.DataFrame.to_csv.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
      ...
      {
        "type": "runnable",
        "initialCode": "import pandas as pd\nimport numpy as np\n\n# Практическое применение в пайплайне\nprint('Запуск: df.to_csv')\ntry:\n    # Инкапсулируем в функцию\n    def process_data():\n        val = df.to_excel(\"out.xlsx\")\n        return val\n    \n    out = process_data()\n    print('Успешное выполнение. Тип:', type(out))\nexcept Exception as e:\n    print('Ошибка выполнения:', e)",
        "solution": "",
        "hints": [],
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Методы: первые или последние n строк таблицы. head(n=5), tail(n=5). Удобно для быстрого просмотра без вывода всего датасета. Возвращают DataFrame.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-pandas-df-head-e-50-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-pandas-df-head-e-50-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-pandas-df-head-e-50-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"https://pandas.pydata.org/docs/reference/api/pandas.DataFrame.head.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
        "initialCode": "import pandas as pd\nimport numpy as np\ndf.head(5)\nprint(df.tail(5))",
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Атрибуты (без скобок). shape — кортеж (число строк, число столбцов). columns — индекс с именами столбцов (можно перебирать или df.columns = [\"a\",\"b\"]). dtypes — тип каждого столбца (int64, float64, object и т.д.).</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-pandas-df-shape-ndf-columns-ndf-dtypes-e-51-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-pandas-df-shape-ndf-columns-ndf-dtypes-e-51-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-pandas-df-shape-ndf-columns-ndf-dtypes-e-51-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"'https://pandas.pydata.org/docs/reference/api/pandas.DataFrame.html'\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
        "initialCode": "import pandas as pd\nimport numpy as np\ndf.shape\ndf.columns\nprint(df.dtypes)",
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>info() — краткая сводка: число строк, список столбцов, типы, число непустых значений, использование памяти. describe() — статистика по числовым столбцам (count, mean, std, min, квантили, max). Для категориальных describe(include=\"object\"). Вызов: df.info(), df.describe().</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-pandas-df-info-e-52-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-pandas-df-info-e-52-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-pandas-df-info-e-52-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"https://pandas.pydata.org/docs/reference/api/pandas.DataFrame.info.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
        "initialCode": "import pandas as pd\nimport numpy as np\ndf.info()\nprint(df.describe())",
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Один столбец: возвращает Series. Синтаксис df[\"col\"] работает всегда (в т.ч. если имя с пробелами). df.col — только если имя столбца без пробелов и не конфликтует с методом. Результат — ссылка на данные; изменение может изменить исходный df (осторожно с присваиванием).</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-pandas-df-col-ndf-col-e-53-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-pandas-df-col-ndf-col-e-53-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-pandas-df-col-ndf-col-e-53-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"'https://pandas.pydata.org/docs/user_guide/indexing.html'\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
        "initialCode": "import pandas as pd\nimport numpy as np\ndf[\"col\"]\nprint(df.col)",
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Несколько столбцов: передаёте список имён — возвращается DataFrame с этими столбцами в указанном порядке. Удобно для подмножества признаков или перестановки столбцов.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-pandas-df-col1-col2-e-54-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-pandas-df-col1-col2-e-54-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-pandas-df-col1-col2-e-54-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"'https://pandas.pydata.org/docs/user_guide/indexing.html'\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
        "initialCode": "import pandas as pd\nimport numpy as np\nprint(df[[\"col1\", \"col2\"]])",
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Доступ по меткам (labels): loc[индекс_строки, индекс_столбца]. Одна метка — скаляр; срез — подтаблица. df.loc[df[\"x\"] > 0] — фильтр строк: оставить только те, где в столбце \"x\" значение больше 0. Можно передать список меток, срез меток или булев Series (длина как у индекса).</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-pandas-df-loc-0-a-ndf-loc-df-x-0-e-55-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-pandas-df-loc-0-a-ndf-loc-df-x-0-e-55-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-pandas-df-loc-0-a-ndf-loc-df-x-0-e-55-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"https://pandas.pydata.org/docs/reference/api/pandas.DataFrame.loc.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
        "initialCode": "import pandas as pd\nimport numpy as np\ndf.loc[0, \"A\"]\nprint(df.loc[df[\"x\"] > 0])",
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Доступ по целочисленным позициям: iloc[позиция_строки, позиция_столбца]. Работает как срезы в NumPy: 0:5 — строки 0,1,2,3,4. Удобно когда не важно имя столбца/индекса, важна только позиция. Отрицательные индексы — с конца.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-pandas-df-iloc-0-5-1-4-e-56-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-pandas-df-iloc-0-5-1-4-e-56-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-pandas-df-iloc-0-5-1-4-e-56-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"https://pandas.pydata.org/docs/reference/api/pandas.DataFrame.iloc.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>isna() — DataFrame той же формы с True там, где пропуск (NaN, None). dropna() — удаляет строки (axis=0) или столбцы (axis=1) с пропусками. how=\"any\" — удалить если есть хотя бы один пропуск; how=\"all\" — только если все значения в строке/столбце пропуски. inplace=False — по умолчанию возвращает новый DataFrame.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-pandas-df-isna-e-57-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-pandas-df-isna-e-57-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-pandas-df-isna-e-57-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"https://pandas.pydata.org/docs/reference/api/pandas.DataFrame.dropna.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
      ...
      {
        "type": "runnable",
        "initialCode": "import pandas as pd\nimport numpy as np\n\n# Практическое применение в пайплайне\nprint('Запуск: df.isna')\ntry:\n    # Инкапсулируем в функцию\n    def process_data():\n        val = df.dropna(axis=0, how=\"any\")\n        return val\n    \n    out = process_data()\n    print('Успешное выполнение. Тип:', type(out))\nexcept Exception as e:\n    print('Ошибка выполнения:', e)",
        "solution": "",
        "hints": [],
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Заполняет пропуски. fillna(0) — константой 0. fillna(method=\"ffill\") — forward fill: предыдущее известное значение (по столбцу). method=\"bfill\" — backward fill. limit — максимум подряд заполняемых пропусков. Возвращает новый DataFrame (или меняет inplace=True).</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-pandas-df-fillna-e-58-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-pandas-df-fillna-e-58-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-pandas-df-fillna-e-58-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"https://pandas.pydata.org/docs/reference/api/pandas.DataFrame.fillna.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
      ...
      {
        "type": "runnable",
        "initialCode": "import pandas as pd\nimport numpy as np\n\n# Практическое применение в пайплайне\nprint('Запуск: df.fillna')\ntry:\n    # Инкапсулируем в функцию\n    def process_data():\n        val = df.fillna(method=\"ffill\")\n        return val\n    \n    out = process_data()\n    print('Успешное выполнение. Тип:', type(out))\nexcept Exception as e:\n    print('Ошибка выполнения:', e)",
        "solution": "",
        "hints": [],
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>drop(columns=[\"col\"]) — удалить столбец (столбцы). drop(index=[...]) — удалить строки по меткам. drop_duplicates() — оставить уникальные строки (по всем столбцам или по subset=[\"col\"]). keep=\"first\" — какую дублирующую строку оставить. Возвращает новый DataFrame.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-pandas-df-drop-e-59-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-pandas-df-drop-e-59-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-pandas-df-drop-e-59-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"https://pandas.pydata.org/docs/reference/api/pandas.DataFrame.drop.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>groupby(\"col\") — разбивает DataFrame на группы по значениям столбца \"col\". Дальше вызывают агрегаты: .sum(), .mean(), .agg({\"other\": \"mean\", \"x\": \"sum\"}) — для каждого столбца своя функция. Результат — DataFrame с индексом по уникальным значениям \"col\". Несколько столбцов группировки: groupby([\"col1\", \"col2\"]).</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-pandas-df-groupby-e-60-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-pandas-df-groupby-e-60-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-pandas-df-groupby-e-60-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"https://pandas.pydata.org/docs/reference/api/pandas.DataFrame.groupby.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
      ...
      {
        "type": "runnable",
        "initialCode": "import pandas as pd\nimport numpy as np\n\n# Практическое применение в пайплайне\nprint('Запуск: df.groupby')\ntry:\n    # Инкапсулируем в функцию\n    def process_data():\n        val = df.groupby(\"col\").agg({\"other\": \"mean\", \"x\": \"sum\"})\n        return val\n    \n    out = process_data()\n    print('Успешное выполнение. Тип:', type(out))\nexcept Exception as e:\n    print('Ошибка выполнения:', e)",
        "solution": "",
        "hints": [],
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Методы по умолчанию считают по столбцам (axis=0): каждая строка результата — одно число по столбцу. mean(), sum() — среднее и сумма; пропуски пропускаются. corr() — корреляционная матрица между числовыми столбцами. axis=1 — считать по строкам. Возвращают Series или DataFrame.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-pandas-df-mean-e-61-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-pandas-df-mean-e-61-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-pandas-df-mean-e-61-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"https://pandas.pydata.org/docs/reference/api/pandas.DataFrame.mean.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
        "initialCode": "import pandas as pd\nimport numpy as np\ndf.mean()\ndf.sum()\nprint(df.corr())",
  ...
  },
  {
    ...
    "codeBlocks": [
      ...
      {
        "type": "runnable",
        "initialCode": "\n# Практическое применение в пайплайне\nprint('Запуск: from sklearn.preprocessing import Standa')\ntry:\n    # Инкапсулируем в функцию\n    def process_data():\n        val = X_train_scaled = scaler.transform(X_train)\n        return val\n    \n    out = process_data()\n    print('Успешное выполнение. Тип:', type(out))\nexcept Exception as e:\n    print('Ошибка выполнения:', e)",
        "solution": "",
        "hints": [],
  ...
  },
  {
    ...
    "codeBlocks": [
      ...
      {
        "type": "runnable",
        "initialCode": "\n# Практическое применение в пайплайне\nprint('Запуск: from sklearn.pipeline import Pipeline\\np')\ntry:\n    # Инкапсулируем в функцию\n    def process_data():\n        val = y_pred = pipe.predict(X_test)\n        return val\n    \n    out = process_data()\n    print('Успешное выполнение. Тип:', type(out))\nexcept Exception as e:\n    print('Ошибка выполнения:', e)",
        "solution": "",
        "hints": [],
  ...
  },
  {
    ...
    "codeBlocks": [
      ...
      {
        "type": "runnable",
        "initialCode": "\n# Практическое применение в пайплайне\nprint('Запуск: from sklearn.linear_model import LinearR')\ntry:\n    # Инкапсулируем в функцию\n    def process_data():\n        val = y_pred = model.predict(X_test)\n        return val\n    \n    out = process_data()\n    print('Успешное выполнение. Тип:', type(out))\nexcept Exception as e:\n    print('Ошибка выполнения:', e)",
        "solution": "",
        "hints": [],
  ...
  },
  {
    ...
    "codeBlocks": [
      ...
      {
        "type": "runnable",
        "initialCode": "\n# Практическое применение в пайплайне\nprint('Запуск: from sklearn.linear_model import Logisti')\ntry:\n    # Инкапсулируем в функцию\n    def process_data():\n        val = model.predict_proba(X_test)\n        return val\n    \n    out = process_data()\n    print('Успешное выполнение. Тип:', type(out))\nexcept Exception as e:\n    print('Ошибка выполнения:', e)",
        "solution": "",
        "hints": [],
  ...
  },
  {
    ...
    "codeBlocks": [
      ...
      {
        "type": "runnable",
        "initialCode": "\n# Практическое применение в пайплайне\nprint('Запуск: from sklearn.ensemble import RandomFores')\ntry:\n    # Инкапсулируем в функцию\n    def process_data():\n        val = model.fit(X_train, y_train)\n        return val\n    \n    out = process_data()\n    print('Успешное выполнение. Тип:', type(out))\nexcept Exception as e:\n    print('Ошибка выполнения:', e)",
        "solution": "",
        "hints": [],
  ...
  },
  {
    ...
    "codeBlocks": [
      ...
      {
        "type": "runnable",
        "initialCode": "\n# Практическое применение в пайплайне\nprint('Запуск: from sklearn.metrics import mean_squared')\ntry:\n    # Инкапсулируем в функцию\n    def process_data():\n        val = acc = accuracy_score(y_true, y_pred)\n        return val\n    \n    out = process_data()\n    print('Успешное выполнение. Тип:', type(out))\nexcept Exception as e:\n    print('Ошибка выполнения:', e)",
        "solution": "",
        "hints": [],
  ...
  },
  {
    ...
    "codeBlocks": [
      ...
      {
        "type": "runnable",
        "initialCode": "import cv2\nimport numpy as np\n\n# Практическое применение в пайплайне\nprint('Запуск: import cv2\\nimg = cv2.imread(\"path.jpg\",')\ntry:\n    # Инкапсулируем в функцию\n    def process_data():\n        val = img = cv2.imread(\"path.jpg\", cv2.IMREAD_COLOR)\n        return val\n    \n    out = process_data()\n    print('Успешное выполнение. Тип:', type(out))\nexcept Exception as e:\n    print('Ошибка выполнения:', e)",
        "solution": "",
        "hints": [],
  ...
  },
  {
    ...
    "codeBlocks": [
      ...
      {
        "type": "runnable",
        "initialCode": "import cv2\nimport numpy as np\n\n# Практическое применение в пайплайне\nprint('Запуск: cv2.imshow')\ntry:\n    # Инкапсулируем в функцию\n    def process_data():\n        val = cv2.destroyAllWindows()\n        return val\n    \n    out = process_data()\n    print('Успешное выполнение. Тип:', type(out))\nexcept Exception as e:\n    print('Ошибка выполнения:', e)",
        "solution": "",
        "hints": [],
  ...
  },
  {
    ...
    "codeBlocks": [
      ...
      {
        "type": "runnable",
        "initialCode": "import cv2\nimport numpy as np\n\n# Исследование свойств объекта\nresult = cv2.imwrite(\"out.jpg\", img)\nprint('Результат:', result)\nif hasattr(result, 'shape'):\n    print('Форма (shape):', result.shape)\nif hasattr(result, 'dtype'):\n    print('Тип данных:', result.dtype)",
        "solution": "",
        "hints": [],
      ...
      {
        "type": "runnable",
        "initialCode": "import cv2\nimport numpy as np\n\n# Практическое применение в пайплайне\nprint('Запуск: cv2.imwrite')\ntry:\n    # Инкапсулируем в функцию\n    def process_data():\n        val = cv2.imwrite(\"out.jpg\", img)\n        return val\n    \n    out = process_data()\n    print('Успешное выполнение. Тип:', type(out))\nexcept Exception as e:\n    print('Ошибка выполнения:', e)",
        "solution": "",
        "hints": [],
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Изображение в OpenCV — это ndarray NumPy. shape — кортеж: для цветного (высота, ширина, 3), для grayscale (высота, ширина). Порядок: сначала строки (высота), потом столбцы (ширина). size — общее число элементов (H*W*3 или H*W). dtype — обычно np.uint8 (0–255). Обращение к пикселю: img[y, x] (сначала строка y, потом столбец x).</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-opencv-img-shape-nimg-size-nimg-dtype-e-72-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-opencv-img-shape-nimg-size-nimg-dtype-e-72-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-opencv-img-shape-nimg-size-nimg-dtype-e-72-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"'https://numpy.org/doc/stable/reference/generated/numpy.ndarray.html'\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
        "initialCode": "import cv2\nimport numpy as np\nimg.shape\nimg.size\nprint(img.dtype)",
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Преобразует изображение из одного цветового пространства в другое. Первый аргумент — массив изображения, второй — код преобразования: cv2.COLOR_BGR2GRAY (в оттенки серого), cv2.COLOR_BGR2RGB (для matplotlib), cv2.COLOR_BGR2HSV (для сегментации по цвету) и т.д. Возвращает новый массив. Размер не меняется (кроме числа каналов).</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-opencv-gray-cv2-cvtcolor-img-cv2-color-bgr2g-e-73-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-opencv-gray-cv2-cvtcolor-img-cv2-color-bgr2g-e-73-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-opencv-gray-cv2-cvtcolor-img-cv2-color-bgr2g-e-73-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"https://docs.opencv.org/4.x/d8/d01/group__imgproc__color__conversions.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
      ...
      {
        "type": "runnable",
        "initialCode": "import cv2\nimport numpy as np\n\n# Практическое применение в пайплайне\nprint('Запуск: gray = cv2.cvtColor(img, cv2.COLOR_BGR2G')\ntry:\n    # Инкапсулируем в функцию\n    def process_data():\n        val = gray = cv2.cvtColor(img, cv2.COLOR_BGR2GRAY)\n        return val\n    \n    out = process_data()\n    print('Успешное выполнение. Тип:', type(out))\nexcept Exception as e:\n    print('Ошибка выполнения:', e)",
        "solution": "",
        "hints": [],
  ...
  },
  {
    ...
    "codeBlocks": [
      ...
      {
        "type": "runnable",
        "initialCode": "import cv2\nimport numpy as np\n\n# Практическое применение в пайплайне\nprint('Запуск: resized = cv2.resize(img, (width, height')\ntry:\n    # Инкапсулируем в функцию\n    def process_data():\n        val = resized = cv2.resize(img, None, fx=0.5, fy=0.5)\n        return val\n    \n    out = process_data()\n    print('Успешное выполнение. Тип:', type(out))\nexcept Exception as e:\n    print('Ошибка выполнения:', e)",
        "solution": "",
        "hints": [],
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Гауссово размытие: сглаживает изображение, уменьшает шум.</div><div style='background-color: #1e293b; border-left: 4px solid #f59e0b; padding: 15px; margin: 20px 0; border-radius: 4px;'><h4 style='margin: 0 0 10px 0; color: #fcd34d;'>💡 Нюансы и параметры:</h4><p style='margin: 0; font-size: 0.95rem; color: #cbd5e1;'>Параметры: изображение, размер ядра (кортеж (kwidth, kheight); оба числа нечётные), sigmaX (0 — считается по размеру ядра). Возвращает новый массив той же формы. Большое ядро — сильнее размытие. Часто применяют перед Canny для уменьшения шума на границах.</p></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-opencv-blurred-cv2-gaussianblur-img-5-5-e-75-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-opencv-blurred-cv2-gaussianblur-img-5-5-e-75-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-opencv-blurred-cv2-gaussianblur-img-5-5-e-75-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"https://docs.opencv.org/4.x/d4/d86/group__imgproc__filter.html#gaabe8c836e97159a9193eff0bccac43a3\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
      ...
      {
        "type": "runnable",
        "initialCode": "import cv2\nimport numpy as np\n\n# Практическое применение в пайплайне\nprint('Запуск: blurred = cv2.GaussianBlur(img, (5, 5), ')\ntry:\n    # Инкапсулируем в функцию\n    def process_data():\n        val = blurred = cv2.GaussianBlur(img, (5, 5), 0)\n        return val\n    \n    out = process_data()\n    print('Успешное выполнение. Тип:', type(out))\nexcept Exception as e:\n    print('Ошибка выполнения:', e)",
        "solution": "",
        "hints": [],
  ...
  },
  {
    ...
    "codeBlocks": [
      ...
      {
        "type": "runnable",
        "initialCode": "import cv2\nimport numpy as np\n\n# Практическое применение в пайплайне\nprint('Запуск: edges = cv2.Canny(img, 100, 200)')\ntry:\n    # Инкапсулируем в функцию\n    def process_data():\n        val = edges = cv2.Canny(img, 100, 200)\n        return val\n    \n    out = process_data()\n    print('Успешное выполнение. Тип:', type(out))\nexcept Exception as e:\n    print('Ошибка выполнения:', e)",
        "solution": "",
        "hints": [],
  ...
  },
  {
    ...
    "codeBlocks": [
      ...
      {
        "type": "runnable",
        "initialCode": "import cv2\nimport numpy as np\n\n# Практическое применение в пайплайне\nprint('Запуск: contours, hierarchy = cv2.findContours(b')\ntry:\n    # Инкапсулируем в функцию\n    def process_data():\n        val = cv2.drawContours(img, contours, -1, (0, 255, 0), 2)\n        return val\n    \n    out = process_data()\n    print('Успешное выполнение. Тип:', type(out))\nexcept Exception as e:\n    print('Ошибка выполнения:', e)",
        "solution": "",
        "hints": [],
  ...
  },
  {
    ...
    "codeBlocks": [
      ...
      {
        "type": "runnable",
        "initialCode": "import cv2\nimport numpy as np\n\n# Исследование свойств объекта\nresult = cv2.putText(img, \"text\", (x, y), cv2.FONT_HERSHEY_SIMPLEX, 1, (255, 255, 255))\nprint('Результат:', result)\nif hasattr(result, 'shape'):\n    print('Форма (shape):', result.shape)\nif hasattr(result, 'dtype'):\n    print('Тип данных:', result.dtype)",
        "solution": "",
        "hints": [],
      ...
      {
        "type": "runnable",
        "initialCode": "import cv2\nimport numpy as np\n\n# Практическое применение в пайплайне\nprint('Запуск: cv2.rectangle')\ntry:\n    # Инкапсулируем в функцию\n    def process_data():\n        val = cv2.putText(img, \"text\", (x, y), cv2.FONT_HERSHEY_SIMPLEX, 1, (255, 255, 255))\n        return val\n    \n    out = process_data()\n    print('Успешное выполнение. Тип:', type(out))\nexcept Exception as e:\n    print('Ошибка выполнения:', e)",
        "solution": "",
        "hints": [],
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>erode — эрозия (съедает белые пиксели с краев). dilate — дилатация (наращивает белые пиксели). getStructuringElement — создаёт ядро (MORPH_RECT, MORPH_ELLIPSE, MORPH_CROSS). Для удаления шума и склеивания компонентов.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-opencv-import-numpy-as-np-nimport-cv2-nimg-np-e-79-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-opencv-import-numpy-as-np-nimport-cv2-nimg-np-e-79-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-opencv-import-numpy-as-np-nimport-cv2-nimg-np-e-79-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"https://docs.opencv.org/4.x/d4/d86/group__imgproc__filter.html, true\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
      ...
      {
        "type": "runnable",
        "initialCode": "import cv2\nimport numpy as np\n\n# Практическое применение в пайплайне\nprint('Запуск: import numpy as np\\nimport cv2\\nimg = np')\ntry:\n    # Инкапсулируем в функцию\n    def process_data():\n        val = print(\"Erode/Dilate:\", eros.shape, dilat.shape)\n        return val\n    \n    out = process_data()\n    print('Успешное выполнение. Тип:', type(out))\nexcept Exception as e:\n    print('Ошибка выполнения:', e)",
        "solution": "",
        "hints": [],
  ...
  },
  {
    ...
    "codeBlocks": [
      ...
      {
        "type": "runnable",
        "initialCode": "import cv2\nimport numpy as np\n\n# Практическое применение в пайплайне\nprint('Запуск: import numpy as np\\nimport cv2\\nimg = np')\ntry:\n    # Инкапсулируем в функцию\n    def process_data():\n        val = print(\"MorphologyEx:\", closing.shape, opening.shape)\n        return val\n    \n    out = process_data()\n    print('Успешное выполнение. Тип:', type(out))\nexcept Exception as e:\n    print('Ошибка выполнения:', e)",
        "solution": "",
        "hints": [],
  ...
  },
  {
    ...
    "codeBlocks": [
      ...
      {
        "type": "runnable",
        "initialCode": "import cv2\nimport numpy as np\n\n# Практическое применение в пайплайне\nprint('Запуск: import numpy as np\\nimport cv2\\nimg = np')\ntry:\n    # Инкапсулируем в функцию\n    def process_data():\n        val = print(\"Thresholded shapes:\", thresh1.shape, thresh2.shape)\n        return val\n    \n    out = process_data()\n    print('Успешное выполнение. Тип:', type(out))\nexcept Exception as e:\n    print('Ошибка выполнения:', e)",
        "solution": "",
        "hints": [],
  ...
  },
  {
    ...
    "codeBlocks": [
      ...
      {
        "type": "runnable",
        "initialCode": "import cv2\nimport numpy as np\n\n# Практическое применение в пайплайне\nprint('Запуск: import numpy as np\\nimport cv2\\nimg = np')\ntry:\n    # Инкапсулируем в функцию\n    def process_data():\n        val = # cv2.normalize(hist, hist, 0, 255, cv2.NORM_MINMAX)\n        return val\n    \n    out = process_data()\n    print('Успешное выполнение. Тип:', type(out))\nexcept Exception as e:\n    print('Ошибка выполнения:', e)",
        "solution": "",
        "hints": [],
  ...
  },
  {
    ...
    "codeBlocks": [
      ...
      {
        "type": "runnable",
        "initialCode": "import cv2\nimport numpy as np\n\n# Практическое применение в пайплайне\nprint('Запуск: import numpy as np\\nimport cv2\\ngray = n')\ntry:\n    # Инкапсулируем в функцию\n    def process_data():\n        val = print(\"Equalize:\", eq.shape, \"CLAHE:\", clahe_img.shape)\n        return val\n    \n    out = process_data()\n    print('Успешное выполнение. Тип:', type(out))\nexcept Exception as e:\n    print('Ошибка выполнения:', e)",
        "solution": "",
        "hints": [],
  ...
  },
  {
    ...
    "codeBlocks": [
      ...
      {
        "type": "runnable",
        "initialCode": "import cv2\nimport numpy as np\n\n# Практическое применение в пайплайне\nprint('Запуск: import numpy as np\\nimport cv2\\nimg = np')\ntry:\n    # Инкапсулируем в функцию\n    def process_data():\n        val = print(\"Best match at:\", max_loc, \"val:\", round(max_val, 2))\n        return val\n    \n    out = process_data()\n    print('Успешное выполнение. Тип:', type(out))\nexcept Exception as e:\n    print('Ошибка выполнения:', e)",
        "solution": "",
        "hints": [],
  ...
  },
  {
    ...
    "codeBlocks": [
      ...
      {
        "type": "runnable",
        "initialCode": "import cv2\nimport numpy as np\n\n# Практическое применение в пайплайне\nprint('Запуск: import numpy as np\\nimport cv2\\ngray = n')\ntry:\n    # Инкапсулируем в функцию\n    def process_data():\n        val = # result[dst > 0.01 * dst.max()] = [0, 0, 255]\n        return val\n    \n    out = process_data()\n    print('Успешное выполнение. Тип:', type(out))\nexcept Exception as e:\n    print('Ошибка выполнения:', e)",
        "solution": "",
        "hints": [],
  ...
  },
  {
    ...
    "codeBlocks": [
      ...
      {
        "type": "runnable",
        "initialCode": "import cv2\nimport numpy as np\n\n# Практическое применение в пайплайне\nprint('Запуск: import numpy as np\\nimport cv2\\n# net = ')\ntry:\n    # Инкапсулируем в функцию\n    def process_data():\n        val = print(\"dnn: blobFromImage, setInput, forward, getUnconnectedOutLayersNames\")\n        return val\n    \n    out = process_data()\n    print('Успешное выполнение. Тип:', type(out))\nexcept Exception as e:\n    print('Ошибка выполнения:', e)",
        "solution": "",
        "hints": [],
  ...
  },
  {
    ...
    "codeBlocks": [
      ...
      {
        "type": "runnable",
        "initialCode": "import cv2\nimport numpy as np\n\n# Практическое применение в пайплайне\nprint('Запуск: import numpy as np\\nimport cv2\\n# cap = ')\ntry:\n    # Инкапсулируем в функцию\n    def process_data():\n        val = print(\"VideoCapture get/set properties: PROP_FRAME_WIDTH, PROP_FPS, PROP_POS_FRAMES\")\n        return val\n    \n    out = process_data()\n    print('Успешное выполнение. Тип:', type(out))\nexcept Exception as e:\n    print('Ошибка выполнения:', e)",
        "solution": "",
        "hints": [],
  ...
  },
  {
    ...
    "codeBlocks": [
      ...
      {
        "type": "runnable",
        "initialCode": "import cv2\nimport numpy as np\n\n# Практическое применение в пайплайне\nprint('Запуск: import numpy as np\\nimport cv2\\n# fourcc')\ntry:\n    # Инкапсулируем в функцию\n    def process_data():\n        val = print(\"VideoWriter: cv2.VideoWriter_fourcc(*XVID), write, release\")\n        return val\n    \n    out = process_data()\n    print('Успешное выполнение. Тип:', type(out))\nexcept Exception as e:\n    print('Ошибка выполнения:', e)",
        "solution": "",
        "hints": [],
  ...
  },
  {
    ...
    "codeBlocks": [
      ...
      {
        "type": "runnable",
        "initialCode": "import cv2\nimport numpy as np\n\n# Практическое применение в пайплайне\nprint('Запуск: import numpy as np\\nimport cv2\\ngray = n')\ntry:\n    # Инкапсулируем в функцию\n    def process_data():\n        val = print(\"HoughLinesP: найдено\", len(lines) if lines is not None else 0, \"линий\")\n        return val\n    \n    out = process_data()\n    print('Успешное выполнение. Тип:', type(out))\nexcept Exception as e:\n    print('Ошибка выполнения:', e)",
        "solution": "",
        "hints": [],
  ...
  },
  {
    ...
    "codeBlocks": [
      ...
      {
        "type": "runnable",
        "initialCode": "import cv2\nimport numpy as np\n\n# Практическое применение в пайплайне\nprint('Запуск: import numpy as np\\nimport cv2\\ngray = n')\ntry:\n    # Инкапсулируем в функцию\n    def process_data():\n        val = print(\"HoughCircles:\", \"найдено\" if circles is not None else \"не найдено\", \"окружностей\")\n        return val\n    \n    out = process_data()\n    print('Успешное выполнение. Тип:', type(out))\nexcept Exception as e:\n    print('Ошибка выполнения:', e)",
        "solution": "",
        "hints": [],
  ...
  },
  {
    ...
    "codeBlocks": [
      ...
      {
        "type": "runnable",
        "initialCode": "import cv2\nimport numpy as np\n\n# Исследование свойств объекта\nresult = # result = cv2.warpPerspective(img, M, (width, height))\nprint('Результат:', result)\nif hasattr(result, 'shape'):\n    print('Форма (shape):', result.shape)\nif hasattr(result, 'dtype'):\n    print('Тип данных:', result.dtype)",
        "solution": "",
        "hints": [],
      ...
      {
        "type": "runnable",
        "initialCode": "import cv2\nimport numpy as np\n\n# Практическое применение в пайплайне\nprint('Запуск: import numpy as np\\nimport cv2\\n# Perspe')\ntry:\n    # Инкапсулируем в функцию\n    def process_data():\n        val = # result = cv2.warpPerspective(img, M, (width, height))\n        return val\n    \n    out = process_data()\n    print('Успешное выполнение. Тип:', type(out))\nexcept Exception as e:\n    print('Ошибка выполнения:', e)",
        "solution": "",
        "hints": [],
  ...
  },
  {
    ...
    "codeBlocks": [
      ...
      {
        "type": "runnable",
        "initialCode": "import cv2\nimport numpy as np\n\n# Исследование свойств объекта\nresult = # result = cv2.warpAffine(img, M, (w, h))\nprint('Результат:', result)\nif hasattr(result, 'shape'):\n    print('Форма (shape):', result.shape)\nif hasattr(result, 'dtype'):\n    print('Тип данных:', result.dtype)",
        "solution": "",
        "hints": [],
      ...
      {
        "type": "runnable",
        "initialCode": "import cv2\nimport numpy as np\n\n# Практическое применение в пайплайне\nprint('Запуск: import numpy as np\\nimport cv2\\n# Affine')\ntry:\n    # Инкапсулируем в функцию\n    def process_data():\n        val = # result = cv2.warpAffine(img, M, (w, h))\n        return val\n    \n    out = process_data()\n    print('Успешное выполнение. Тип:', type(out))\nexcept Exception as e:\n    print('Ошибка выполнения:', e)",
        "solution": "",
        "hints": [],
  ...
  },
  {
    ...
    "codeBlocks": [
      ...
      {
        "type": "runnable",
        "initialCode": "import cv2\nimport numpy as np\n\n# Практическое применение в пайплайне\nprint('Запуск: import numpy as np\\nimport cv2\\nimg1 = n')\ntry:\n    # Инкапсулируем в функцию\n    def process_data():\n        val = print(\"addWeighted:\", result2[0,0])\n        return val\n    \n    out = process_data()\n    print('Успешное выполнение. Тип:', type(out))\nexcept Exception as e:\n    print('Ошибка выполнения:', e)",
        "solution": "",
        "hints": [],
  ...
  },
  {
    ...
    "codeBlocks": [
      ...
      {
        "type": "runnable",
        "initialCode": "import cv2\nimport numpy as np\n\n# Практическое применение в пайплайне\nprint('Запуск: import numpy as np\\nimport cv2\\nimg = np')\ntry:\n    # Инкапсулируем в функцию\n    def process_data():\n        val = print(\"and sum:\", result_and.sum(), \"or sum:\", result_or.sum())\n        return val\n    \n    out = process_data()\n    print('Успешное выполнение. Тип:', type(out))\nexcept Exception as e:\n    print('Ошибка выполнения:', e)",
        "solution": "",
        "hints": [],
  ...
  },
  {
    ...
    "codeBlocks": [
      ...
      {
        "type": "runnable",
        "initialCode": "import cv2\nimport numpy as np\n\n# Практическое применение в пайплайне\nprint('Запуск: import numpy as np\\nimport cv2\\nimg = np')\ntry:\n    # Инкапсулируем в функцию\n    def process_data():\n        val = print(\"pixels in range:\", mask.sum() // 255)\n        return val\n    \n    out = process_data()\n    print('Успешное выполнение. Тип:', type(out))\nexcept Exception as e:\n    print('Ошибка выполнения:', e)",
        "solution": "",
        "hints": [],
  ...
  },
  {
    ...
    "codeBlocks": [
      ...
      {
        "type": "runnable",
        "initialCode": "import cv2\nimport numpy as np\n\n# Практическое применение в пайплайне\nprint('Запуск: import numpy as np\\nimport cv2\\n# Каскад')\ntry:\n    # Инкапсулируем в функцию\n    def process_data():\n        val = print(\"detectMultiScale: scaleFactor, minNeighbors\")\n        return val\n    \n    out = process_data()\n    print('Успешное выполнение. Тип:', type(out))\nexcept Exception as e:\n    print('Ошибка выполнения:', e)",
        "solution": "",
        "hints": [],
  ...
  },
  {
    ...
    "codeBlocks": [
      ...
      {
        "type": "runnable",
        "initialCode": "import cv2\nimport numpy as np\n\n# Практическое применение в пайплайне\nprint('Запуск: import numpy as np\\nimport cv2\\n# Backgr')\ntry:\n    # Инкапсулируем в функцию\n    def process_data():\n        val = print(\"BackgroundSubtractorKNN: альтернатива\")\n        return val\n    \n    out = process_data()\n    print('Успешное выполнение. Тип:', type(out))\nexcept Exception as e:\n    print('Ошибка выполнения:', e)",
        "solution": "",
        "hints": [],
  ...
  },
  {
    ...
    "codeBlocks": [
      ...
      {
        "type": "runnable",
        "initialCode": "import cv2\nimport numpy as np\n\n# Практическое применение в пайплайне\nprint('Запуск: import numpy as np\\nimport cv2\\n# Contou')\ntry:\n    # Инкапсулируем в функцию\n    def process_data():\n        val = print(\"center:\", int(M[\"m10\"]/M[\"m00\"]), int(M[\"m01\"]/M[\"m00\"]))\n        return val\n    \n    out = process_data()\n    print('Успешное выполнение. Тип:', type(out))\nexcept Exception as e:\n    print('Ошибка выполнения:', e)",
        "solution": "",
        "hints": [],
  ...
  },
  {
    ...
    "codeBlocks": [
      ...
      {
        "type": "runnable",
        "initialCode": "import cv2\nimport numpy as np\n\n# Практическое применение в пайплайне\nprint('Запуск: core — Core functionality')\ntry:\n    # Инкапсулируем в функцию\n    def process_data():\n        val = core — Core functionality\n        return val\n    \n    out = process_data()\n    print('Успешное выполнение. Тип:', type(out))\nexcept Exception as e:\n    print('Ошибка выполнения:', e)",
        "solution": "",
        "hints": [],
  ...
  },
  {
    ...
    "codeBlocks": [
      ...
      {
        "type": "runnable",
        "initialCode": "import cv2\nimport numpy as np\n\n# Практическое применение в пайплайне\nprint('Запуск: imgproc — Image Processing')\ntry:\n    # Инкапсулируем в функцию\n    def process_data():\n        val = imgproc — Image Processing\n        return val\n    \n    out = process_data()\n    print('Успешное выполнение. Тип:', type(out))\nexcept Exception as e:\n    print('Ошибка выполнения:', e)",
        "solution": "",
        "hints": [],
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Чтение и запись изображений в файлы. Функции: imread() — загрузка из файла (поддержка JPEG, PNG, BMP, TIFF и др.); imwrite() — сохранение; imdecode()/imencode() — работа с памятью (буфер байтов).</div><div style='background-color: #1e293b; border-left: 4px solid #f59e0b; padding: 15px; margin: 20px 0; border-radius: 4px;'><h4 style='margin: 0 0 10px 0; color: #fcd34d;'>💡 Нюансы и параметры:</h4><p style='margin: 0; font-size: 0.95rem; color: #cbd5e1;'>Параметры: флаги загрузки (IMREAD_COLOR, IMREAD_GRAYSCALE, IMREAD_UNCHANGED), параметры сохранения (качество JPEG, сжатие PNG). В Python доступны как cv2.imread, cv2.imwrite.</p></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-opencv-imgcodecs-image-file-reading-and-writi-e-101-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-opencv-imgcodecs-image-file-reading-and-writi-e-101-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-opencv-imgcodecs-image-file-reading-and-writi-e-101-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"https://docs.opencv.org/4.x/d4/da8/group__imgcodecs.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
      ...
      {
        "type": "runnable",
        "initialCode": "import cv2\nimport numpy as np\n\n# Практическое применение в пайплайне\nprint('Запуск: imgcodecs — Image file reading and writi')\ntry:\n    # Инкапсулируем в функцию\n    def process_data():\n        val = imgcodecs — Image file reading and writing\n        return val\n    \n    out = process_data()\n    print('Успешное выполнение. Тип:', type(out))\nexcept Exception as e:\n    print('Ошибка выполнения:', e)",
        "solution": "",
        "hints": [],
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Захват и запись видео. VideoCapture — открытие видеофайла или камеры (индекс 0 — веб-камера), read() — следующий кадр, get()/set() — свойства (ширина, высота, FPS). VideoWriter — запись видео (кодек, размер, FPS). Удобно для обработки видео по кадрам и сохранения результата. В коде: cap = cv2.VideoCapture(0); ret, frame = cap.read(); cap.release().</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-opencv-videoio-video-i-o-e-102-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-opencv-videoio-video-i-o-e-102-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-opencv-videoio-video-i-o-e-102-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"https://docs.opencv.org/4.x/d8/dfe/group__videoio.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
      ...
      {
        "type": "runnable",
        "initialCode": "import cv2\nimport numpy as np\n\n# Практическое применение в пайплайне\nprint('Запуск: videoio — Video I/O')\ntry:\n    # Инкапсулируем в функцию\n    def process_data():\n        val = videoio — Video I/O\n        return val\n    \n    out = process_data()\n    print('Успешное выполнение. Тип:', type(out))\nexcept Exception as e:\n    print('Ошибка выполнения:', e)",
        "solution": "",
        "hints": [],
  ...
  },
  {
    ...
    "codeBlocks": [
      ...
      {
        "type": "runnable",
        "initialCode": "import cv2\nimport numpy as np\n\n# Практическое применение в пайплайне\nprint('Запуск: highgui — High-level GUI')\ntry:\n    # Инкапсулируем в функцию\n    def process_data():\n        val = highgui — High-level GUI\n        return val\n    \n    out = process_data()\n    print('Успешное выполнение. Тип:', type(out))\nexcept Exception as e:\n    print('Ошибка выполнения:', e)",
        "solution": "",
        "hints": [],
  ...
  },
  {
    ...
    "codeBlocks": [
      ...
      {
        "type": "runnable",
        "initialCode": "import cv2\nimport numpy as np\n\n# Практическое применение в пайплайне\nprint('Запуск: video — Video Analysis')\ntry:\n    # Инкапсулируем в функцию\n    def process_data():\n        val = video — Video Analysis\n        return val\n    \n    out = process_data()\n    print('Успешное выполнение. Тип:', type(out))\nexcept Exception as e:\n    print('Ошибка выполнения:', e)",
        "solution": "",
        "hints": [],
  ...
  },
  {
    ...
    "codeBlocks": [
      ...
      {
        "type": "runnable",
        "initialCode": "import cv2\nimport numpy as np\n\n# Исследование свойств объекта\nresult = calib3d — Camera Calibration and 3D Reconstruction\nprint('Результат:', result)\nif hasattr(result, 'shape'):\n    print('Форма (shape):', result.shape)\nif hasattr(result, 'dtype'):\n    print('Тип данных:', result.dtype)",
        "solution": "",
        "hints": [],
      ...
      {
        "type": "runnable",
        "initialCode": "import cv2\nimport numpy as np\n\n# Практическое применение в пайплайне\nprint('Запуск: calib3d — Camera Calibration and 3D Reco')\ntry:\n    # Инкапсулируем в функцию\n    def process_data():\n        val = calib3d — Camera Calibration and 3D Reconstruction\n        return val\n    \n    out = process_data()\n    print('Успешное выполнение. Тип:', type(out))\nexcept Exception as e:\n    print('Ошибка выполнения:', e)",
        "solution": "",
        "hints": [],
  ...
  },
  {
    ...
    "codeBlocks": [
      ...
      {
        "type": "runnable",
        "initialCode": "import cv2\nimport numpy as np\n\n# Исследование свойств объекта\nresult = features2d — 2D Features Framework\nprint('Результат:', result)\nif hasattr(result, 'shape'):\n    print('Форма (shape):', result.shape)\nif hasattr(result, 'dtype'):\n    print('Тип данных:', result.dtype)",
        "solution": "",
        "hints": [],
      ...
      {
        "type": "runnable",
        "initialCode": "import cv2\nimport numpy as np\n\n# Практическое применение в пайплайне\nprint('Запуск: features2d — 2D Features Framework')\ntry:\n    # Инкапсулируем в функцию\n    def process_data():\n        val = features2d — 2D Features Framework\n        return val\n    \n    out = process_data()\n    print('Успешное выполнение. Тип:', type(out))\nexcept Exception as e:\n    print('Ошибка выполнения:', e)",
        "solution": "",
        "hints": [],
  ...
  },
  {
    ...
    "codeBlocks": [
      ...
      {
        "type": "runnable",
        "initialCode": "import cv2\nimport numpy as np\n\n# Практическое применение в пайплайне\nprint('Запуск: objdetect — Object Detection')\ntry:\n    # Инкапсулируем в функцию\n    def process_data():\n        val = objdetect — Object Detection\n        return val\n    \n    out = process_data()\n    print('Успешное выполнение. Тип:', type(out))\nexcept Exception as e:\n    print('Ошибка выполнения:', e)",
        "solution": "",
        "hints": [],
  ...
  },
  {
    ...
    "codeBlocks": [
      ...
      {
        "type": "runnable",
        "initialCode": "import cv2\nimport numpy as np\n\n# Практическое применение в пайплайне\nprint('Запуск: dnn — Deep Neural Network module')\ntry:\n    # Инкапсулируем в функцию\n    def process_data():\n        val = dnn — Deep Neural Network module\n        return val\n    \n    out = process_data()\n    print('Успешное выполнение. Тип:', type(out))\nexcept Exception as e:\n    print('Ошибка выполнения:', e)",
        "solution": "",
        "hints": [],
  ...
  },
  {
    ...
    "codeBlocks": [
      ...
      {
        "type": "runnable",
        "initialCode": "import cv2\nimport numpy as np\n\n# Практическое применение в пайплайне\nprint('Запуск: ml — Machine Learning')\ntry:\n    # Инкапсулируем в функцию\n    def process_data():\n        val = ml — Machine Learning\n        return val\n    \n    out = process_data()\n    print('Успешное выполнение. Тип:', type(out))\nexcept Exception as e:\n    print('Ошибка выполнения:', e)",
        "solution": "",
        "hints": [],
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Быстрый поиск ближайших соседей в многомерных пространствах. FLANN (Fast Library for Approximate Nearest Neighbors): построение индекса по набору векторов (дескрипторов), поиск k ближайших или радиуса. Используется внутри features2d для матчинга дескрипторов и в любых задачах поиска по множеству точек. Index_create(), index.knnSearch(), index.radiusSearch().</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-opencv-flann-clustering-and-search-in-multi-d-e-110-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-opencv-flann-clustering-and-search-in-multi-d-e-110-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-opencv-flann-clustering-and-search-in-multi-d-e-110-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"https://docs.opencv.org/4.x/d2/d75/group__flann.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
      ...
      {
        "type": "runnable",
        "initialCode": "import cv2\nimport numpy as np\n\n# Практическое применение в пайплайне\nprint('Запуск: flann — Clustering and Search in Multi-D')\ntry:\n    # Инкапсулируем в функцию\n    def process_data():\n        val = flann — Clustering and Search in Multi-Dimensional Spaces\n        return val\n    \n    out = process_data()\n    print('Успешное выполнение. Тип:', type(out))\nexcept Exception as e:\n    print('Ошибка выполнения:', e)",
        "solution": "",
        "hints": [],
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Вычислительная фотография: устранение шума (fastNlMeansDenoising, denoise_TVL1), inpainting (восстановление повреждённых областей), HDR (mergeExposures), декомпозиция (seamlessClone). Удобно для улучшения снимков и ретуши. Функции работают с целым изображением или маской.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-opencv-photo-computational-photography-e-111-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-opencv-photo-computational-photography-e-111-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-opencv-photo-computational-photography-e-111-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"https://docs.opencv.org/4.x/d1/dd9/group__photo.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
      ...
      {
        "type": "runnable",
        "initialCode": "import cv2\nimport numpy as np\n\n# Практическое применение в пайплайне\nprint('Запуск: photo — Computational Photography')\ntry:\n    # Инкапсулируем в функцию\n    def process_data():\n        val = photo — Computational Photography\n        return val\n    \n    out = process_data()\n    print('Успешное выполнение. Тип:', type(out))\nexcept Exception as e:\n    print('Ошибка выполнения:', e)",
        "solution": "",
        "hints": [],
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Сшивание изображений в панораму: Stitcher создаёт панораму из нескольких перекрывающихся кадров. Внутри: детекция признаков, матчинг, оценка гомографии, блендинг. Используется для панорамных снимков и склейки видео. Stitcher.create(), stitcher.stitch(images). Параметры режима (панорама, сканер и т.д.).</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-opencv-stitching-images-stitching-e-112-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-opencv-stitching-images-stitching-e-112-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-opencv-stitching-images-stitching-e-112-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"https://docs.opencv.org/4.x/d8/d19/group__stitching.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
      ...
      {
        "type": "runnable",
        "initialCode": "import cv2\nimport numpy as np\n\n# Практическое применение в пайплайне\nprint('Запуск: stitching — Images stitching')\ntry:\n    # Инкапсулируем в функцию\n    def process_data():\n        val = stitching — Images stitching\n        return val\n    \n    out = process_data()\n    print('Успешное выполнение. Тип:', type(out))\nexcept Exception as e:\n    print('Ошибка выполнения:', e)",
        "solution": "",
        "hints": [],
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Graph API: построение графа операций обработки изображений с автоматической оптимизацией и выполнением на CPU/GPU. Позволяет описать пайплайн один раз и выполнять его эффективно. Используется в продвинутых сценариях и встроенных системах. В Python доступность ограничена; в основном C++ API.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-opencv-gapi-graph-api-e-113-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-opencv-gapi-graph-api-e-113-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-opencv-gapi-graph-api-e-113-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"https://docs.opencv.org/4.x/d1/dd9/group__gapi.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Выделение полупрозрачных границ объекта (alpha matting): по тримапу и изображению уточняется альфа-канал на границах. Нужно для качественного вырезания объектов и композитинга.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-opencv-alphamat-alpha-matting-e-114-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-opencv-alphamat-alpha-matting-e-114-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-opencv-alphamat-alpha-matting-e-114-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"https://docs.opencv.org/4.x/d1/dd9/group__alphamat.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
      ...
      {
        "type": "runnable",
        "initialCode": "import cv2\nimport numpy as np\n\n# Практическое применение в пайплайне\nprint('Запуск: alphamat — Alpha Matting')\ntry:\n    # Инкапсулируем в функцию\n    def process_data():\n        val = alphamat — Alpha Matting\n        return val\n    \n    out = process_data()\n    print('Успешное выполнение. Тип:', type(out))\nexcept Exception as e:\n    print('Ошибка выполнения:', e)",
        "solution": "",
        "hints": [],
  ...
  },
  {
    ...
    "codeBlocks": [
      ...
      {
        "type": "runnable",
        "initialCode": "import cv2\nimport numpy as np\n\n# Практическое применение в пайплайне\nprint('Запуск: aruco — ArUco markers')\ntry:\n    # Инкапсулируем в функцию\n    def process_data():\n        val = aruco — ArUco markers\n        return val\n    \n    out = process_data()\n    print('Успешное выполнение. Тип:', type(out))\nexcept Exception as e:\n    print('Ошибка выполнения:', e)",
        "solution": "",
        "hints": [],
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Улучшенные методы выделения переднего плана: дополнительные алгоритмы фонового вычитания (сверх MOG2/KNN из video). Для видеонаблюдения и сегментации движущихся объектов.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-opencv-bgsegm-background-foreground-segmentat-e-116-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-opencv-bgsegm-background-foreground-segmentat-e-116-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-opencv-bgsegm-background-foreground-segmentat-e-116-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"https://docs.opencv.org/4.x/d1/dd9/group__bgsegm.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
      ...
      {
        "type": "runnable",
        "initialCode": "import cv2\nimport numpy as np\n\n# Практическое применение в пайплайне\nprint('Запуск: bgsegm — Background-Foreground Segmentat')\ntry:\n    # Инкапсулируем в функцию\n    def process_data():\n        val = bgsegm — Background-Foreground Segmentation\n        return val\n    \n    out = process_data()\n    print('Успешное выполнение. Тип:', type(out))\nexcept Exception as e:\n    print('Ошибка выполнения:', e)",
        "solution": "",
        "hints": [],
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Биологически мотивированные модели зрения: сетчатка, адаптация к освещению. Исследовательские и специализированные задачи.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-opencv-bioinspired-biologically-inspired-visi-e-117-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-opencv-bioinspired-biologically-inspired-visi-e-117-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-opencv-bioinspired-biologically-inspired-visi-e-117-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"https://docs.opencv.org/4.x/d1/dd9/group__bioinspired.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
      ...
      {
        "type": "runnable",
        "initialCode": "import cv2\nimport numpy as np\n\n# Практическое применение в пайплайне\nprint('Запуск: bioinspired — Biologically inspired visi')\ntry:\n    # Инкапсулируем в функцию\n    def process_data():\n        val = bioinspired — Biologically inspired vision\n        return val\n    \n    out = process_data()\n    print('Успешное выполнение. Тип:', type(out))\nexcept Exception as e:\n    print('Ошибка выполнения:', e)",
        "solution": "",
        "hints": [],
  ...
  },
  {
    ...
    "codeBlocks": [
      ...
      {
        "type": "runnable",
        "initialCode": "import cv2\nimport numpy as np\n\n# Практическое применение в пайплайне\nprint('Запуск: cuda* — CUDA-ускоренные модули')\ntry:\n    # Инкапсулируем в функцию\n    def process_data():\n        val = cuda* — CUDA-ускоренные модули\n        return val\n    \n    out = process_data()\n    print('Успешное выполнение. Тип:', type(out))\nexcept Exception as e:\n    print('Ошибка выполнения:', e)",
        "solution": "",
        "hints": [],
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>dnn_objdetect — готовые DNN-модели для детекции объектов (в т.ч. специфичные форматы). dnn_superres — супер-разрешение на основе нейросетей (увеличение разрешения изображения). Требуют загрузки весов; удобны для быстрого прототипа.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-opencv-dnn-objdetect-dnn-superres-e-119-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-opencv-dnn-objdetect-dnn-superres-e-119-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-opencv-dnn-objdetect-dnn-superres-e-119-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"https://docs.opencv.org/4.x/d2/d58/group__dnn.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
      ...
      {
        "type": "runnable",
        "initialCode": "import cv2\nimport numpy as np\n\n# Практическое применение в пайплайне\nprint('Запуск: dnn_objdetect / dnn_superres')\ntry:\n    # Инкапсулируем в функцию\n    def process_data():\n        val = dnn_objdetect / dnn_superres\n        return val\n    \n    out = process_data()\n    print('Успешное выполнение. Тип:', type(out))\nexcept Exception as e:\n    print('Ошибка выполнения:', e)",
        "solution": "",
        "hints": [],
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Анализ лиц: распознавание (LBPH, Eigenfaces, Fisherfaces), детекция ориентира (landmarks). Функции для построения пайплайна распознавания лиц. Дополняет objdetect (детекция лица) и dnn (современные сети).</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-opencv-face-face-analysis-e-120-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-opencv-face-face-analysis-e-120-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-opencv-face-face-analysis-e-120-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"https://docs.opencv.org/4.x/d1/dd9/group__face.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
      ...
      {
        "type": "runnable",
        "initialCode": "import cv2\nimport numpy as np\n\n# Практическое применение в пайплайне\nprint('Запуск: face — Face Analysis')\ntry:\n    # Инкапсулируем в функцию\n    def process_data():\n        val = face — Face Analysis\n        return val\n    \n    out = process_data()\n    print('Успешное выполнение. Тип:', type(out))\nexcept Exception as e:\n    print('Ошибка выполнения:', e)",
        "solution": "",
        "hints": [],
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Отрисовка текста в UTF-8 с помощью FreeType/Harfbuzz: поддержка разных языков и шрифтов. Расширяет базовый putText для нелатинских символов.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-opencv-freetype-drawing-utf-8-strings-e-121-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-opencv-freetype-drawing-utf-8-strings-e-121-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-opencv-freetype-drawing-utf-8-strings-e-121-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"https://docs.opencv.org/4.x/d1/dd9/group__freetype.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
      ...
      {
        "type": "runnable",
        "initialCode": "import cv2\nimport numpy as np\n\n# Практическое применение в пайплайне\nprint('Запуск: freetype — Drawing UTF-8 strings')\ntry:\n    # Инкапсулируем в функцию\n    def process_data():\n        val = freetype — Drawing UTF-8 strings\n        return val\n    \n    out = process_data()\n    print('Успешное выполнение. Тип:', type(out))\nexcept Exception as e:\n    print('Ошибка выполнения:', e)",
        "solution": "",
        "hints": [],
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Алгоритмы хеширования изображений (pHash, aHash и др.): компактное представление для быстрого сравнения «похожести» картинок. Поиск дубликатов, похожих изображений.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-opencv-img-hash-image-hashing-e-122-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-opencv-img-hash-image-hashing-e-122-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-opencv-img-hash-image-hashing-e-122-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"https://docs.opencv.org/4.x/d1/dd9/group__img__hash.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
      ...
      {
        "type": "runnable",
        "initialCode": "import cv2\nimport numpy as np\n\n# Практическое применение в пайплайне\nprint('Запуск: img_hash — Image hashing')\ntry:\n    # Инкапсулируем в функцию\n    def process_data():\n        val = img_hash — Image hashing\n        return val\n    \n    out = process_data()\n    print('Успешное выполнение. Тип:', type(out))\nexcept Exception as e:\n    print('Ошибка выполнения:', e)",
        "solution": "",
        "hints": [],
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Преобразования яркости/контраста: коррекция гистограммы, адаптация контраста. Удобно для предобработки перед детекцией или для улучшения визуализации.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-opencv-intensity-transform-intensity-transfor-e-123-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-opencv-intensity-transform-intensity-transfor-e-123-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-opencv-intensity-transform-intensity-transfor-e-123-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"https://docs.opencv.org/4.x/d1/dd9/group__intensity__transform.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
      ...
      {
        "type": "runnable",
        "initialCode": "import cv2\nimport numpy as np\n\n# Практическое применение в пайплайне\nprint('Запуск: intensity_transform — Intensity transfor')\ntry:\n    # Инкапсулируем в функцию\n    def process_data():\n        val = intensity_transform — Intensity transformation\n        return val\n    \n    out = process_data()\n    print('Успешное выполнение. Тип:', type(out))\nexcept Exception as e:\n    print('Ошибка выполнения:', e)",
        "solution": "",
        "hints": [],
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Расширенные алгоритмы оптического потока (помимо video): плотный и разрежённый поток, различные методы. Для трекинга и оценки движения между кадрами.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-opencv-optflow-optical-flow-algorithms-e-124-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-opencv-optflow-optical-flow-algorithms-e-124-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-opencv-optflow-optical-flow-algorithms-e-124-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"https://docs.opencv.org/4.x/d1/dd9/group__optflow.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
      ...
      {
        "type": "runnable",
        "initialCode": "import cv2\nimport numpy as np\n\n# Практическое применение в пайплайне\nprint('Запуск: optflow — Optical Flow Algorithms')\ntry:\n    # Инкапсулируем в функцию\n    def process_data():\n        val = optflow — Optical Flow Algorithms\n        return val\n    \n    out = process_data()\n    print('Успешное выполнение. Тип:', type(out))\nexcept Exception as e:\n    print('Ошибка выполнения:', e)",
        "solution": "",
        "hints": [],
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Визуализация данных Mat: построение графиков (гистограммы, кривые) в окне OpenCV. Альтернатива matplotlib для простых графиков внутри OpenCV-приложения.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-opencv-plot-plot-for-mat-data-e-125-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-opencv-plot-plot-for-mat-data-e-125-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-opencv-plot-plot-for-mat-data-e-125-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"https://docs.opencv.org/4.x/d1/dd9/group__plot.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
      ...
      {
        "type": "runnable",
        "initialCode": "import cv2\nimport numpy as np\n\n# Практическое применение в пайплайне\nprint('Запуск: plot — Plot for Mat data')\ntry:\n    # Инкапсулируем в функцию\n    def process_data():\n        val = plot — Plot for Mat data\n        return val\n    \n    out = process_data()\n    print('Успешное выполнение. Тип:', type(out))\nexcept Exception as e:\n    print('Ошибка выполнения:', e)",
        "solution": "",
        "hints": [],
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Оценка качества изображения: метрики резкости, шума, артефактов. Полезно для автоматической оценки снимков и выбора лучшего кадра.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-opencv-quality-image-quality-analysis-iqa-e-126-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-opencv-quality-image-quality-analysis-iqa-e-126-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-opencv-quality-image-quality-analysis-iqa-e-126-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"https://docs.opencv.org/4.x/d1/dd9/group__quality.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
      ...
      {
        "type": "runnable",
        "initialCode": "import cv2\nimport numpy as np\n\n# Практическое применение в пайплайне\nprint('Запуск: quality — Image Quality Analysis (IQA)')\ntry:\n    # Инкапсулируем в функцию\n    def process_data():\n        val = quality — Image Quality Analysis (IQA)\n        return val\n    \n    out = process_data()\n    print('Успешное выполнение. Тип:', type(out))\nexcept Exception as e:\n    print('Ошибка выполнения:', e)",
        "solution": "",
        "hints": [],
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Регистрация изображений: выравнивание двух изображений одной сцены (сдвиг, поворот, нелинейные деформации). Медицинская визуализация, мультиспектральные данные.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-opencv-reg-image-registration-e-127-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-opencv-reg-image-registration-e-127-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-opencv-reg-image-registration-e-127-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"https://docs.opencv.org/4.x/d1/dd9/group__reg.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
      ...
      {
        "type": "runnable",
        "initialCode": "import cv2\nimport numpy as np\n\n# Практическое применение в пайплайне\nprint('Запуск: reg — Image Registration')\ntry:\n    # Инкапсулируем в функцию\n    def process_data():\n        val = reg — Image Registration\n        return val\n    \n    out = process_data()\n    print('Успешное выполнение. Тип:', type(out))\nexcept Exception as e:\n    print('Ошибка выполнения:', e)",
        "solution": "",
        "hints": [],
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Обработка RGB-D камер (Kinect, RealSense и др.): работа с глубиной, выравнивание глубины и цвета, нормали, сегментация по глубине.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-opencv-rgbd-rgb-depth-processing-e-128-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-opencv-rgbd-rgb-depth-processing-e-128-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-opencv-rgbd-rgb-depth-processing-e-128-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"https://docs.opencv.org/4.x/d1/dd9/group__rgbd.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
      ...
      {
        "type": "runnable",
        "initialCode": "import cv2\nimport numpy as np\n\n# Практическое применение в пайплайне\nprint('Запуск: rgbd — RGB-Depth Processing')\ntry:\n    # Инкапсулируем в функцию\n    def process_data():\n        val = rgbd — RGB-Depth Processing\n        return val\n    \n    out = process_data()\n    print('Успешное выполнение. Тип:', type(out))\nexcept Exception as e:\n    print('Ошибка выполнения:', e)",
        "solution": "",
        "hints": [],
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Выделение заметных (salient) областей изображения: статическая и динамическая салиентность. Используется для привлечения внимания модели к важным регионам.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-opencv-saliency-saliency-api-e-129-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-opencv-saliency-saliency-api-e-129-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-opencv-saliency-saliency-api-e-129-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"https://docs.opencv.org/4.x/d1/dd9/group__saliency.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
      ...
      {
        "type": "runnable",
        "initialCode": "import cv2\nimport numpy as np\n\n# Практическое применение в пайплайне\nprint('Запуск: saliency — Saliency API')\ntry:\n    # Инкапсулируем в функцию\n    def process_data():\n        val = saliency — Saliency API\n        return val\n    \n    out = process_data()\n    print('Успешное выполнение. Тип:', type(out))\nexcept Exception as e:\n    print('Ошибка выполнения:', e)",
        "solution": "",
        "hints": [],
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Восстановление 3D структуры и движения камеры по нескольким кадрам. Классические методы SfM; для больших сцен часто используют внешние библиотеки (COLMAP и др.).</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-opencv-sfm-structure-from-motion-e-130-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-opencv-sfm-structure-from-motion-e-130-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-opencv-sfm-structure-from-motion-e-130-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"https://docs.opencv.org/4.x/d1/dd9/group__sfm.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
      ...
      {
        "type": "runnable",
        "initialCode": "import cv2\nimport numpy as np\n\n# Практическое применение в пайплайне\nprint('Запуск: sfm — Structure From Motion')\ntry:\n    # Инкапсулируем в функцию\n    def process_data():\n        val = sfm — Structure From Motion\n        return val\n    \n    out = process_data()\n    print('Успешное выполнение. Тип:', type(out))\nexcept Exception as e:\n    print('Ошибка выполнения:', e)",
        "solution": "",
        "hints": [],
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Сравнение и сопоставление форм контуров: расстояния между формами, матчинг. Для распознавания по форме объекта.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-opencv-shape-shape-distance-and-matching-e-131-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-opencv-shape-shape-distance-and-matching-e-131-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-opencv-shape-shape-distance-and-matching-e-131-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"https://docs.opencv.org/4.x/d1/dd9/group__shape.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
      ...
      {
        "type": "runnable",
        "initialCode": "import cv2\nimport numpy as np\n\n# Практическое применение в пайплайне\nprint('Запуск: shape — Shape Distance and Matching')\ntry:\n    # Инкапсулируем в функцию\n    def process_data():\n        val = shape — Shape Distance and Matching\n        return val\n    \n    out = process_data()\n    print('Успешное выполнение. Тип:', type(out))\nexcept Exception as e:\n    print('Ошибка выполнения:', e)",
        "solution": "",
        "hints": [],
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Стереосоответствие: построение карты глубины из стереопары. Алгоритмы блочного матчинга и др. Дополняет calib3d для полного стереопайплайна.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-opencv-stereo-stereo-correspondence-e-132-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-opencv-stereo-stereo-correspondence-e-132-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-opencv-stereo-stereo-correspondence-e-132-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"https://docs.opencv.org/4.x/d1/dd9/group__stereo.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
      ...
      {
        "type": "runnable",
        "initialCode": "import cv2\nimport numpy as np\n\n# Практическое применение в пайплайне\nprint('Запуск: stereo — Stereo Correspondence')\ntry:\n    # Инкапсулируем в функцию\n    def process_data():\n        val = stereo — Stereo Correspondence\n        return val\n    \n    out = process_data()\n    print('Успешное выполнение. Тип:', type(out))\nexcept Exception as e:\n    print('Ошибка выполнения:', e)",
        "solution": "",
        "hints": [],
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Структурированный свет: 3D-сканирование с помощью проектора и камеры. Специализированные приложения для реконструкции поверхности.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-opencv-structured-light-structured-light-api-e-133-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-opencv-structured-light-structured-light-api-e-133-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-opencv-structured-light-structured-light-api-e-133-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"https://docs.opencv.org/4.x/d1/dd9/group__structured__light.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
      ...
      {
        "type": "runnable",
        "initialCode": "import cv2\nimport numpy as np\n\n# Исследование свойств объекта\nresult = structured_light — Structured Light API\nprint('Результат:', result)\nif hasattr(result, 'shape'):\n    print('Форма (shape):', result.shape)\nif hasattr(result, 'dtype'):\n    print('Тип данных:', result.dtype)",
        "solution": "",
        "hints": [],
      ...
      {
        "type": "runnable",
        "initialCode": "import cv2\nimport numpy as np\n\n# Практическое применение в пайплайне\nprint('Запуск: structured_light — Structured Light API')\ntry:\n    # Инкапсулируем в функцию\n    def process_data():\n        val = structured_light — Structured Light API\n        return val\n    \n    out = process_data()\n    print('Успешное выполнение. Тип:', type(out))\nexcept Exception as e:\n    print('Ошибка выполнения:', e)",
        "solution": "",
        "hints": [],
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Супер-разрешение классическими методами (без DNN): увеличение разрешения изображения. dnn_superres даёт более качественный результат при наличии модели.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-opencv-superres-super-resolution-e-134-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-opencv-superres-super-resolution-e-134-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-opencv-superres-super-resolution-e-134-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"https://docs.opencv.org/4.x/d1/dd9/group__superres.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
      ...
      {
        "type": "runnable",
        "initialCode": "import cv2\nimport numpy as np\n\n# Практическое применение в пайплайне\nprint('Запуск: superres — Super Resolution')\ntry:\n    # Инкапсулируем в функцию\n    def process_data():\n        val = superres — Super Resolution\n        return val\n    \n    out = process_data()\n    print('Успешное выполнение. Тип:', type(out))\nexcept Exception as e:\n    print('Ошибка выполнения:', e)",
        "solution": "",
        "hints": [],
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Сопоставление 3D поверхностей: обнаружение объектов по 3D модели. Для робототехники и промышленной инспекции.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-opencv-surface-matching-surface-matching-e-135-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-opencv-surface-matching-surface-matching-e-135-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-opencv-surface-matching-surface-matching-e-135-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"https://docs.opencv.org/4.x/d1/dd9/group__surface__matching.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
      ...
      {
        "type": "runnable",
        "initialCode": "import cv2\nimport numpy as np\n\n# Исследование свойств объекта\nresult = surface_matching — Surface Matching\nprint('Результат:', result)\nif hasattr(result, 'shape'):\n    print('Форма (shape):', result.shape)\nif hasattr(result, 'dtype'):\n    print('Тип данных:', result.dtype)",
        "solution": "",
        "hints": [],
      ...
      {
        "type": "runnable",
        "initialCode": "import cv2\nimport numpy as np\n\n# Практическое применение в пайплайне\nprint('Запуск: surface_matching — Surface Matching')\ntry:\n    # Инкапсулируем в функцию\n    def process_data():\n        val = surface_matching — Surface Matching\n        return val\n    \n    out = process_data()\n    print('Успешное выполнение. Тип:', type(out))\nexcept Exception as e:\n    print('Ошибка выполнения:', e)",
        "solution": "",
        "hints": [],
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Детекция и распознавание текста на сцене (OCR): детектор областей с текстом, распознавание символов. Классические и нейросетевые компоненты; для production часто используют Tesseract или специализированные сети.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-opencv-text-scene-text-detection-and-recognit-e-136-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-opencv-text-scene-text-detection-and-recognit-e-136-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-opencv-text-scene-text-detection-and-recognit-e-136-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"https://docs.opencv.org/4.x/d1/dd9/group__text.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
      ...
      {
        "type": "runnable",
        "initialCode": "import cv2\nimport numpy as np\n\n# Практическое применение в пайплайне\nprint('Запуск: text — Scene Text Detection and Recognit')\ntry:\n    # Инкапсулируем в функцию\n    def process_data():\n        val = text — Scene Text Detection and Recognition\n        return val\n    \n    out = process_data()\n    print('Успешное выполнение. Тип:', type(out))\nexcept Exception as e:\n    print('Ошибка выполнения:', e)",
        "solution": "",
        "hints": [],
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>API трекинга объектов: трекеры по bounding box (KCF, CSRT, MedianFlow и др.), обновление положения объекта в следующих кадрах. Используется после детектора для стабильного слежения.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-opencv-tracking-tracking-api-e-137-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-opencv-tracking-tracking-api-e-137-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-opencv-tracking-tracking-api-e-137-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"https://docs.opencv.org/4.x/d1/dd9/group__tracking.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
      ...
      {
        "type": "runnable",
        "initialCode": "import cv2\nimport numpy as np\n\n# Практическое применение в пайплайне\nprint('Запуск: tracking — Tracking API')\ntry:\n    # Инкапсулируем в функцию\n    def process_data():\n        val = tracking — Tracking API\n        return val\n    \n    out = process_data()\n    print('Успешное выполнение. Тип:', type(out))\nexcept Exception as e:\n    print('Ошибка выполнения:', e)",
        "solution": "",
        "hints": [],
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Стабилизация видео: устранение дрожания камеры, выравнивание кадров. Улучшает качество съёмки с рук.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-opencv-videostab-video-stabilization-e-138-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-opencv-videostab-video-stabilization-e-138-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-opencv-videostab-video-stabilization-e-138-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"https://docs.opencv.org/4.x/d1/dd9/group__videostab.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
      ...
      {
        "type": "runnable",
        "initialCode": "import cv2\nimport numpy as np\n\n# Практическое применение в пайплайне\nprint('Запуск: videostab — Video Stabilization')\ntry:\n    # Инкапсулируем в функцию\n    def process_data():\n        val = videostab — Video Stabilization\n        return val\n    \n    out = process_data()\n    print('Успешное выполнение. Тип:', type(out))\nexcept Exception as e:\n    print('Ошибка выполнения:', e)",
        "solution": "",
        "hints": [],
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>3D визуализация: отображение облаков точек, координатных систем, мешей. Требует VTK. Для отладки 3D-реконструкции и калибровки.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-opencv-viz-3d-visualizer-e-139-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-opencv-viz-3d-visualizer-e-139-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-opencv-viz-3d-visualizer-e-139-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"https://docs.opencv.org/4.x/d1/dd9/group__viz.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
      ...
      {
        "type": "runnable",
        "initialCode": "import cv2\nimport numpy as np\n\n# Практическое применение в пайплайне\nprint('Запуск: viz — 3D Visualizer')\ntry:\n    # Инкапсулируем в функцию\n    def process_data():\n        val = viz — 3D Visualizer\n        return val\n    \n    out = process_data()\n    print('Успешное выполнение. Тип:', type(out))\nexcept Exception as e:\n    print('Ошибка выполнения:', e)",
        "solution": "",
        "hints": [],
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Детектор и декодер QR-кодов от WeChat: обнаружение и распознавание QR в кадре. Альтернатива встроенному QR-детектору OpenCV (если доступен в сборке).</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-opencv-wechat-qrcode-wechat-qr-code-detector-e-140-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-opencv-wechat-qrcode-wechat-qr-code-detector-e-140-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-opencv-wechat-qrcode-wechat-qr-code-detector-e-140-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"https://docs.opencv.org/4.x/d1/dd9/group__wechat__qrcode.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
      ...
      {
        "type": "runnable",
        "initialCode": "import cv2\nimport numpy as np\n\n# Исследование свойств объекта\nresult = wechat_qrcode — WeChat QR code detector\nprint('Результат:', result)\nif hasattr(result, 'shape'):\n    print('Форма (shape):', result.shape)\nif hasattr(result, 'dtype'):\n    print('Тип данных:', result.dtype)",
        "solution": "",
        "hints": [],
      ...
      {
        "type": "runnable",
        "initialCode": "import cv2\nimport numpy as np\n\n# Практическое применение в пайплайне\nprint('Запуск: wechat_qrcode — WeChat QR code detector')\ntry:\n    # Инкапсулируем в функцию\n    def process_data():\n        val = wechat_qrcode — WeChat QR code detector\n        return val\n    \n    out = process_data()\n    print('Успешное выполнение. Тип:', type(out))\nexcept Exception as e:\n    print('Ошибка выполнения:', e)",
        "solution": "",
        "hints": [],
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Дополнительные 2D-признаки: SIFT, SURF (в non-free части), BRIEF, FREAK и др. Расширяет features2d; часть алгоритмов может требовать отдельной сборки (contrib).</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-opencv-xfeatures2d-extra-2d-features-e-141-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-opencv-xfeatures2d-extra-2d-features-e-141-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-opencv-xfeatures2d-extra-2d-features-e-141-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"https://docs.opencv.org/4.x/d1/dd9/group__xfeatures2d.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
      ...
      {
        "type": "runnable",
        "initialCode": "import cv2\nimport numpy as np\n\n# Исследование свойств объекта\nresult = xfeatures2d — Extra 2D Features\nprint('Результат:', result)\nif hasattr(result, 'shape'):\n    print('Форма (shape):', result.shape)\nif hasattr(result, 'dtype'):\n    print('Тип данных:', result.dtype)",
        "solution": "",
        "hints": [],
      ...
      {
        "type": "runnable",
        "initialCode": "import cv2\nimport numpy as np\n\n# Практическое применение в пайплайне\nprint('Запуск: xfeatures2d — Extra 2D Features')\ntry:\n    # Инкапсулируем в функцию\n    def process_data():\n        val = xfeatures2d — Extra 2D Features\n        return val\n    \n    out = process_data()\n    print('Успешное выполнение. Тип:', type(out))\nexcept Exception as e:\n    print('Ошибка выполнения:', e)",
        "solution": "",
        "hints": [],
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Расширенная обработка изображений: селективное размытие, детекция границ (структурированные леса), сегментация, фильтры. Дополняет imgproc для более сложных алгоритмов.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-opencv-ximgproc-extended-image-processing-e-142-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-opencv-ximgproc-extended-image-processing-e-142-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-opencv-ximgproc-extended-image-processing-e-142-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"https://docs.opencv.org/4.x/d1/dd9/group__ximgproc.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
      ...
      {
        "type": "runnable",
        "initialCode": "import cv2\nimport numpy as np\n\n# Практическое применение в пайплайне\nprint('Запуск: ximgproc — Extended Image Processing')\ntry:\n    # Инкапсулируем в функцию\n    def process_data():\n        val = ximgproc — Extended Image Processing\n        return val\n    \n    out = process_data()\n    print('Успешное выполнение. Тип:', type(out))\nexcept Exception as e:\n    print('Ошибка выполнения:', e)",
        "solution": "",
        "hints": [],
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Дополнительные алгоритмы обработки фото: коррекция баланса белого, инпейнтинг, тонирование. Расширяет модуль photo.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-opencv-xphoto-additional-photo-processing-e-143-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-opencv-xphoto-additional-photo-processing-e-143-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-opencv-xphoto-additional-photo-processing-e-143-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"https://docs.opencv.org/4.x/d1/dd9/group__xphoto.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
      ...
      {
        "type": "runnable",
        "initialCode": "import cv2\nimport numpy as np\n\n# Практическое применение в пайплайне\nprint('Запуск: xphoto — Additional photo processing')\ntry:\n    # Инкапсулируем в функцию\n    def process_data():\n        val = xphoto — Additional photo processing\n        return val\n    \n    out = process_data()\n    print('Успешное выполнение. Тип:', type(out))\nexcept Exception as e:\n    print('Ошибка выполнения:', e)",
        "solution": "",
        "hints": [],
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Batch (полный батч): за один вызов optimizer.step() используется вся обучающая выборка. Градиент считается по всем примерам сразу — он стабильный, но один шаг очень тяжёлый по памяти и времени. Подходит только для маленьких датасетов. В коде: передаёте в model(X_full) весь X целиком.<br><br><strong>Когда использовать:</strong> маленькие данные (сотни–тысячи примеров), когда всё помещается в память. В глубоком обучении почти не используется.<br><strong>Минусы:</strong> не масштабируется; локальные минимумы застревают легче.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-pytorch-batch-gradient-descent-e-144-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-pytorch-batch-gradient-descent-e-144-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-pytorch-batch-gradient-descent-e-144-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"https://pytorch.org/docs/stable/optim.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
      ...
      {
        "type": "runnable",
        "initialCode": "import torch\nimport torch.nn as nn\n\n# Практическое применение в пайплайне\nprint('Запуск: # Batch gradient descent — градиент по В')\ntry:\n    # Инкапсулируем в функцию\n    def process_data():\n        val =     optimizer.step()\n        return val\n    \n    out = process_data()\n    print('Успешное выполнение. Тип:', type(out))\nexcept Exception as e:\n    print('Ошибка выполнения:', e)",
        "solution": "",
        "hints": [],
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Stochastic (стохастический): один шаг = один пример. На каждой итерации считаете loss по одному объекту (X[i:i+1] даёт форму [1, ...]). Градиент очень шумный — это может помочь выходить из плоских минимумов, но обучение нестабильное. В чистом виде редко используют: слишком много шагов за эпоху и сильный шум.<br><br><strong>Когда использовать:</strong> онлайн-обучение, потоковые данные; иногда для мелких датасетов.<br><strong></div><div style='background-color: #1e293b; border-left: 4px solid #f59e0b; padding: 15px; margin: 20px 0; border-radius: 4px;'><h4 style='margin: 0 0 10px 0; color: #fcd34d;'>💡 Нюансы и параметры:</h4><p style='margin: 0; font-size: 0.95rem; color: #cbd5e1;'>Нюанс: </strong> X[i:i+1] важен — срез сохраняет размерность (1, features), а X[i] дала бы (features,) и сломала бы батч.</p></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-pytorch-stochastic-gradient-descent-sgd-e-145-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-pytorch-stochastic-gradient-descent-sgd-e-145-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-pytorch-stochastic-gradient-descent-sgd-e-145-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"https://pytorch.org/docs/stable/generated/torch.optim.SGD.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
      ...
      {
        "type": "runnable",
        "initialCode": "import torch\nimport torch.nn as nn\n\n# Практическое применение в пайплайне\nprint('Запуск: # Stochastic gradient descent (SGD) — од')\ntry:\n    # Инкапсулируем в функцию\n    def process_data():\n        val =         optimizer.step()\n        return val\n    \n    out = process_data()\n    print('Успешное выполнение. Тип:', type(out))\nexcept Exception as e:\n    print('Ошибка выполнения:', e)",
        "solution": "",
        "hints": [],
  ...
  },
  {
    ...
    "codeBlocks": [
      ...
      {
        "type": "runnable",
        "initialCode": "import torch\nimport torch.nn as nn\n\n# Практическое применение в пайплайне\nprint('Запуск: # Mini-batch gradient descent — батч за ')\ntry:\n    # Инкапсулируем в функцию\n    def process_data():\n        val =         optimizer.step()\n        return val\n    \n    out = process_data()\n    print('Успешное выполнение. Тип:', type(out))\nexcept Exception as e:\n    print('Ошибка выполнения:', e)",
        "solution": "",
        "hints": [],
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Mean Absolute Error (MAE): среднее от |output − target|. Используется в регрессии, когда выбросы не должны сильно влиять (в отличие от MSE). Вход и target — одна форма (например оба [N] или [N, 1]).</div><div style='background-color: #1e293b; border-left: 4px solid #f59e0b; padding: 15px; margin: 20px 0; border-radius: 4px;'><h4 style='margin: 0 0 10px 0; color: #fcd34d;'>💡 Нюансы и параметры:</h4><p style='margin: 0; font-size: 0.95rem; color: #cbd5e1;'>Параметры: reduction=\"mean\".<br><strong>Пример:</strong> предсказание числа (цена, возраст).</p></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-pytorch-nn-l1loss-e-147-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-pytorch-nn-l1loss-e-147-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-pytorch-nn-l1loss-e-147-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"PT_G + 'torch.nn.L1Loss.html'\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
        "initialCode": "import torch\nimport torch.nn as nn\nprint(nn.L1Loss())",
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Mean Squared Error: среднее от (output − target)². Самый частый loss для регрессии. Сильно штрафует большие ошибки — чувствителен к выбросам. Вход и target — одна форма.</div><div style='background-color: #1e293b; border-left: 4px solid #f59e0b; padding: 15px; margin: 20px 0; border-radius: 4px;'><h4 style='margin: 0 0 10px 0; color: #fcd34d;'>💡 Нюансы и параметры:</h4><p style='margin: 0; font-size: 0.95rem; color: #cbd5e1;'>Параметры: reduction=\"mean\".<br><strong>Когда использовать:</strong> регрессия, когда ошибки распределены нормально и выбросов мало.</p></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-pytorch-nn-mseloss-e-148-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-pytorch-nn-mseloss-e-148-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-pytorch-nn-mseloss-e-148-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"PT_G + 'torch.nn.MSELoss.html'\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
        "initialCode": "import torch\nimport torch.nn as nn\nprint(nn.MSELoss())",
  ...
  },
  {
    ...
    "codeBlocks": [
      ...
      {
        "type": "runnable",
        "initialCode": "import torch\nimport torch.nn as nn\n\n# Практическое применение в пайплайне\nprint('Запуск: nn.CrossEntropyLoss')\ntry:\n    # Инкапсулируем в функцию\n    def process_data():\n        val = nn.CrossEntropyLoss()\n        return val\n    \n    out = process_data()\n    print('Успешное выполнение. Тип:', type(out))\nexcept Exception as e:\n    print('Ошибка выполнения:', e)",
        "solution": "",
        "hints": [],
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Connectionist Temporal Classification — для задач, где выход — последовательность, а целевых меток меньше (например распознавание речи: аудио кадры → текст).</div><div style='background-color: #1e293b; border-left: 4px solid #f59e0b; padding: 15px; margin: 20px 0; border-radius: 4px;'><h4 style='margin: 0 0 10px 0; color: #fcd34d;'>💡 Нюансы и параметры:</h4><p style='margin: 0; font-size: 0.95rem; color: #cbd5e1;'>Параметры: blank (индекс пустого символа), zero_infinity. Сложнее в использовании: нужны длины входов и целей.<br><strong>Когда использовать:</strong> speech-to-text, распознавание рукописного ввода.</p></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-pytorch-nn-ctcloss-e-150-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-pytorch-nn-ctcloss-e-150-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-pytorch-nn-ctcloss-e-150-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"PT_G + 'torch.nn.CTCLoss.html'\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
        "initialCode": "import torch\nimport torch.nn as nn\nprint(nn.CTCLoss())",
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Negative Log Likelihood: принимает логиты после log_softmax (не после обычного softmax). Target — индексы классов [N]. Часто используют вместе: выход модели → log_softmax → NLLLoss. CrossEntropyLoss по сути объединяет log_softmax + NLLLoss в одном классе.<br><strong>Когда использовать:</strong> если вы сами делаете log_softmax (например в кастомной голове).</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-pytorch-nn-nllloss-e-151-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-pytorch-nn-nllloss-e-151-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-pytorch-nn-nllloss-e-151-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"PT_G + 'torch.nn.NLLLoss.html'\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
        "initialCode": "import torch\nimport torch.nn as nn\nprint(nn.NLLLoss())",
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>NLL при предположении, что цель распределена по Пуассону.</div><div style='background-color: #1e293b; border-left: 4px solid #f59e0b; padding: 15px; margin: 20px 0; border-radius: 4px;'><h4 style='margin: 0 0 10px 0; color: #fcd34d;'>💡 Нюансы и параметры:</h4><p style='margin: 0; font-size: 0.95rem; color: #cbd5e1;'>Параметры: log_input (True — вход уже логарифм), full (учитывать ли приближение Стирлинга). Редко используется в типичных задачах.<br><strong>Когда использовать:</strong> подсчёт событий (счётчики).</p></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-pytorch-nn-poissonnllloss-e-152-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-pytorch-nn-poissonnllloss-e-152-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-pytorch-nn-poissonnllloss-e-152-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"PT_G + 'torch.nn.PoissonNLLLoss.html'\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
      ...
      {
        "type": "runnable",
        "initialCode": "import torch\nimport torch.nn as nn\n\n# Практическое применение в пайплайне\nprint('Запуск: nn.PoissonNLLLoss')\ntry:\n    # Инкапсулируем в функцию\n    def process_data():\n        val = nn.PoissonNLLLoss()\n        return val\n    \n    out = process_data()\n    print('Успешное выполнение. Тип:', type(out))\nexcept Exception as e:\n    print('Ошибка выполнения:', e)",
        "solution": "",
        "hints": [],
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Регрессия с предсказанием не только среднего, но и дисперсии. Вход: предсказание и дисперсия (или лог-дисперсия); target — истинное значение. Полезно для оценки неопределённости.<br><strong>Когда использовать:</strong> когда нужна уверенность модели (uncertainty).</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-pytorch-nn-gaussiannllloss-e-153-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-pytorch-nn-gaussiannllloss-e-153-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-pytorch-nn-gaussiannllloss-e-153-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"PT_G + 'torch.nn.GaussianNLLLoss.html'\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
      ...
      {
        "type": "runnable",
        "initialCode": "import torch\nimport torch.nn as nn\n\n# Практическое применение в пайплайне\nprint('Запуск: nn.GaussianNLLLoss')\ntry:\n    # Инкапсулируем в функцию\n    def process_data():\n        val = nn.GaussianNLLLoss()\n        return val\n    \n    out = process_data()\n    print('Успешное выполнение. Тип:', type(out))\nexcept Exception as e:\n    print('Ошибка выполнения:', e)",
        "solution": "",
        "hints": [],
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Kullback–Leibler divergence между двумя распределениями. Вход — логарифмы вероятностей (логиты после log_softmax), target — вероятности. Reduction: \"batchmean\" для совместимости с формулой. Используется в VAE, дистилляции, когда нужно приблизить одно распределение к другому.<br><strong>Когда использовать:</strong> дистилляция моделей, VAE.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-pytorch-nn-kldivloss-e-154-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-pytorch-nn-kldivloss-e-154-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-pytorch-nn-kldivloss-e-154-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"PT_G + 'torch.nn.KLDivLoss.html'\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
        "initialCode": "import torch\nimport torch.nn as nn\nprint(nn.KLDivLoss())",
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Binary Cross Entropy: бинарная классификация. Вход — вероятности (после sigmoid), форма [N, 1] или [N]; target — 0 или 1, та же форма. Значения входа должны быть в (0, 1), иначе градиенты нестабильны.</div><div style='background-color: #1e293b; border-left: 4px solid #f59e0b; padding: 15px; margin: 20px 0; border-radius: 4px;'><h4 style='margin: 0 0 10px 0; color: #fcd34d;'>💡 Нюансы и параметры:</h4><p style='margin: 0; font-size: 0.95rem; color: #cbd5e1;'>Параметры: weight, reduction.<br><strong>Нюанс:</strong> чаще используют BCEWithLogitsLoss — он объединяет sigmoid и BCE и численно стабильнее.</p></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-pytorch-nn-bceloss-e-155-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-pytorch-nn-bceloss-e-155-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-pytorch-nn-bceloss-e-155-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"PT_G + 'torch.nn.BCELoss.html'\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
        "initialCode": "import torch\nimport torch.nn as nn\nprint(nn.BCELoss())",
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>BCE + Sigmoid в одном классе. Вход — сырые логиты (без sigmoid), target — 0 или 1. Внутри применяется sigmoid; реализация устойчива к переполнению. Рекомендуется вместо ручного sigmoid + BCELoss.</div><div style='background-color: #1e293b; border-left: 4px solid #f59e0b; padding: 15px; margin: 20px 0; border-radius: 4px;'><h4 style='margin: 0 0 10px 0; color: #fcd34d;'>💡 Нюансы и параметры:</h4><p style='margin: 0; font-size: 0.95rem; color: #cbd5e1;'>Параметры: pos_weight (для несбалансированных классов), reduction.<br><strong>Пример:</strong> бинарная классификация (да/нет, есть объект/нет).</p></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-pytorch-nn-bcewithlogitsloss-e-156-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-pytorch-nn-bcewithlogitsloss-e-156-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-pytorch-nn-bcewithlogitsloss-e-156-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"PT_G + 'torch.nn.BCEWithLogitsLoss.html'\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
      ...
      {
        "type": "runnable",
        "initialCode": "import torch\nimport torch.nn as nn\n\n# Практическое применение в пайплайне\nprint('Запуск: nn.BCEWithLogitsLoss')\ntry:\n    # Инкапсулируем в функцию\n    def process_data():\n        val = nn.BCEWithLogitsLoss()\n        return val\n    \n    out = process_data()\n    print('Успешное выполнение. Тип:', type(out))\nexcept Exception as e:\n    print('Ошибка выполнения:', e)",
        "solution": "",
        "hints": [],
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Ranking: на входе два тензора x1, x2 и метки target (1 или −1). Loss поощряет: если target=1, то x1 > x2; если −1, то x1 < x2. Используется в рекомендациях, ранжировании.<br><strong>Когда использовать:</strong> learning to rank, рекомендации.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-pytorch-nn-marginrankingloss-e-157-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-pytorch-nn-marginrankingloss-e-157-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-pytorch-nn-marginrankingloss-e-157-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"PT_G + 'torch.nn.MarginRankingLoss.html'\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
      ...
      {
        "type": "runnable",
        "initialCode": "import torch\nimport torch.nn as nn\n\n# Практическое применение в пайплайне\nprint('Запуск: nn.MarginRankingLoss')\ntry:\n    # Инкапсулируем в функцию\n    def process_data():\n        val = nn.MarginRankingLoss()\n        return val\n    \n    out = process_data()\n    print('Успешное выполнение. Тип:', type(out))\nexcept Exception as e:\n    print('Ошибка выполнения:', e)",
        "solution": "",
        "hints": [],
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Для меток ±1: если target=1, loss = max(0, margin − x); если −1, loss = max(0, x). Параметр margin по умолчанию 1. Используется в метрическом обучении, эмбеддингах.<br><strong>Когда использовать:</strong> когда нужны эмбеддинги с большим отступом между классами.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-pytorch-nn-hingeembeddingloss-e-158-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-pytorch-nn-hingeembeddingloss-e-158-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-pytorch-nn-hingeembeddingloss-e-158-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"PT_G + 'torch.nn.HingeEmbeddingLoss.html'\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
      ...
      {
        "type": "runnable",
        "initialCode": "import torch\nimport torch.nn as nn\n\n# Практическое применение в пайплайне\nprint('Запуск: nn.HingeEmbeddingLoss')\ntry:\n    # Инкапсулируем в функцию\n    def process_data():\n        val = nn.HingeEmbeddingLoss()\n        return val\n    \n    out = process_data()\n    print('Успешное выполнение. Тип:', type(out))\nexcept Exception as e:\n    print('Ошибка выполнения:', e)",
        "solution": "",
        "hints": [],
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Multi-label классификация с margin: у одного объекта может быть несколько правильных классов. Вход — 2D тензор, target — индексы правильных классов (не one-hot). Специфичный формат target; см. документацию.<br><strong>Когда использовать:</strong> несколько меток на объект (теги, категории).</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-pytorch-nn-multilabelmarginloss-e-159-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-pytorch-nn-multilabelmarginloss-e-159-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-pytorch-nn-multilabelmarginloss-e-159-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"PT_G + 'torch.nn.MultiLabelMarginLoss.html'\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
      ...
      {
        "type": "runnable",
        "initialCode": "import torch\nimport torch.nn as nn\n\n# Практическое применение в пайплайне\nprint('Запуск: nn.MultiLabelMarginLoss')\ntry:\n    # Инкапсулируем в функцию\n    def process_data():\n        val = nn.MultiLabelMarginLoss()\n        return val\n    \n    out = process_data()\n    print('Успешное выполнение. Тип:', type(out))\nexcept Exception as e:\n    print('Ошибка выполнения:', e)",
        "solution": "",
        "hints": [],
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Гибрид L2 и L1: при малой ошибке ведёт себя как квадрат (гладко), при большой — как модуль (устойчиво к выбросам). Параметр delta задаёт порог перехода. Регрессия. Хорош когда в данных есть выбросы.<br><strong>Когда использовать:</strong> регрессия с зашумлёнными или выбросными данными.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-pytorch-nn-huberloss-e-160-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-pytorch-nn-huberloss-e-160-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-pytorch-nn-huberloss-e-160-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"PT_G + 'torch.nn.HuberLoss.html'\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
        "initialCode": "import torch\nimport torch.nn as nn\nprint(nn.HuberLoss())",
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Похож на Huber: при |error| < beta — квадратичная часть, иначе линейная. Регрессия, устойчивость к выбросам. Параметр beta (по умолчанию 1). Часто используется в детекции объектов (bounding box regression).<br><strong>Когда использовать:</strong> регрессия координат, боксов.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-pytorch-nn-smoothl1loss-e-161-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-pytorch-nn-smoothl1loss-e-161-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-pytorch-nn-smoothl1loss-e-161-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"PT_G + 'torch.nn.SmoothL1Loss.html'\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Двухклассовый логистический loss. Метки target: +1 или −1. Вход — один тензор (разность или оценка). Реже используется чем BCEWithLogitsLoss.<br><strong>Когда использовать:</strong> бинарная классификация с метками ±1.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-pytorch-nn-softmarginloss-e-162-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-pytorch-nn-softmarginloss-e-162-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-pytorch-nn-softmarginloss-e-162-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"PT_G + 'torch.nn.SoftMarginLoss.html'\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
      ...
      {
        "type": "runnable",
        "initialCode": "import torch\nimport torch.nn as nn\n\n# Практическое применение в пайплайне\nprint('Запуск: nn.SoftMarginLoss')\ntry:\n    # Инкапсулируем в функцию\n    def process_data():\n        val = nn.SoftMarginLoss()\n        return val\n    \n    out = process_data()\n    print('Успешное выполнение. Тип:', type(out))\nexcept Exception as e:\n    print('Ошибка выполнения:', e)",
        "solution": "",
        "hints": [],
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Multi-label классификация: для каждого класса своя бинарная задача (one-vs-rest). Вход — логиты [N, C], target — бинарная матрица [N, C] (0 или 1).</div><div style='background-color: #1e293b; border-left: 4px solid #f59e0b; padding: 15px; margin: 20px 0; border-radius: 4px;'><h4 style='margin: 0 0 10px 0; color: #fcd34d;'>💡 Нюансы и параметры:</h4><p style='margin: 0; font-size: 0.95rem; color: #cbd5e1;'>Параметры: weight, reduction.<br><strong>Когда использовать:</strong> несколько независимых меток на объект.</p></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-pytorch-nn-multilabelsoftmarginloss-e-163-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-pytorch-nn-multilabelsoftmarginloss-e-163-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-pytorch-nn-multilabelsoftmarginloss-e-163-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"PT_G + 'torch.nn.MultiLabelSoftMarginLoss.html'\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
      ...
      {
        "type": "runnable",
        "initialCode": "import torch\nimport torch.nn as nn\n\n# Практическое применение в пайплайне\nprint('Запуск: nn.MultiLabelSoftMarginLoss')\ntry:\n    # Инкапсулируем в функцию\n    def process_data():\n        val = nn.MultiLabelSoftMarginLoss()\n        return val\n    \n    out = process_data()\n    print('Успешное выполнение. Тип:', type(out))\nexcept Exception as e:\n    print('Ошибка выполнения:', e)",
        "solution": "",
        "hints": [],
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Измеряет косинусное сходство между векторами x1 и x2. Target: 1 — векторы должны быть похожи, −1 — различаться. Параметр margin. Используется в эмбеддингах, сравнении пар.<br><strong>Когда использовать:</strong> сходство текстов/изображений, siamese сети.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-pytorch-nn-cosineembeddingloss-e-164-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-pytorch-nn-cosineembeddingloss-e-164-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-pytorch-nn-cosineembeddingloss-e-164-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"PT_G + 'torch.nn.CosineEmbeddingLoss.html'\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
      ...
      {
        "type": "runnable",
        "initialCode": "import torch\nimport torch.nn as nn\n\n# Практическое применение в пайплайне\nprint('Запуск: nn.CosineEmbeddingLoss')\ntry:\n    # Инкапсулируем в функцию\n    def process_data():\n        val = nn.CosineEmbeddingLoss()\n        return val\n    \n    out = process_data()\n    print('Успешное выполнение. Тип:', type(out))\nexcept Exception as e:\n    print('Ошибка выполнения:', e)",
        "solution": "",
        "hints": [],
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Multi-class hinge (margin) loss. Вход — сырые оценки [N, C], target — индексы классов [N]. Штрафует правильный класс, если его оценка не больше остальных на margin.</div><div style='background-color: #1e293b; border-left: 4px solid #f59e0b; padding: 15px; margin: 20px 0; border-radius: 4px;'><h4 style='margin: 0 0 10px 0; color: #fcd34d;'>💡 Нюансы и параметры:</h4><p style='margin: 0; font-size: 0.95rem; color: #cbd5e1;'>Параметры: p (норма), margin, weight.<br><strong>Когда использовать:</strong> многоклассовая классификация с margin (альтернатива CrossEntropy).</p></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-pytorch-nn-multimarginloss-e-165-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-pytorch-nn-multimarginloss-e-165-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-pytorch-nn-multimarginloss-e-165-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"PT_G + 'torch.nn.MultiMarginLoss.html'\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
      ...
      {
        "type": "runnable",
        "initialCode": "import torch\nimport torch.nn as nn\n\n# Практическое применение в пайплайне\nprint('Запуск: nn.MultiMarginLoss')\ntry:\n    # Инкапсулируем в функцию\n    def process_data():\n        val = nn.MultiMarginLoss()\n        return val\n    \n    out = process_data()\n    print('Успешное выполнение. Тип:', type(out))\nexcept Exception as e:\n    print('Ошибка выполнения:', e)",
        "solution": "",
        "hints": [],
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Triplet loss: на входе anchor, positive (того же класса), negative (другого класса). Цель — чтобы расстояние(anchor, positive) + margin < distance(anchor, negative). Используется в face recognition, метрическом обучении.</div><div style='background-color: #1e293b; border-left: 4px solid #f59e0b; padding: 15px; margin: 20px 0; border-radius: 4px;'><h4 style='margin: 0 0 10px 0; color: #fcd34d;'>💡 Нюансы и параметры:</h4><p style='margin: 0; font-size: 0.95rem; color: #cbd5e1;'>Параметры: margin, p (норма), swap.<br><strong>Когда использовать:</strong> эмбеддинги лиц, поиск похожих объектов.</p></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-pytorch-nn-tripletmarginloss-e-166-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-pytorch-nn-tripletmarginloss-e-166-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-pytorch-nn-tripletmarginloss-e-166-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"PT_G + 'torch.nn.TripletMarginLoss.html'\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
      ...
      {
        "type": "runnable",
        "initialCode": "import torch\nimport torch.nn as nn\n\n# Практическое применение в пайплайне\nprint('Запуск: nn.TripletMarginLoss')\ntry:\n    # Инкапсулируем в функцию\n    def process_data():\n        val = nn.TripletMarginLoss()\n        return val\n    \n    out = process_data()\n    print('Успешное выполнение. Тип:', type(out))\nexcept Exception as e:\n    print('Ошибка выполнения:', e)",
        "solution": "",
        "hints": [],
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Тот же triplet, но функцию расстояния можно задать своей (distance_function). По умолчанию — Lp. Гибкость для кастомных метрик.<br><strong>Когда использовать:</strong> когда нужно своё расстояние в triplet loss.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-pytorch-nn-tripletmarginwithdistanceloss-e-167-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-pytorch-nn-tripletmarginwithdistanceloss-e-167-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-pytorch-nn-tripletmarginwithdistanceloss-e-167-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"PT_G + 'torch.nn.TripletMarginWithDistanceLoss.html'\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
      ...
      {
        "type": "runnable",
        "initialCode": "import torch\nimport torch.nn as nn\n\n# Практическое применение в пайплайне\nprint('Запуск: nn.TripletMarginWithDistanceLoss')\ntry:\n    # Инкапсулируем в функцию\n    def process_data():\n        val = nn.TripletMarginWithDistanceLoss()\n        return val\n    \n    out = process_data()\n    print('Успешное выполнение. Тип:', type(out))\nexcept Exception as e:\n    print('Ошибка выполнения:', e)",
        "solution": "",
        "hints": [],
  ...
  },
  {
    ...
    "codeBlocks": [
      ...
      {
        "type": "runnable",
        "initialCode": "import torch\nimport torch.nn as nn\n\n# Практическое применение в пайплайне\nprint('Запуск: torch.optim.SGD')\ntry:\n    # Инкапсулируем в функцию\n    def process_data():\n        val = torch.optim.SGD(params, lr, momentum=0, weight_decay=0)\n        return val\n    \n    out = process_data()\n    print('Успешное выполнение. Тип:', type(out))\nexcept Exception as e:\n    print('Ошибка выполнения:', e)",
        "solution": "",
        "hints": [],
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Adam: адаптивный learning rate для каждого параметра (момент первого и второго порядка).</div><div style='background-color: #1e293b; border-left: 4px solid #f59e0b; padding: 15px; margin: 20px 0; border-radius: 4px;'><h4 style='margin: 0 0 10px 0; color: #fcd34d;'>💡 Нюансы и параметры:</h4><p style='margin: 0; font-size: 0.95rem; color: #cbd5e1;'>Параметры: lr (часто 1e-3), betas — коэффициенты для моментов, eps — для численной стабильности. Обычно хорошо работает \"из коробки\", не требует тонкой настройки lr. Минус: часто хуже обобщает чем SGD+momentum при долгом обучении.<br><strong>Когда использовать:</strong> по умолчанию для многих задач (NLP, GAN, быстрый прототип).</p></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-pytorch-torch-optim-adam-e-169-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-pytorch-torch-optim-adam-e-169-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-pytorch-torch-optim-adam-e-169-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"PT_G + 'torch.optim.Adam.html'\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
      ...
      {
        "type": "runnable",
        "initialCode": "import torch\nimport torch.nn as nn\n\n# Практическое применение в пайплайне\nprint('Запуск: torch.optim.Adam')\ntry:\n    # Инкапсулируем в функцию\n    def process_data():\n        val = torch.optim.Adam(params, lr=1e-3, betas=(0.9, 0.999))\n        return val\n    \n    out = process_data()\n    print('Успешное выполнение. Тип:', type(out))\nexcept Exception as e:\n    print('Ошибка выполнения:', e)",
        "solution": "",
        "hints": [],
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Adam с decoupled weight decay: weight decay применяется к весам отдельно от градиента (как в оригинальной статье), а не через L2 в градиенте.</div><div style='background-color: #1e293b; border-left: 4px solid #f59e0b; padding: 15px; margin: 20px 0; border-radius: 4px;'><h4 style='margin: 0 0 10px 0; color: #fcd34d;'>💡 Нюансы и параметры:</h4><p style='margin: 0; font-size: 0.95rem; color: #cbd5e1;'>Параметры: lr, betas, eps, weight_decay. Рекомендуется вместо Adam + L2-регуляризации.<br><strong>Когда использовать:</strong> трансформеры, когда нужна сильная регуляризация весов.</p></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-pytorch-torch-optim-adamw-e-170-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-pytorch-torch-optim-adamw-e-170-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-pytorch-torch-optim-adamw-e-170-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"PT_G + 'torch.optim.AdamW.html'\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
      ...
      {
        "type": "runnable",
        "initialCode": "import torch\nimport torch.nn as nn\n\n# Практическое применение в пайплайне\nprint('Запуск: torch.optim.AdamW')\ntry:\n    # Инкапсулируем в функцию\n    def process_data():\n        val = torch.optim.AdamW(params, lr=1e-3)\n        return val\n    \n    out = process_data()\n    print('Успешное выполнение. Тип:', type(out))\nexcept Exception as e:\n    print('Ошибка выполнения:', e)",
        "solution": "",
        "hints": [],
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Adagrad: уменьшает lr для параметров с большей историей градиентов.</div><div style='background-color: #1e293b; border-left: 4px solid #f59e0b; padding: 15px; margin: 20px 0; border-radius: 4px;'><h4 style='margin: 0 0 10px 0; color: #fcd34d;'>💡 Нюансы и параметры:</h4><p style='margin: 0; font-size: 0.95rem; color: #cbd5e1;'>Параметры: lr, lr_decay, eps. Подходит для разрежённых данных (NLP); для плотных данных часто lr падает слишком сильно.<br><strong>Когда использовать:</strong> разрежённые градиенты, рекомендации.</p></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-pytorch-torch-optim-adagrad-e-171-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-pytorch-torch-optim-adagrad-e-171-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-pytorch-torch-optim-adagrad-e-171-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"PT_G + 'torch.optim.Adagrad.html'\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
      ...
      {
        "type": "runnable",
        "initialCode": "import torch\nimport torch.nn as nn\n\n# Практическое применение в пайплайне\nprint('Запуск: torch.optim.Adagrad')\ntry:\n    # Инкапсулируем в функцию\n    def process_data():\n        val = torch.optim.Adagrad(params, lr=1e-2)\n        return val\n    \n    out = process_data()\n    print('Успешное выполнение. Тип:', type(out))\nexcept Exception as e:\n    print('Ошибка выполнения:', e)",
        "solution": "",
        "hints": [],
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Adadelta: адаптивный lr без явного задания learning rate (используется скользящее среднее градиентов и обновлений).</div><div style='background-color: #1e293b; border-left: 4px solid #f59e0b; padding: 15px; margin: 20px 0; border-radius: 4px;'><h4 style='margin: 0 0 10px 0; color: #fcd34d;'>💡 Нюансы и параметры:</h4><p style='margin: 0; font-size: 0.95rem; color: #cbd5e1;'>Параметры: rho, eps. Редко используется в глубоком обучении.<br><strong>Когда использовать:</strong> когда не хотите задавать lr вручную (но на практике lr всё равно подбирают).</p></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-pytorch-torch-optim-adadelta-e-172-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-pytorch-torch-optim-adadelta-e-172-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-pytorch-torch-optim-adadelta-e-172-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"PT_G + 'torch.optim.Adadelta.html'\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
      ...
      {
        "type": "runnable",
        "initialCode": "import torch\nimport torch.nn as nn\n\n# Практическое применение в пайплайне\nprint('Запуск: torch.optim.Adadelta')\ntry:\n    # Инкапсулируем в функцию\n    def process_data():\n        val = torch.optim.Adadelta(params, lr=1.0, rho=0.9)\n        return val\n    \n    out = process_data()\n    print('Успешное выполнение. Тип:', type(out))\nexcept Exception as e:\n    print('Ошибка выполнения:', e)",
        "solution": "",
        "hints": [],
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>RMSprop: скользящее среднее квадратов градиентов; lr делится на корень из этого среднего.</div><div style='background-color: #1e293b; border-left: 4px solid #f59e0b; padding: 15px; margin: 20px 0; border-radius: 4px;'><h4 style='margin: 0 0 10px 0; color: #fcd34d;'>💡 Нюансы и параметры:</h4><p style='margin: 0; font-size: 0.95rem; color: #cbd5e1;'>Параметры: lr, alpha (затухание), eps. Популярен в reinforcement learning; основа для Adam.<br><strong>Когда использовать:</strong> RL, RNN; иногда как замена Adam.</p></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-pytorch-torch-optim-rmsprop-e-173-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-pytorch-torch-optim-rmsprop-e-173-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-pytorch-torch-optim-rmsprop-e-173-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"PT_G + 'torch.optim.RMSprop.html'\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
      ...
      {
        "type": "runnable",
        "initialCode": "import torch\nimport torch.nn as nn\n\n# Практическое применение в пайплайне\nprint('Запуск: torch.optim.RMSprop')\ntry:\n    # Инкапсулируем в функцию\n    def process_data():\n        val = torch.optim.RMSprop(params, lr=1e-2, alpha=0.99)\n        return val\n    \n    out = process_data()\n    print('Успешное выполнение. Тип:', type(out))\nexcept Exception as e:\n    print('Ошибка выполнения:', e)",
        "solution": "",
        "hints": [],
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Rprop: обновление только по знаку градиента; размер шага адаптируется отдельно. Работает только с батчем (не мини-батчем). В PyTorch редко используется.<br><strong>Когда использовать:</strong> полный батч, маленькие сети.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-pytorch-torch-optim-rprop-e-174-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-pytorch-torch-optim-rprop-e-174-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-pytorch-torch-optim-rprop-e-174-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"PT_G + 'torch.optim.Rprop.html'\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
      ...
      {
        "type": "runnable",
        "initialCode": "import torch\nimport torch.nn as nn\n\n# Практическое применение в пайплайне\nprint('Запуск: torch.optim.Rprop')\ntry:\n    # Инкапсулируем в функцию\n    def process_data():\n        val = torch.optim.Rprop(params, lr=1e-2)\n        return val\n    \n    out = process_data()\n    print('Успешное выполнение. Тип:', type(out))\nexcept Exception as e:\n    print('Ошибка выполнения:', e)",
        "solution": "",
        "hints": [],
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Adamax: вариант Adam на основе бесконечной нормы (max) вместо L2.</div><div style='background-color: #1e293b; border-left: 4px solid #f59e0b; padding: 15px; margin: 20px 0; border-radius: 4px;'><h4 style='margin: 0 0 10px 0; color: #fcd34d;'>💡 Нюансы и параметры:</h4><p style='margin: 0; font-size: 0.95rem; color: #cbd5e1;'>Параметры: lr, betas, eps. Иногда более стабилен при очень длинных последовательностях.<br><strong>Когда использовать:</strong> длинные последовательности, когда Adam нестабилен.</p></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-pytorch-torch-optim-adamax-e-175-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-pytorch-torch-optim-adamax-e-175-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-pytorch-torch-optim-adamax-e-175-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"PT_G + 'torch.optim.Adamax.html'\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
      ...
      {
        "type": "runnable",
        "initialCode": "import torch\nimport torch.nn as nn\n\n# Практическое применение в пайплайне\nprint('Запуск: torch.optim.Adamax')\ntry:\n    # Инкапсулируем в функцию\n    def process_data():\n        val = torch.optim.Adamax(params, lr=2e-3)\n        return val\n    \n    out = process_data()\n    print('Успешное выполнение. Тип:', type(out))\nexcept Exception as e:\n    print('Ошибка выполнения:', e)",
        "solution": "",
        "hints": [],
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Averaged SGD: усредняет параметры за последние итерации (скользящее среднее).</div><div style='background-color: #1e293b; border-left: 4px solid #f59e0b; padding: 15px; margin: 20px 0; border-radius: 4px;'><h4 style='margin: 0 0 10px 0; color: #fcd34d;'>💡 Нюансы и параметры:</h4><p style='margin: 0; font-size: 0.95rem; color: #cbd5e1;'>Параметры: lr, lambd, alpha. Может улучшить обобщение.<br><strong>Когда использовать:</strong> когда SGD сходится, но хочется более гладкого решения.</p></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-pytorch-torch-optim-asgd-e-176-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-pytorch-torch-optim-asgd-e-176-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-pytorch-torch-optim-asgd-e-176-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"PT_G + 'torch.optim.ASGD.html'\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
      ...
      {
        "type": "runnable",
        "initialCode": "import torch\nimport torch.nn as nn\n\n# Практическое применение в пайплайне\nprint('Запуск: torch.optim.ASGD')\ntry:\n    # Инкапсулируем в функцию\n    def process_data():\n        val = torch.optim.ASGD(params, lr=1e-2)\n        return val\n    \n    out = process_data()\n    print('Успешное выполнение. Тип:', type(out))\nexcept Exception as e:\n    print('Ошибка выполнения:', e)",
        "solution": "",
        "hints": [],
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>L-BFGS: квази-Ньютоновский метод. Требует многократного пересчёта loss в одном step — вы передаёте closure: step(closure), где closure() считает loss и backward(). Память растёт с числом итераций. Подходит для маленьких батчей и маленьких моделей.<br><strong>Когда использовать:</strong> стиль-трансфер, малые задачи; не для больших нейросетей.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-pytorch-torch-optim-lbfgs-e-177-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-pytorch-torch-optim-lbfgs-e-177-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-pytorch-torch-optim-lbfgs-e-177-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"PT_G + 'torch.optim.LBFGS.html'\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
      ...
      {
        "type": "runnable",
        "initialCode": "import torch\nimport torch.nn as nn\n\n# Практическое применение в пайплайне\nprint('Запуск: torch.optim.LBFGS')\ntry:\n    # Инкапсулируем в функцию\n    def process_data():\n        val = torch.optim.LBFGS(params, lr=1)\n        return val\n    \n    out = process_data()\n    print('Успешное выполнение. Тип:', type(out))\nexcept Exception as e:\n    print('Ошибка выполнения:', e)",
        "solution": "",
        "hints": [],
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>NAdam: Adam + Nesterov momentum (look-ahead).</div><div style='background-color: #1e293b; border-left: 4px solid #f59e0b; padding: 15px; margin: 20px 0; border-radius: 4px;'><h4 style='margin: 0 0 10px 0; color: #fcd34d;'>💡 Нюансы и параметры:</h4><p style='margin: 0; font-size: 0.95rem; color: #cbd5e1;'>Параметры: lr, betas, eps. Часто чуть быстрее сходится чем Adam.<br><strong>Когда использовать:</strong> альтернатива Adam с Nesterov.</p></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-pytorch-torch-optim-nadam-e-178-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-pytorch-torch-optim-nadam-e-178-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-pytorch-torch-optim-nadam-e-178-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"PT_G + 'torch.optim.NAdam.html'\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
      ...
      {
        "type": "runnable",
        "initialCode": "import torch\nimport torch.nn as nn\n\n# Практическое применение в пайплайне\nprint('Запуск: torch.optim.NAdam')\ntry:\n    # Инкапсулируем в функцию\n    def process_data():\n        val = torch.optim.NAdam(params, lr=2e-3)\n        return val\n    \n    out = process_data()\n    print('Успешное выполнение. Тип:', type(out))\nexcept Exception as e:\n    print('Ошибка выполнения:', e)",
        "solution": "",
        "hints": [],
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Rectified Adam: корректирует дисперсию в начале обучения (warmup по сути встроен).</div><div style='background-color: #1e293b; border-left: 4px solid #f59e0b; padding: 15px; margin: 20px 0; border-radius: 4px;'><h4 style='margin: 0 0 10px 0; color: #fcd34d;'>💡 Нюансы и параметры:</h4><p style='margin: 0; font-size: 0.95rem; color: #cbd5e1;'>Параметры: lr, betas, eps. Уменьшает необходимость в ручном warmup.<br><strong>Когда использовать:</strong> когда не хотите настраивать warmup вручную.</p></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-pytorch-torch-optim-radam-e-179-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-pytorch-torch-optim-radam-e-179-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-pytorch-torch-optim-radam-e-179-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"PT_G + 'torch.optim.RAdam.html'\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
      ...
      {
        "type": "runnable",
        "initialCode": "import torch\nimport torch.nn as nn\n\n# Практическое применение в пайплайне\nprint('Запуск: torch.optim.RAdam')\ntry:\n    # Инкапсулируем в функцию\n    def process_data():\n        val = torch.optim.RAdam(params, lr=1e-3)\n        return val\n    \n    out = process_data()\n    print('Успешное выполнение. Тип:', type(out))\nexcept Exception as e:\n    print('Ошибка выполнения:', e)",
        "solution": "",
        "hints": [],
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Adam для разрежённых градиентов: обновляет только те параметры, у которых градиент ненулевой. Экономит память и время при очень разрежённых обновлениях.<br><strong>Когда использовать:</strong> эмбеддинги с огромным словарём, разрежённые обновления.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-pytorch-torch-optim-sparseadam-e-180-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-pytorch-torch-optim-sparseadam-e-180-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-pytorch-torch-optim-sparseadam-e-180-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"PT_G + 'torch.optim.SparseAdam.html'\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
      ...
      {
        "type": "runnable",
        "initialCode": "import torch\nimport torch.nn as nn\n\n# Практическое применение в пайплайне\nprint('Запуск: torch.optim.SparseAdam')\ntry:\n    # Инкапсулируем в функцию\n    def process_data():\n        val = torch.optim.SparseAdam(params, lr=1e-3)\n        return val\n    \n    out = process_data()\n    print('Успешное выполнение. Тип:', type(out))\nexcept Exception as e:\n    print('Ошибка выполнения:', e)",
        "solution": "",
        "hints": [],
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Adafactor: адаптивный метод с меньшим числом гиперпараметров и меньшим потреблением памяти (моменты хранятся в факторизованном виде). Подходит для очень больших моделей.<br><strong>Когда использовать:</strong> большие трансформеры, нехватка памяти.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-pytorch-torch-optim-adafactor-e-181-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-pytorch-torch-optim-adafactor-e-181-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-pytorch-torch-optim-adafactor-e-181-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"PT_G + 'torch.optim.Adafactor.html'\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
      ...
      {
        "type": "runnable",
        "initialCode": "import torch\nimport torch.nn as nn\n\n# Практическое применение в пайплайне\nprint('Запуск: torch.optim.Adafactor')\ntry:\n    # Инкапсулируем в функцию\n    def process_data():\n        val = torch.optim.Adafactor(params)\n        return val\n    \n    out = process_data()\n    print('Успешное выполнение. Тип:', type(out))\nexcept Exception as e:\n    print('Ошибка выполнения:', e)",
        "solution": "",
        "hints": [],
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Muon: новый оптимизатор из PyTorch (на основе теории динамики).</div><div style='background-color: #1e293b; border-left: 4px solid #f59e0b; padding: 15px; margin: 20px 0; border-radius: 4px;'><h4 style='margin: 0 0 10px 0; color: #fcd34d;'>💡 Нюансы и параметры:</h4><p style='margin: 0; font-size: 0.95rem; color: #cbd5e1;'>Параметры: lr, momentum и др. Экспериментальный; см. актуальную документацию.<br><strong>Когда использовать:</strong> эксперименты, сравнение с Adam/SGD.</p></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-pytorch-torch-optim-muon-e-182-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-pytorch-torch-optim-muon-e-182-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-pytorch-torch-optim-muon-e-182-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"PT_G + 'torch.optim.Muon.html'\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
      ...
      {
        "type": "runnable",
        "initialCode": "import torch\nimport torch.nn as nn\n\n# Практическое применение в пайплайне\nprint('Запуск: torch.optim.Muon')\ntry:\n    # Инкапсулируем в функцию\n    def process_data():\n        val = torch.optim.Muon(params, lr=1e-3)\n        return val\n    \n    out = process_data()\n    print('Успешное выполнение. Тип:', type(out))\nexcept Exception as e:\n    print('Ошибка выполнения:', e)",
        "solution": "",
        "hints": [],
  ...
  },
  {
    ...
    "codeBlocks": [
      ...
      {
        "type": "runnable",
        "initialCode": "import torch\nimport torch.nn as nn\n\n# Практическое применение в пайплайне\nprint('Запуск: import torch\\nx = torch.tensor([1, 2, 3]')\ntry:\n    # Инкапсулируем в функцию\n    def process_data():\n        val = x.to(\"cuda\")  # на GPU\n        return val\n    \n    out = process_data()\n    print('Успешное выполнение. Тип:', type(out))\nexcept Exception as e:\n    print('Ошибка выполнения:', e)",
        "solution": "",
        "hints": [],
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Любая модель наследуется от nn.Module. В __init__ создаются слои (они автоматически регистрируются и их параметры попадут в model.parameters()). forward(x) — прямой проход: вы описываете, как из входа x получить выход. Вызов model(x) внутри вызывает forward(x). Не вызывайте forward вручную — только model(x). Параметры модели: model.parameters() передаётся в оптимизатор.<br><strong></div><div style='background-color: #1e293b; border-left: 4px solid #f59e0b; padding: 15px; margin: 20px 0; border-radius: 4px;'><h4 style='margin: 0 0 10px 0; color: #fcd34d;'>💡 Нюансы и параметры:</h4><p style='margin: 0; font-size: 0.95rem; color: #cbd5e1;'>Нюанс: </strong> в forward только прямой проход, без side effects; обратный проход делается через loss.backward().</p></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-pytorch-class-net-nn-module-n-def-init-e-184-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-pytorch-class-net-nn-module-n-def-init-e-184-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-pytorch-class-net-nn-module-n-def-init-e-184-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"PT_G + 'torch.nn.Module.html'\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
      ...
      {
        "type": "runnable",
        "initialCode": "import torch\nimport torch.nn as nn\n\n# Практическое применение в пайплайне\nprint('Запуск: class Net(nn.Module):\\n    def __init__(')\ntry:\n    # Инкапсулируем в функцию\n    def process_data():\n        val =         return self.fc(x)\n        return val\n    \n    out = process_data()\n    print('Успешное выполнение. Тип:', type(out))\nexcept Exception as e:\n    print('Ошибка выполнения:', e)",
        "solution": "",
        "hints": [],
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>nn.Linear(in_f, out_f): полносвязный слой, выход = x @ W + b; in_f/out_f — размер входа и выхода. nn.Conv2d(in_c, out_c, k): свёртка 2D; in_c/out_c — число каналов, k — размер ядра (число или (h,w)). nn.ReLU(): активация max(0, x), без параметров. Другие слои: nn.BatchNorm2d, nn.MaxPool2d, nn.Dropout. Полный список — в документации torch.nn.<br><strong>Пример:</strong> после свёрток форма (N, C, H, W); перед Linear нужно flatten: x.view(N, -1).</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-pytorch-nn-linear-e-185-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-pytorch-nn-linear-e-185-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-pytorch-nn-linear-e-185-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"https://pytorch.org/docs/stable/nn.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
  ...
  },
  {
    ...
    "codeBlocks": [
      ...
      {
        "type": "runnable",
        "initialCode": "import torch\nimport torch.nn as nn\n\n# Практическое применение в пайплайне\nprint('Запуск: optimizer.zero_grad')\ntry:\n    # Инкапсулируем в функцию\n    def process_data():\n        val = optimizer.step()        # обновить веса\n        return val\n    \n    out = process_data()\n    print('Успешное выполнение. Тип:', type(out))\nexcept Exception as e:\n    print('Ошибка выполнения:', e)",
        "solution": "",
        "hints": [],
  ...
  },
  {
    ...
    "codeBlocks": [
      ...
      {
        "type": "runnable",
        "initialCode": "import torch\nimport torch.nn as nn\n\n# Практическое применение в пайплайне\nprint('Запуск: from torch.utils.data import DataLoader\\')\ntry:\n    # Инкапсулируем в функцию\n    def process_data():\n        val = loader = DataLoader(dataset, batch_size=32, shuffle=True, num_workers=0)\n        return val\n    \n    out = process_data()\n    print('Успешное выполнение. Тип:', type(out))\nexcept Exception as e:\n    print('Ошибка выполнения:', e)",
        "solution": "",
        "hints": [],
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Базовые активации. ReLU(x) = max(0, x) — стандартная, но страдает от \"умирающих\" нейронов. LeakyReLU — пропускает небольшой градиент для x<0. ELU — сглаживает излом в нуле (улучшает сходимость, но чуть медленнее вычисляется).</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-pytorch-import-torch-nimport-torch-nn-as-nn-nx-e-188-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-pytorch-import-torch-nimport-torch-nn-as-nn-nx-e-188-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-pytorch-import-torch-nimport-torch-nn-as-nn-nx-e-188-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"https://pytorch.org/docs/stable/nn.html#non-linear-activations-weighted-sum-nonlinearity, true\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Современные гладкие активации (стандарт для трансформеров и глубоких CNN). SiLU (Swish): x * sigmoid(x), используется в YOLOv5/v8, EfficientNet. GELU: x * Phi(x), стандарт в BERT, GPT, ViT. Mish: x * tanh(softplus(x)), показывает отличные результаты в комп. зрении.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-pytorch-import-torch-nimport-torch-nn-as-nn-nx-e-189-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-pytorch-import-torch-nimport-torch-nn-as-nn-nx-e-189-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-pytorch-import-torch-nimport-torch-nn-as-nn-nx-e-189-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"https://pytorch.org/docs/stable/nn.html#non-linear-activations-weighted-sum-nonlinearity, true\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Ограничивающие активации. Sigmoid -> [0, 1] — для бинарной классификации (выходного слоя) или шлюзов (LSTM). Tanh -> [-1, 1] — центрирует данные, лучше сигмоиды для скрытых слоев. Softmax -> сумма=1 (распределение вероятностей по классам).</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-pytorch-import-torch-nimport-torch-nn-as-nn-nx-e-190-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-pytorch-import-torch-nimport-torch-nn-as-nn-nx-e-190-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-pytorch-import-torch-nimport-torch-nn-as-nn-nx-e-190-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"https://pytorch.org/docs/stable/nn.html#non-linear-activations-weighted-sum-nonlinearity, true\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
      ...
      {
        "type": "runnable",
        "initialCode": "import torch\nimport torch.nn as nn\n\n# Практическое применение в пайплайне\nprint('Запуск: import torch\\nimport torch.nn as nn\\nx =')\ntry:\n    # Инкапсулируем в функцию\n    def process_data():\n        val = print(\"Softmax:\", nn.Softmax(dim=1)(x))\n        return val\n    \n    out = process_data()\n    print('Успешное выполнение. Тип:', type(out))\nexcept Exception as e:\n    print('Ошибка выполнения:', e)",
        "solution": "",
        "hints": [],
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Стандартный цикл обучения в PyTorch. Обязательно model.train() перед эпохой (важно для Dropout/BatchNorm). Сначала zero_grad(), иначе градиенты будут накапливаться с предыдущего шага.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-pytorch-import-torch-nimport-torch-nn-as-nn-n-m-e-191-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-pytorch-import-torch-nimport-torch-nn-as-nn-n-m-e-191-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-pytorch-import-torch-nimport-torch-nn-as-nn-n-m-e-191-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"https://pytorch.org/docs/stable/optim.html, true\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
      ...
      {
        "type": "runnable",
        "initialCode": "import torch\nimport torch.nn as nn\n\n# Практическое применение в пайплайне\nprint('Запуск: import torch\\nimport torch.nn as nn\\n# m')\ntry:\n    # Инкапсулируем в функцию\n    def process_data():\n        val = print(\"training: zero_grad, forward, backward, step\")\n        return val\n    \n    out = process_data()\n    print('Успешное выполнение. Тип:', type(out))\nexcept Exception as e:\n    print('Ошибка выполнения:', e)",
        "solution": "",
        "hints": [],
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Стандартный цикл валидации или инференса. Обязательно torch.no_grad() — чтобы не тратить память на сохранение вычислительного графа. model.eval() переводит слои в режим тестирования.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-pytorch-import-torch-n-model-eval-e-192-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-pytorch-import-torch-n-model-eval-e-192-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-pytorch-import-torch-n-model-eval-e-192-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"https://pytorch.org/docs/stable/autograd.html, true\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
      ...
      {
        "type": "runnable",
        "initialCode": "import torch\nimport torch.nn as nn\n\n# Практическое применение в пайплайне\nprint('Запуск: import torch\\n# model.eval   # Отключа')\ntry:\n    # Инкапсулируем в функцию\n    def process_data():\n        val = print(\"validation: model.eval(), torch.no_grad()\")\n        return val\n    \n    out = process_data()\n    print('Успешное выполнение. Тип:', type(out))\nexcept Exception as e:\n    print('Ошибка выполнения:', e)",
        "solution": "",
        "hints": [],
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Свой класс Dataset. Нужно реализовать __len__ (сколько всего элементов) и __getitem__ (как получить элемент по индексу). Можно в __getitem__ читать картинки с диска, чтобы не грузить всё в ОЗУ.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-pytorch-import-torch-nfrom-torch-utils-data-impo-e-193-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-pytorch-import-torch-nfrom-torch-utils-data-impo-e-193-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-pytorch-import-torch-nfrom-torch-utils-data-impo-e-193-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"https://pytorch.org/docs/stable/data.html, true\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
      ...
      {
        "type": "runnable",
        "initialCode": "import torch\nimport torch.nn as nn\n\n# Практическое применение в пайплайне\nprint('Запуск: import torch\\nfrom torch.utils.data impo')\ntry:\n    # Инкапсулируем в функцию\n    def process_data():\n        val = print(\"Dataset: __init__, __len__, __getitem__\")\n        return val\n    \n    out = process_data()\n    print('Успешное выполнение. Тип:', type(out))\nexcept Exception as e:\n    print('Ошибка выполнения:', e)",
        "solution": "",
        "hints": [],
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>DataLoader — оборачивает Dataset и разбивает на батчи (куски данных). shuffle=True — перемешивание (для train). num_workers — загрузка данных в несколько потоков (параллельно).</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-pytorch-import-torch-nfrom-torch-utils-data-impo-e-194-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-pytorch-import-torch-nfrom-torch-utils-data-impo-e-194-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-pytorch-import-torch-nfrom-torch-utils-data-impo-e-194-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"https://pytorch.org/docs/stable/data.html, true\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
      ...
      {
        "type": "runnable",
        "initialCode": "import torch\nimport torch.nn as nn\n\n# Практическое применение в пайплайне\nprint('Запуск: import torch\\nfrom torch.utils.data impo')\ntry:\n    # Инкапсулируем в функцию\n    def process_data():\n        val = print(\"DataLoader: batch_size, shuffle, num_workers\")\n        return val\n    \n    out = process_data()\n    print('Успешное выполнение. Тип:', type(out))\nexcept Exception as e:\n    print('Ошибка выполнения:', e)",
        "solution": "",
        "hints": [],
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Предобработка картинок (torchvision). Аугментации (Flip, Crop, Rotation) только для train! ToTensor конвертирует PIL Image/numpy (H, W, C) [0..255] в тензор (C, H, W) [0..1]. Normalize вычитает среднее и делит на std.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-pytorch-import-torchvision-transforms-as-t-n-tr-e-195-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-pytorch-import-torchvision-transforms-as-t-n-tr-e-195-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-pytorch-import-torchvision-transforms-as-t-n-tr-e-195-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"https://pytorch.org/docs/stable/data.html, true\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
      ...
      {
        "type": "runnable",
        "initialCode": "import torch\nimport torch.nn as nn\n\n# Практическое применение в пайплайне\nprint('Запуск: import torchvision.transforms as T\\n# tr')\ntry:\n    # Инкапсулируем в функцию\n    def process_data():\n        val = print(\"Transforms: Resize, ToTensor, Normalize, Flip, Crop\")\n        return val\n    \n    out = process_data()\n    print('Успешное выполнение. Тип:', type(out))\nexcept Exception as e:\n    print('Ошибка выполнения:', e)",
        "solution": "",
        "hints": [],
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Простая свёрточная сеть (CNN). Conv2d(входы, выходы, ядро). MaxPool2d(2,2) уменьшает картинку в 2 раза по осям H,W. Перед Linear нужно сплющить (flatten) тензор с помощью .view(B, -1) или nn.Flatten.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-pytorch-import-torch-nimport-torch-nn-as-nn-ncla-e-196-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-pytorch-import-torch-nimport-torch-nn-as-nn-ncla-e-196-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-pytorch-import-torch-nimport-torch-nn-as-nn-ncla-e-196-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"https://pytorch.org/docs/stable/nn.html, true\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
      ...
      {
        "type": "runnable",
        "initialCode": "import torch\nimport torch.nn as nn\n\n# Практическое применение в пайплайне\nprint('Запуск: import torch\\nimport torch.nn as nn\\ncla')\ntry:\n    # Инкапсулируем в функцию\n    def process_data():\n        val =         return self.fc(x.view(x.size(0), -1)) # flatten\n        return val\n    \n    out = process_data()\n    print('Успешное выполнение. Тип:', type(out))\nexcept Exception as e:\n    print('Ошибка выполнения:', e)",
        "solution": "",
        "hints": [],
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Рекуррентные сети (RNN/GRU/LSTM). input_size — размер одного слова/шага. hidden_size — скрытое состояние. batch_first=True означает, что батч идёт первой осью (по умолчанию он второй!).</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-pytorch-import-torch-nimport-torch-nn-as-nn-n-l-e-197-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-pytorch-import-torch-nimport-torch-nn-as-nn-n-l-e-197-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-pytorch-import-torch-nimport-torch-nn-as-nn-n-l-e-197-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"https://pytorch.org/docs/stable/nn.html, true\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
      ...
      {
        "type": "runnable",
        "initialCode": "import torch\nimport torch.nn as nn\n\n# Практическое применение в пайплайне\nprint('Запуск: import torch\\nimport torch.nn as nn\\n# L')\ntry:\n    # Инкапсулируем в функцию\n    def process_data():\n        val = print(\"LSTM output:\", output.shape) # (3, 5, 20)\n        return val\n    \n    out = process_data()\n    print('Успешное выполнение. Тип:', type(out))\nexcept Exception as e:\n    print('Ошибка выполнения:', e)",
        "solution": "",
        "hints": [],
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Базовый трансформер (как в BERT). d_model — размер эмбеддинга. nhead — кол-во голов внимания. Работает с последовательностями параллельно (без рекуррентности), но требует Positional Encoding.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-pytorch-import-torch-nimport-torch-nn-as-nn-n-t-e-198-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-pytorch-import-torch-nimport-torch-nn-as-nn-n-t-e-198-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-pytorch-import-torch-nimport-torch-nn-as-nn-n-t-e-198-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"https://pytorch.org/docs/stable/nn.html, true\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
      ...
      {
        "type": "runnable",
        "initialCode": "import torch\nimport torch.nn as nn\n\n# Практическое применение в пайплайне\nprint('Запуск: import torch\\nimport torch.nn as nn\\n# T')\ntry:\n    # Инкапсулируем в функцию\n    def process_data():\n        val = print(\"TransformerEncoder out:\", out.shape)\n        return val\n    \n    out = process_data()\n    print('Успешное выполнение. Тип:', type(out))\nexcept Exception as e:\n    print('Ошибка выполнения:', e)",
        "solution": "",
        "hints": [],
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Использование предобученных сетей через torchvision. Загружаем веса ImageNet, замораживаем слои (при необходимости), меняем последний Linear/classifier слой под кол-во классов в датасете.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-pytorch-import-torch-nimport-torch-nn-as-nn-nimp-e-199-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-pytorch-import-torch-nimport-torch-nn-as-nn-nimp-e-199-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-pytorch-import-torch-nimport-torch-nn-as-nn-nimp-e-199-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"https://pytorch.org/docs/stable/hub.html, true\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
      ...
      {
        "type": "runnable",
        "initialCode": "import torch\nimport torch.nn as nn\n\n# Практическое применение в пайплайне\nprint('Запуск: import torch\\nimport torch.nn as nn\\nimp')\ntry:\n    # Инкапсулируем в функцию\n    def process_data():\n        val = print(\"models.resnet18(weights=DEFAULT), fine-tuning\")\n        return val\n    \n    out = process_data()\n    print('Успешное выполнение. Тип:', type(out))\nexcept Exception as e:\n    print('Ошибка выполнения:', e)",
        "solution": "",
        "hints": [],
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Перенос вычислений на видеокарту. И модель, и данные должны быть на одном устройстве. is_available() проверяет наличие драйверов NVIDIA (CUDA).</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-pytorch-import-torch-n-device-torch-device-c-e-200-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-pytorch-import-torch-n-device-torch-device-c-e-200-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-pytorch-import-torch-n-device-torch-device-c-e-200-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"https://pytorch.org/docs/stable/tensor_attributes.html#torch.torch.device, true\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Сохранение только весов (state_dict_). Не сохраняйте саму модель (torch.save(model)), так как это привяжет сохранение к структуре директорий и импортам. Перед инференсом обязательно model.eval().</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-pytorch-import-torch-n-torch-save-model-state-d-e-201-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-pytorch-import-torch-n-torch-save-model-state-d-e-201-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-pytorch-import-torch-n-torch-save-model-state-d-e-201-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"https://pytorch.org/docs/stable/notes/serialization.html, true\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
      ...
      {
        "type": "runnable",
        "initialCode": "import torch\nimport torch.nn as nn\n\n# Практическое применение в пайплайне\nprint('Запуск: import torch\\n# torch.save(model.state_d')\ntry:\n    # Инкапсулируем в функцию\n    def process_data():\n        val = print(\"save/load: state_dict(), model.pth\")\n        return val\n    \n    out = process_data()\n    print('Успешное выполнение. Тип:', type(out))\nexcept Exception as e:\n    print('Ошибка выполнения:', e)",
        "solution": "",
        "hints": [],
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>torch.cat — конкатенация по существующей оси. torch.stack — создаёт новую ось. cat по dim=0 — по строкам (как np.vstack). cat по dim=1 — по столбцам. stack — добавляет измерение.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-pytorch-import-torch-na-torch-tensor-1-2-3-e-202-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-pytorch-import-torch-na-torch-tensor-1-2-3-e-202-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-pytorch-import-torch-na-torch-tensor-1-2-3-e-202-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"PT_G + 'torch.cat.html', true\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
      ...
      {
        "type": "runnable",
        "initialCode": "import torch\nimport torch.nn as nn\n\n# Практическое применение в пайплайне\nprint('Запуск: import torch\\na = torch.tensor([[1,2],[3')\ntry:\n    # Инкапсулируем в функцию\n    def process_data():\n        val = print(\"stack:\", torch.stack([a,b]).shape)\n        return val\n    \n    out = process_data()\n    print('Успешное выполнение. Тип:', type(out))\nexcept Exception as e:\n    print('Ошибка выполнения:', e)",
        "solution": "",
        "hints": [],
  ...
  },
  {
    ...
    "codeBlocks": [
      ...
      {
        "type": "runnable",
        "initialCode": "import torch\nimport torch.nn as nn\n\n# Практическое применение в пайплайне\nprint('Запуск: import torch\\na = torch.tensor([1,2,3,4,')\ntry:\n    # Инкапсулируем в функцию\n    def process_data():\n        val = print(\"squeeze:\", a.unsqueeze(0).squeeze(0).shape)\n        return val\n    \n    out = process_data()\n    print('Успешное выполнение. Тип:', type(out))\nexcept Exception as e:\n    print('Ошибка выполнения:', e)",
        "solution": "",
        "hints": [],
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>max/min — максимум/минимум. argmax/argmin — индекс. topk(k) — k наибольших. clamp(min, max) — обрезка (как np.clip). abs, ceil, floor, round — привычные математические.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-pytorch-import-torch-na-torch-randn-3-3-npri-e-204-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-pytorch-import-torch-na-torch-randn-3-3-npri-e-204-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-pytorch-import-torch-na-torch-randn-3-3-npri-e-204-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"PT_G + 'torch.max.html', true\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
      ...
      {
        "type": "runnable",
        "initialCode": "import torch\nimport torch.nn as nn\n\n# Исследование свойств объекта\nresult = print(\"clamp:\", torch.clamp(a, min=-0.5, max=0.5))\nprint('Результат:', result)\nif hasattr(result, 'shape'):\n    print('Форма (shape):', result.shape)\nif hasattr(result, 'dtype'):\n    print('Тип данных:', result.dtype)",
        "solution": "",
        "hints": [],
      ...
      {
        "type": "runnable",
        "initialCode": "import torch\nimport torch.nn as nn\n\n# Практическое применение в пайплайне\nprint('Запуск: import torch\\na = torch.randn(3, 3)\\npri')\ntry:\n    # Инкапсулируем в функцию\n    def process_data():\n        val = print(\"clamp:\", torch.clamp(a, min=-0.5, max=0.5))\n        return val\n    \n    out = process_data()\n    print('Успешное выполнение. Тип:', type(out))\nexcept Exception as e:\n    print('Ошибка выполнения:', e)",
        "solution": "",
        "hints": [],
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Создание тензоров: zeros, ones, randn (нормальное), rand (равномерное [0,1]), arange, linspace, eye (единичная матрица), full(size, val), empty (без инициализации). _like — как другой тензор (zeros_like, randn_like).</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-pytorch-import-torch-nprint-zeros-torch-zero-e-206-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-pytorch-import-torch-nprint-zeros-torch-zero-e-206-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-pytorch-import-torch-nprint-zeros-torch-zero-e-206-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"PT_G + 'torch.zeros.html', true\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
      ...
      {
        "type": "runnable",
        "initialCode": "import torch\nimport torch.nn as nn\n\n# Практическое применение в пайплайне\nprint('Запуск: import torch\\nprint(\"zeros:\", torch.zero')\ntry:\n    # Инкапсулируем в функцию\n    def process_data():\n        val = print(\"eye:\", torch.eye(3).shape)\n        return val\n    \n    out = process_data()\n    print('Успешное выполнение. Тип:', type(out))\nexcept Exception as e:\n    print('Ошибка выполнения:', e)",
        "solution": "",
        "hints": [],
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Инициализация весов: xavier_uniform_ — для tanh/sigmoid. kaiming_normal_ — для ReLU. zeros_ — для bias. model.apply(fn) — применяет функцию рекурсивно ко всем подмодулям. Правильная инициализация ускоряет обучение.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-pytorch-import-torch-nimport-torch-nn-as-nn-n-n-e-207-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-pytorch-import-torch-nimport-torch-nn-as-nn-n-n-e-207-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-pytorch-import-torch-nimport-torch-nn-as-nn-n-n-e-207-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"https://pytorch.org/docs/stable/nn.init.html, true\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
      ...
      {
        "type": "runnable",
        "initialCode": "import torch\nimport torch.nn as nn\n\n# Практическое применение в пайплайне\nprint('Запуск: import torch\\nimport torch.nn as nn\\n\\n#')\ntry:\n    # Инкапсулируем в функцию\n    def process_data():\n        val = print(\"model.apply(fn) — рекурсивно ко всем модулям\")\n        return val\n    \n    out = process_data()\n    print('Успешное выполнение. Тип:', type(out))\nexcept Exception as e:\n    print('Ошибка выполнения:', e)",
        "solution": "",
        "hints": [],
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Mixed Precision Training — FP16 для прямого прохода (быстрее на GPU), FP32 для градиентов (точнее). autocast — автоматически выбирает точность. GradScaler — масштабирует loss для предотвращения underflow. Ускорение 2-3× на NVIDIA Tensor Cores.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-pytorch-import-torch-nimport-torch-nn-as-nn-n-n-e-208-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-pytorch-import-torch-nimport-torch-nn-as-nn-n-n-e-208-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-pytorch-import-torch-nimport-torch-nn-as-nn-n-n-e-208-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"https://pytorch.org/docs/stable/amp.html, true\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
      ...
      {
        "type": "runnable",
        "initialCode": "import torch\nimport torch.nn as nn\n\n# Практическое применение в пайплайне\nprint('Запуск: import torch\\nimport torch.nn as nn\\n\\n#')\ntry:\n    # Инкапсулируем в функцию\n    def process_data():\n        val = print(\"FP16 для forward, FP32 для backward\")\n        return val\n    \n    out = process_data()\n    print('Успешное выполнение. Тип:', type(out))\nexcept Exception as e:\n    print('Ошибка выполнения:', e)",
        "solution": "",
        "hints": [],
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Замораживание параметров: requires_grad = False — параметр не обновляется. named_parameters() — итерация с именами. Передавайте в optimizer только обучаемые. Для fine-tuning: заморозить всё кроме последних слоёв.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-pytorch-import-torch-nimport-torch-nn-as-nn-n-n-e-209-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-pytorch-import-torch-nimport-torch-nn-as-nn-n-n-e-209-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-pytorch-import-torch-nimport-torch-nn-as-nn-n-n-e-209-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"https://pytorch.org/docs/stable/autograd.html, true\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
      ...
      {
        "type": "runnable",
        "initialCode": "import torch\nimport torch.nn as nn\n\n# Практическое применение в пайплайне\nprint('Запуск: import torch\\nimport torch.nn as nn\\n\\n#')\ntry:\n    # Инкапсулируем в функцию\n    def process_data():\n        val = print(\"filter(requires_grad) в optimizer\")\n        return val\n    \n    out = process_data()\n    print('Успешное выполнение. Тип:', type(out))\nexcept Exception as e:\n    print('Ошибка выполнения:', e)",
        "solution": "",
        "hints": [],
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Early Stopping — останавливаем обучение если val_loss не улучшается patience эпох. Сохраняем лучшую модель. Предотвращает переобучение. В sklearn — через callbacks или вручную. В PyTorch — реализуется вручную (нет встроенного).</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-pytorch-import-torch-nimport-torch-nn-as-nn-n-n-e-210-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-pytorch-import-torch-nimport-torch-nn-as-nn-n-n-e-210-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-pytorch-import-torch-nimport-torch-nn-as-nn-n-n-e-210-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"https://pytorch.org/docs/stable/nn.html, true\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
      ...
      {
        "type": "runnable",
        "initialCode": "import torch\nimport torch.nn as nn\n\n# Практическое применение в пайплайне\nprint('Запуск: import torch\\nimport torch.nn as nn\\n\\n#')\ntry:\n    # Инкапсулируем в функцию\n    def process_data():\n        val = print(\"Early Stopping: patience, best_loss, save best\")\n        return val\n    \n    out = process_data()\n    print('Успешное выполнение. Тип:', type(out))\nexcept Exception as e:\n    print('Ошибка выполнения:', e)",
        "solution": "",
        "hints": [],
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>nn.Sequential — контейнер, вызывает слои по порядку. Для простых сетей. nn.ModuleList — список модулей (регистрирует параметры), но forward пишете сами. Для сложных архитектур (skip connections, разветвления). nn.ModuleDict — по именам.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-pytorch-import-torch-nimport-torch-nn-as-nn-n-n-e-211-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-pytorch-import-torch-nimport-torch-nn-as-nn-n-n-e-211-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-pytorch-import-torch-nimport-torch-nn-as-nn-n-n-e-211-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"https://pytorch.org/docs/stable/nn.html#containers, true\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
      ...
      {
        "type": "runnable",
        "initialCode": "import torch\nimport torch.nn as nn\n\n# Практическое применение в пайплайне\nprint('Запуск: import torch\\nimport torch.nn as nn\\n\\n#')\ntry:\n    # Инкапсулируем в функцию\n    def process_data():\n        val = print(\"ModuleList: ручное управление в forward\")\n        return val\n    \n    out = process_data()\n    print('Успешное выполнение. Тип:', type(out))\nexcept Exception as e:\n    print('Ошибка выполнения:', e)",
        "solution": "",
        "hints": [],
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Функциональный аналог torch.nn: те же операции, но как функции, без хранения состояния. Например F.relu(x), F.conv2d(x, weight), F.cross_entropy(logits, target). Удобно для разовых вызовов, кастомных forward (когда не нужен отдельный слой с параметрами) и когда параметры передаёте вручную. Не путать: nn.ReLU() — слой с параметрами (их нет у ReLU); F.relu() — просто функция. В forward часто пишут F.relu(self.fc(x)) вместо создания nn.ReLU() в __init__. Полный список функций: активации, свёртки, пулинг, loss, утилиты (pad, interpolate и т.д.).</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-pytorch-torch-nn-functional-f-e-213-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-pytorch-torch-nn-functional-f-e-213-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-pytorch-torch-nn-functional-f-e-213-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"https://pytorch.org/docs/stable/nn.functional.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
      ...
      {
        "type": "runnable",
        "initialCode": "import torch\nimport torch.nn as nn\n\n# Практическое применение в пайплайне\nprint('Запуск: torch.nn.functional (F)')\ntry:\n    # Инкапсулируем в функцию\n    def process_data():\n        val = torch.nn.functional (F)\n        return val\n    \n    out = process_data()\n    print('Успешное выполнение. Тип:', type(out))\nexcept Exception as e:\n    print('Ошибка выполнения:', e)",
        "solution": "",
        "hints": [],
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Атрибуты тензора: shape, stride, dtype, device, requires_grad, grad, is_leaf, grad_fn. Shape — размеры по осям; stride — шаги в памяти при движении по индексам. Views (виды) — тензоры, разделяющие память с исходным: view(), reshape() (иногда копия), transpose(), expand(), narrow(). Изменение view меняет исходный тензор. Для копии используйте .clone(). Документация по атрибутам и view-операциям помогает отлаживать форму и избегать лишних копий.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-pytorch-tensor-attributes-tensor-views-e-215-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-pytorch-tensor-attributes-tensor-views-e-215-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-pytorch-tensor-attributes-tensor-views-e-215-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"https://pytorch.org/docs/stable/tensor_view.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
      ...
      {
        "type": "runnable",
        "initialCode": "import torch\nimport torch.nn as nn\n\n# Практическое применение в пайплайне\nprint('Запуск: Tensor Attributes / Tensor Views')\ntry:\n    # Инкапсулируем в функцию\n    def process_data():\n        val = Tensor Attributes / Tensor Views\n        return val\n    \n    out = process_data()\n    print('Успешное выполнение. Тип:', type(out))\nexcept Exception as e:\n    print('Ошибка выполнения:', e)",
        "solution": "",
        "hints": [],
  ...
  },
  {
    ...
    "codeBlocks": [
      ...
      {
        "type": "runnable",
        "initialCode": "import torch\nimport torch.nn as nn\n\n# Практическое применение в пайплайне\nprint('Запуск: torch.amp (Automatic Mixed Precision)')\ntry:\n    # Инкапсулируем в функцию\n    def process_data():\n        val = torch.amp (Automatic Mixed Precision)\n        return val\n    \n    out = process_data()\n    print('Успешное выполнение. Тип:', type(out))\nexcept Exception as e:\n    print('Ошибка выполнения:', e)",
        "solution": "",
        "hints": [],
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Низкоуровневый API для регистрации пользовательских операторов (операций) в C++ и привязки их к PyTorch. Нужен для кастомных ядер, интеграции с другими библиотеками или оптимизации под железо. Новичку обычно не требуется; используется при расширении PyTorch или написании своих CUDA-операций.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-pytorch-torch-library-e-218-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-pytorch-torch-library-e-218-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-pytorch-torch-library-e-218-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"https://pytorch.org/docs/stable/library.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
        "initialCode": "import torch\nimport torch.nn as nn\nprint(torch.library)",
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Унифицированный API для выбора устройства (CPU, CUDA, MPS и т.д.): определение доступного устройства, перенос тензоров и моделей. Упрощает код, который должен работать на разных бэкендах без явных if cuda else cpu.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-pytorch-torch-accelerator-e-219-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-pytorch-torch-accelerator-e-219-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-pytorch-torch-accelerator-e-219-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"https://pytorch.org/docs/stable/accelerator.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
      ...
      {
        "type": "runnable",
        "initialCode": "import torch\nimport torch.nn as nn\n\n# Практическое применение в пайплайне\nprint('Запуск: torch.accelerator')\ntry:\n    # Инкапсулируем в функцию\n    def process_data():\n        val = torch.accelerator\n        return val\n    \n    out = process_data()\n    print('Успешное выполнение. Тип:', type(out))\nexcept Exception as e:\n    print('Ошибка выполнения:', e)",
        "solution": "",
        "hints": [],
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Бэкенды устройств. torch.cpu — операции на процессоре. torch.cuda — NVIDIA GPU: перенос тензоров и моделей на GPU, синхронизация (torch.cuda.synchronize()), управление памятью (empty_cache(), memory_allocated()). torch.mps — Apple Silicon (M1/M2) GPU. torch.xpu — Intel GPU. torch.mtia — Meta Training Inference Accelerator. Обычно используют device = torch.device(\"cuda\" if torch.cuda.is_available() else \"cpu\") и .to(device). Документация по каждому бэкенду: специфичные функции, лимиты, лучшие практики.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-pytorch-torch-cpu-torch-cuda-torch-mps-tor-e-220-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-pytorch-torch-cpu-torch-cuda-torch-mps-tor-e-220-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-pytorch-torch-cpu-torch-cuda-torch-mps-tor-e-220-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"https://pytorch.org/docs/stable/cuda.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
      ...
      {
        "type": "runnable",
        "initialCode": "import torch\nimport torch.nn as nn\n\n# Практическое применение в пайплайне\nprint('Запуск: torch.cpu / torch.cuda / torch.mps / tor')\ntry:\n    # Инкапсулируем в функцию\n    def process_data():\n        val = torch.cpu / torch.cuda / torch.mps / torch.xpu / torch.mtia\n        return val\n    \n    out = process_data()\n    print('Успешное выполнение. Тип:', type(out))\nexcept Exception as e:\n    print('Ошибка выполнения:', e)",
        "solution": "",
        "hints": [],
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Управление памятью GPU: память выделяется под тензоры автоматически; при нехватке — OOM. Функции: torch.cuda.empty_cache() — освободить кэш неиспользуемой памяти; memory_allocated(), max_memory_allocated() — статистика; set_per_process_memory_fraction() — лимит. Полезно при отладке OOM и при многопроцессном обучении. torch.mtia.memory — аналогично для MTIA.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-pytorch-torch-cuda-memory-torch-mtia-memory-e-221-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-pytorch-torch-cuda-memory-torch-mtia-memory-e-221-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-pytorch-torch-cuda-memory-torch-mtia-memory-e-221-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"https://pytorch.org/docs/stable/cuda.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
      ...
      {
        "type": "runnable",
        "initialCode": "import torch\nimport torch.nn as nn\n\n# Практическое применение в пайплайне\nprint('Запуск: torch.cuda.memory / torch.mtia.memory')\ntry:\n    # Инкапсулируем в функцию\n    def process_data():\n        val = torch.cuda.memory / torch.mtia.memory\n        return val\n    \n    out = process_data()\n    print('Успешное выполнение. Тип:', type(out))\nexcept Exception as e:\n    print('Ошибка выполнения:', e)",
        "solution": "",
        "hints": [],
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>«Мета»-устройство: тензоры без реальных данных, только форма и dtype. Нужно для быстрой проверки формы модели и подсчёта параметров без выделения памяти на GPU/CPU. Используется в больших моделях и при распределённой инициализации.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-pytorch-meta-device-e-222-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-pytorch-meta-device-e-222-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-pytorch-meta-device-e-222-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"https://pytorch.org/docs/stable/meta.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
        "initialCode": "import torch\nimport torch.nn as nn\nprint(Meta device)",
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Бэкенды для низкоуровневых библиотек: cuDNN (torch.backends.cudnn), CUDA (cuda), MPS, MKL и т.д. Настройки: cudnn.benchmark = True — авто-подбор быстрых алгоритмов свёртки (рекомендуется при фиксированном размере входа); cudnn.deterministic — воспроизводимость в ущерб скорости. Меняют глобальное поведение PyTorch на выбранном устройстве.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-pytorch-torch-backends-e-223-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-pytorch-torch-backends-e-223-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-pytorch-torch-backends-e-223-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"https://pytorch.org/docs/stable/backends.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Экспорт модели в формат вне PyTorch: ONNX, TorchScript, другие графы. export() строит граф из модели и примера входа; затем граф можно сохранить и запускать без Python (деплой на сервер, мобильные устройства). Связано с torch.onnx и torch.jit; документация описывает ограничения и поддерживаемые конструкции.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-pytorch-torch-export-e-224-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-pytorch-torch-export-e-224-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-pytorch-torch-export-e-224-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"https://pytorch.org/docs/stable/export.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
        "initialCode": "import torch\nimport torch.nn as nn\nprint(torch.export)",
  ...
  },
  {
    ...
    "codeBlocks": [
      ...
      {
        "type": "runnable",
        "initialCode": "import torch\nimport torch.nn as nn\n\n# Практическое применение в пайплайне\nprint('Запуск: torch.distributed')\ntry:\n    # Инкапсулируем в функцию\n    def process_data():\n        val = torch.distributed\n        return val\n    \n    out = process_data()\n    print('Успешное выполнение. Тип:', type(out))\nexcept Exception as e:\n    print('Ошибка выполнения:', e)",
        "solution": "",
        "hints": [],
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>FSDP (Fully Sharded Data Parallel): параметры модели разбиваются между процессами; каждый процесс хранит только свою часть. Позволяет обучать модели, не помещающиеся в память одного GPU. Альтернатива классическому DDP при огромном числе параметров. Требует понимания распределённого обучения.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-pytorch-torch-distributed-fsdp-fully-shard-e-226-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-pytorch-torch-distributed-fsdp-fully-shard-e-226-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-pytorch-torch-distributed-fsdp-fully-shard-e-226-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"https://pytorch.org/docs/stable/fsdp.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
      ...
      {
        "type": "runnable",
        "initialCode": "import torch\nimport torch.nn as nn\n\n# Практическое применение в пайплайне\nprint('Запуск: torch.distributed.fsdp / fully_shard')\ntry:\n    # Инкапсулируем в функцию\n    def process_data():\n        val = torch.distributed.fsdp / fully_shard\n        return val\n    \n    out = process_data()\n    print('Успешное выполнение. Тип:', type(out))\nexcept Exception as e:\n    print('Ошибка выполнения:', e)",
        "solution": "",
        "hints": [],
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Tensor parallel — разбиение вычислений слоёв между устройствами (например большая матрица умножается по частям). distributed.optim — оптимизаторы для распределённого сценария. checkpoint — сохранение/загрузка распределённого состояния. pipelining — pipeline parallelism: слои модели на разных устройствах, батчи проходят по конвейеру. Используется в очень больших моделях (сотни миллиардов параметров).</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-pytorch-torch-distributed-tensor-parallel-opti-e-227-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-pytorch-torch-distributed-tensor-parallel-opti-e-227-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-pytorch-torch-distributed-tensor-parallel-opti-e-227-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"https://pytorch.org/docs/stable/distributed.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
      ...
      {
        "type": "runnable",
        "initialCode": "import torch\nimport torch.nn as nn\n\n# Практическое применение в пайплайне\nprint('Запуск: torch.distributed.tensor.parallel / opti')\ntry:\n    # Инкапсулируем в функцию\n    def process_data():\n        val = torch.distributed.tensor.parallel / optim / checkpoint / pipelining\n        return val\n    \n    out = process_data()\n    print('Успешное выполнение. Тип:', type(out))\nexcept Exception as e:\n    print('Ошибка выполнения:', e)",
        "solution": "",
        "hints": [],
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Распределения вероятностей: Normal, Bernoulli, Categorical, Uniform, MultivariateNormal и многие другие. Методы: .sample(), .log_prob(x), .entropy(). Нужны для VAE, reinforcement learning (политики), байесовских моделей и любого кода, где явно работают с распределениями. Интеграция с autograd: градиенты по параметрам распределения.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-pytorch-torch-distributions-e-228-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-pytorch-torch-distributions-e-228-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-pytorch-torch-distributions-e-228-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"https://pytorch.org/docs/stable/distributions.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
      ...
      {
        "type": "runnable",
        "initialCode": "import torch\nimport torch.nn as nn\n\n# Практическое применение в пайплайне\nprint('Запуск: torch.distributions')\ntry:\n    # Инкапсулируем в функцию\n    def process_data():\n        val = torch.distributions\n        return val\n    \n    out = process_data()\n    print('Успешное выполнение. Тип:', type(out))\nexcept Exception as e:\n    print('Ошибка выполнения:', e)",
        "solution": "",
        "hints": [],
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Компилятор PyTorch 2: torch.compile(model) — JIT-компиляция модели в оптимизированный граф (TorchDynamo + индуктор). Значительно ускоряет обучение и инференс без изменения кода модели.</div><div style='background-color: #1e293b; border-left: 4px solid #f59e0b; padding: 15px; margin: 20px 0; border-radius: 4px;'><h4 style='margin: 0 0 10px 0; color: #fcd34d;'>💡 Нюансы и параметры:</h4><p style='margin: 0; font-size: 0.95rem; color: #cbd5e1;'>Параметры: mode (\"default\", \"reduce-overhead\", \"max-autotune\"), backend. Рекомендуется включать для новых проектов; некоторые конструкции пока не поддерживаются — смотреть предупреждения.</p></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-pytorch-torch-compiler-e-229-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-pytorch-torch-compiler-e-229-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-pytorch-torch-compiler-e-229-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"https://pytorch.org/docs/stable/compiler.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Быстрое преобразование Фурье: fft.fft(), fft.ifft(), fft.rfft() (для вещественных сигналов), fft.fft2() для 2D (изображения). Используется в обработке сигналов, спектральном анализе, некоторых слоях в нейросетях. Возвращает комплексные тензоры; для вещественного входа rfft экономит память.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-pytorch-torch-fft-e-230-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-pytorch-torch-fft-e-230-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-pytorch-torch-fft-e-230-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"https://pytorch.org/docs/stable/fft.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
        "initialCode": "import torch\nimport torch.nn as nn\nprint(torch.fft)",
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Функциональные трансформации: vmap (векторизация по дополнительному измерению), grad, jacrev/jacfwd (якобианы), hessian, checkpoint (экономия памяти). Удобно для кастомной логики с градиентами без явного цикла по батчу или для вторых производных. Замена части устаревшего torch.autograd.functional.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-pytorch-torch-func-e-231-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-pytorch-torch-func-e-231-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-pytorch-torch-func-e-231-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"https://pytorch.org/docs/stable/func.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
        "initialCode": "import torch\nimport torch.nn as nn\nprint(torch.func)",
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Асинхронные будущие результаты (Future): отложенное выполнение и получение результата позже. Используется внутри распределённого обучения и при асинхронных операциях. Новичку редко нужен.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-pytorch-torch-futures-e-232-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-pytorch-torch-futures-e-232-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-pytorch-torch-futures-e-232-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"https://pytorch.org/docs/stable/future.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
        "initialCode": "import torch\nimport torch.nn as nn\nprint(torch.futures)",
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Framework для трансформации графов моделей: трассировка nn.Module в граф (symbolic trace), замена/вставка узлов, вывод оптимизированного кода. Нужен для квантизации, кастомных компиляторов, анализа графа. Продвинутый инструмент; обычно не требуется на старте.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-pytorch-torch-fx-e-233-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-pytorch-torch-fx-e-233-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-pytorch-torch-fx-e-233-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"https://pytorch.org/docs/stable/fx.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
        "initialCode": "import torch\nimport torch.nn as nn\nprint(torch.fx)",
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Загрузка предобученных моделей и скриптов с репозитория (GitHub). torch.hub.load(\"pytorch/vision\", \"resnet18\", pretrained=True) — пример. Удобно для воспроизведения чужих моделей и быстрого прототипирования. Документация: список моделей, кэш, свои репозитории.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-pytorch-torch-hub-e-234-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-pytorch-torch-hub-e-234-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-pytorch-torch-hub-e-234-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"https://pytorch.org/docs/stable/hub.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
        "initialCode": "import torch\nimport torch.nn as nn\nprint(torch.hub)",
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>TorchScript: компиляция моделей в граф, независимый от Python, для деплоя (C++, мобильные устройства) и оптимизации. trace — запись графа по примеру входа; script — разбор кода с аннотациями. Ограничения: не весь Python поддерживается. Используется при экспорте в production.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-pytorch-torch-jit-e-235-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-pytorch-torch-jit-e-235-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-pytorch-torch-jit-e-235-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"https://pytorch.org/docs/stable/jit.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
        "initialCode": "import torch\nimport torch.nn as nn\nprint(torch.jit)",
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Линейная алгебра: решения систем (solve, lstsq), разложения (cholesky, svd, qr), нормы (norm), определитель, собственные значения. Аналог numpy.linalg с поддержкой GPU и autograd. Используется в моделях с матричными операциями и в научных расчётах.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-pytorch-torch-linalg-e-236-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-pytorch-torch-linalg-e-236-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-pytorch-torch-linalg-e-236-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"https://pytorch.org/docs/stable/linalg.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
        "initialCode": "import torch\nimport torch.nn as nn\nprint(torch.linalg)",
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Мониторинг событий обучения (логирование, метрики) через подписки. Для интеграции с внешними системами мониторинга.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-pytorch-torch-monitor-e-237-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-pytorch-torch-monitor-e-237-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-pytorch-torch-monitor-e-237-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"https://pytorch.org/docs/stable/monitor.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
        "initialCode": "import torch\nimport torch.nn as nn\nprint(torch.monitor)",
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Обработка сигналов: оконные функции, свёртки для сигналов, спектрограммы. Дополнение к torch.fft для задач аудио и одномерных сигналов.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-pytorch-torch-signal-e-238-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-pytorch-torch-signal-e-238-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-pytorch-torch-signal-e-238-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"https://pytorch.org/docs/stable/signal.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
        "initialCode": "import torch\nimport torch.nn as nn\nprint(torch.signal)",
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Специальные математические функции: гамма, бета, эрфи, логическая сумма (logsumexp) и т.д. Нужны в вероятностных моделях и некоторых формулах потерь.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-pytorch-torch-special-e-239-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-pytorch-torch-special-e-239-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-pytorch-torch-special-e-239-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"https://pytorch.org/docs/stable/special.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
        "initialCode": "import torch\nimport torch.nn as nn\nprint(torch.special)",
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Переопределение поведения встроенных функций PyTorch для своих типов тензоров (кастомные классы с __torch_function__). Продвинутое использование при разработке библиотек поверх PyTorch.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-pytorch-torch-overrides-e-240-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-pytorch-torch-overrides-e-240-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-pytorch-torch-overrides-e-240-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"https://pytorch.org/docs/stable/overrides.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Нативный рантайм для скомпилированных моделей (деплой без Python). Специфичная тема деплоя.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-pytorch-torch-nativert-e-241-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-pytorch-torch-nativert-e-241-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-pytorch-torch-nativert-e-241-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"https://pytorch.org/docs/stable/nativert.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Упаковка модели и зависимостей в один файл для переноса и деплоя. Альтернатива/дополнение к torch.save и TorchScript.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-pytorch-torch-package-e-242-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-pytorch-torch-package-e-242-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-pytorch-torch-package-e-242-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"https://pytorch.org/docs/stable/package.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
        "initialCode": "import torch\nimport torch.nn as nn\nprint(torch.package)",
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Профилирование: замер времени выполнения операций, использование памяти, узкие места. Контекст torch.profiler.profile() с schedule и on_trace_ready; экспорт в Chrome trace. Необходим при оптимизации скорости и памяти.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-pytorch-torch-profiler-e-243-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-pytorch-torch-profiler-e-243-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-pytorch-torch-profiler-e-243-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"https://pytorch.org/docs/stable/profiler.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Инициализация весов слоёв: init.xavier_uniform_(), init.kaiming_normal_(), init.orthogonal_() и др. Применяются к параметрам модели после создания; влияют на сходимость. По умолчанию многие слои уже имеют разумную инициализацию; кастомная нужна для нестандартных архитектур.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-pytorch-torch-nn-init-e-244-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-pytorch-torch-nn-init-e-244-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-pytorch-torch-nn-init-e-244-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"https://pytorch.org/docs/stable/nn.init.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
        "initialCode": "import torch\nimport torch.nn as nn\nprint(torch.nn.init)",
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Слои и утилиты для механизма внимания (attention): scaled dot-product, multihead и т.д. Используется в трансформерах. В документации — форматы входа/выхода и параметры (num_heads, dropout).</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-pytorch-torch-nn-attention-e-245-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-pytorch-torch-nn-attention-e-245-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-pytorch-torch-nn-attention-e-245-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"https://pytorch.org/docs/stable/nn.attention.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
      ...
      {
        "type": "runnable",
        "initialCode": "import torch\nimport torch.nn as nn\n\n# Практическое применение в пайплайне\nprint('Запуск: torch.nn.attention')\ntry:\n    # Инкапсулируем в функцию\n    def process_data():\n        val = torch.nn.attention\n        return val\n    \n    out = process_data()\n    print('Успешное выполнение. Тип:', type(out))\nexcept Exception as e:\n    print('Ошибка выполнения:', e)",
        "solution": "",
        "hints": [],
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Экспорт модели в формат ONNX для запуска в других фреймворках (ONNX Runtime, TensorRT и т.д.). torch.onnx.export(model, example_input, \"model.onnx\") — базовый вызов. Нужны при деплое вне PyTorch; некоторые операции требуют обходных путей или неподдерживаются.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-pytorch-torch-onnx-e-246-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-pytorch-torch-onnx-e-246-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-pytorch-torch-onnx-e-246-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"https://pytorch.org/docs/stable/onnx.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
        "initialCode": "import torch\nimport torch.nn as nn\nprint(torch.onnx)",
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Поддержка комплексных тензоров (dtype complex64, complex128): арифметика, fft, linalg. Нужно в физике, обработке сигналов и части моделей.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-pytorch-complex-numbers-e-247-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-pytorch-complex-numbers-e-247-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-pytorch-complex-numbers-e-247-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"https://pytorch.org/docs/stable/complex_numbers.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Хуки для кастомной логики синхронизации градиентов в DistributedDataParallel (сжатие, асинхронность и т.д.). Для продвинутой настройки распределённого обучения.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-pytorch-ddp-communication-hooks-e-248-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-pytorch-ddp-communication-hooks-e-248-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-pytorch-ddp-communication-hooks-e-248-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"https://pytorch.org/docs/stable/ddp.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
      ...
      {
        "type": "runnable",
        "initialCode": "import torch\nimport torch.nn as nn\n\n# Практическое применение в пайплайне\nprint('Запуск: DDP Communication Hooks')\ntry:\n    # Инкапсулируем в функцию\n    def process_data():\n        val = DDP Communication Hooks\n        return val\n    \n    out = process_data()\n    print('Успешное выполнение. Тип:', type(out))\nexcept Exception as e:\n    print('Ошибка выполнения:', e)",
        "solution": "",
        "hints": [],
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Квантизация весов и активаций (int8, float16 и др.) для ускорения и уменьшения размера модели на CPU/GPU. Динамическая, статическая и QAT (quantization-aware training). Важно для деплоя на edge и серверах; требует калибровки или дообучения.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-pytorch-quantization-e-249-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-pytorch-quantization-e-249-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-pytorch-quantization-e-249-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"https://pytorch.org/docs/stable/quantization.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
        "initialCode": "import torch\nimport torch.nn as nn\nprint(Quantization)",
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Удалённый вызов процедур (RPC) между процессами: запуск функций на других узлах, передача тензоров. Используется в сложных распределённых сценариях (например части модели на разных машинах).</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-pytorch-distributed-rpc-framework-e-250-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-pytorch-distributed-rpc-framework-e-250-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-pytorch-distributed-rpc-framework-e-250-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"https://pytorch.org/docs/stable/rpc.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
      ...
      {
        "type": "runnable",
        "initialCode": "import torch\nimport torch.nn as nn\n\n# Практическое применение в пайплайне\nprint('Запуск: Distributed RPC Framework')\ntry:\n    # Инкапсулируем в функцию\n    def process_data():\n        val = Distributed RPC Framework\n        return val\n    \n    out = process_data()\n    print('Успешное выполнение. Тип:', type(out))\nexcept Exception as e:\n    print('Ошибка выполнения:', e)",
        "solution": "",
        "hints": [],
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Генерация случайных чисел: torch.manual_seed(), torch.randn(), torch.randint() и т.д.; генераторы для воспроизводимости (torch.Generator). Документация по всем случайным функциям и лучшим практикам (установка seed на каждом процессе при DDP).</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-pytorch-torch-random-e-251-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-pytorch-torch-random-e-251-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-pytorch-torch-random-e-251-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"https://pytorch.org/docs/stable/random.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
        "initialCode": "import torch\nimport torch.nn as nn\nprint(torch.random)",
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Операции с масками: masked tensor (тензор с маской пропущенных/невалидных элементов). Для неравномерных последовательностей и пропусков без заполнения нулями.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-pytorch-torch-masked-e-252-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-pytorch-torch-masked-e-252-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-pytorch-torch-masked-e-252-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"https://pytorch.org/docs/stable/masked.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
        "initialCode": "import torch\nimport torch.nn as nn\nprint(torch.masked)",
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Вложенные тензоры (nested tensor): последовательности переменной длины в одном тензоре без паддинга. Экономия памяти и упрощение кода для NLP и аудио.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-pytorch-torch-nested-e-253-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-pytorch-torch-nested-e-253-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-pytorch-torch-nested-e-253-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"https://pytorch.org/docs/stable/nested.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
        "initialCode": "import torch\nimport torch.nn as nn\nprint(torch.nested)",
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Класс размера тензора: результат .shape, поддерживает индексацию и арифметику (например size[0] * size[1]). Используется при проверке форм и динамическом построении слоёв.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-pytorch-torch-size-e-254-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-pytorch-torch-size-e-254-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-pytorch-torch-size-e-254-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"https://pytorch.org/docs/stable/tensors.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
        "initialCode": "import torch\nimport torch.nn as nn\nprint(torch.Size)",
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Разрежённые тензоры: хранение только ненулевых элементов. Экономия памяти для графов, эмбеддингов с очень большим числом нулей. Операции: sparse_coo_tensor(), to_dense(); не все операции поддерживают sparse.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-pytorch-torch-sparse-e-255-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-pytorch-torch-sparse-e-255-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-pytorch-torch-sparse-e-255-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"https://pytorch.org/docs/stable/sparse.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
        "initialCode": "import torch\nimport torch.nn as nn\nprint(torch.sparse)",
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Низкоуровневое хранилище данных тензора (1D непрерывный буфер). Обычно не используется напрямую; нужно при работе с .data_ptr() или при написании своих расширений.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-pytorch-torch-storage-e-256-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-pytorch-torch-storage-e-256-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-pytorch-torch-storage-e-256-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"https://pytorch.org/docs/stable/storage.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
        "initialCode": "import torch\nimport torch.nn as nn\nprint(torch.Storage)",
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Утилиты для тестирования: сравнение тензоров (assert_close), проверка градиентов. Удобно в unit-тестах моделей и слоёв.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-pytorch-torch-testing-e-257-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-pytorch-torch-testing-e-257-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-pytorch-torch-testing-e-257-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"https://pytorch.org/docs/stable/testing.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
        "initialCode": "import torch\nimport torch.nn as nn\nprint(torch.testing)",
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Dataset, DataLoader, Sampler и подклассы. Dataset — абстракция датасета (__len__, __getitem__); DataLoader — батчи, shuffle, num_workers; IterableDataset для потоковых данных. Документация по кастомным датасетам, коллайтам (обработка батча) и многопроцессной загрузке.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-pytorch-torch-utils-data-e-258-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-pytorch-torch-utils-data-e-258-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-pytorch-torch-utils-data-e-258-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"https://pytorch.org/docs/stable/data.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
      ...
      {
        "type": "runnable",
        "initialCode": "import torch\nimport torch.nn as nn\n\n# Практическое применение в пайплайне\nprint('Запуск: torch.utils.data')\ntry:\n    # Инкапсулируем в функцию\n    def process_data():\n        val = torch.utils.data\n        return val\n    \n    out = process_data()\n    print('Успешное выполнение. Тип:', type(out))\nexcept Exception as e:\n    print('Ошибка выполнения:', e)",
        "solution": "",
        "hints": [],
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Gradient checkpointing: пересчёт активаций при backward вместо хранения. Сильно экономит память при обучении глубоких сетей; время обучения увеличивается. Используется когда модель не влезает в GPU.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-pytorch-torch-utils-checkpoint-e-259-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-pytorch-torch-utils-checkpoint-e-259-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-pytorch-torch-utils-checkpoint-e-259-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"https://pytorch.org/docs/stable/checkpoint.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
      ...
      {
        "type": "runnable",
        "initialCode": "import torch\nimport torch.nn as nn\n\n# Практическое применение в пайплайне\nprint('Запуск: torch.utils.checkpoint')\ntry:\n    # Инкапсулируем в функцию\n    def process_data():\n        val = torch.utils.checkpoint\n        return val\n    \n    out = process_data()\n    print('Успешное выполнение. Тип:', type(out))\nexcept Exception as e:\n    print('Ошибка выполнения:', e)",
        "solution": "",
        "hints": [],
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Интеграция с TensorBoard: логирование скаляров, графиков, изображений, гистограмм весов. Writer.add_scalar(), add_histogram() и т.д. Стандартный способ визуализации обучения.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-pytorch-torch-utils-tensorboard-e-260-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-pytorch-torch-utils-tensorboard-e-260-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-pytorch-torch-utils-tensorboard-e-260-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"https://pytorch.org/docs/stable/tensorboard.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
      ...
      {
        "type": "runnable",
        "initialCode": "import torch\nimport torch.nn as nn\n\n# Практическое применение в пайплайне\nprint('Запуск: torch.utils.tensorboard')\ntry:\n    # Инкапсулируем в функцию\n    def process_data():\n        val = torch.utils.tensorboard\n        return val\n    \n    out = process_data()\n    print('Успешное выполнение. Тип:', type(out))\nexcept Exception as e:\n    print('Ошибка выполнения:', e)",
        "solution": "",
        "hints": [],
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>benchmark — точный замер времени операций (Timer); collect_env — вывод информации о системе и версиях для отчётов об ошибках; flop_counter — подсчёт FLOP; cpp_extension — компиляция своих C++/CUDA расширений; deterministic — включение детерминированных алгоритмов для воспроизводимости. Утилиты для отладки, бенчмарков и расширения PyTorch.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-pytorch-torch-utils-benchmark-collect-env-fl-e-261-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-pytorch-torch-utils-benchmark-collect-env-fl-e-261-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-pytorch-torch-utils-benchmark-collect-env-fl-e-261-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"https://pytorch.org/docs/stable/utils.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
      ...
      {
        "type": "runnable",
        "initialCode": "import torch\nimport torch.nn as nn\n\n# Практическое применение в пайплайне\nprint('Запуск: torch.utils.benchmark / collect_env / fl')\ntry:\n    # Инкапсулируем в функцию\n    def process_data():\n        val = torch.utils.benchmark / collect_env / flop_counter / cpp_extension / deterministic\n        return val\n    \n    out = process_data()\n    print('Успешное выполнение. Тип:', type(out))\nexcept Exception as e:\n    print('Ошибка выполнения:', e)",
        "solution": "",
        "hints": [],
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Тензоры с именованными осями: например tensor(\"batch\", \"channel\", \"height\", \"width\"). Удобно для читаемости и уменьшения ошибок с порядком размерностей. Поддержка в операциях и постепенное расширение покрытия.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-pytorch-named-tensors-e-262-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-pytorch-named-tensors-e-262-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-pytorch-named-tensors-e-262-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"https://pytorch.org/docs/stable/named_tensor.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
        "initialCode": "import torch\nimport torch.nn as nn\nprint(Named Tensors)",
  ...
  },
  {
    ...
    "theory": "<div style='font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px;'>Type Info — аннотации типов для статической проверки. __config__ — информация о сборке PyTorch. Переменные окружения управляют поведением (CUDA_VISIBLE_DEVICES, TORCH_*, и т.д.). Документация по конфигурации и отладке окружения.</div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 1: Базовое использование</h4><div class='code-block-container' id='code-block-pytorch-type-info-torch-config-environme-e-263-code-1'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 2: Свойства и типы данных (shape, dtype)</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Проверка того, что именно возвращает функция и какие у объекта свойства.</p><div class='code-block-container' id='code-block-pytorch-type-info-torch-config-environme-e-263-code-2'></div><h4 style='margin-top:30px; border-bottom: 1px solid #334155; padding-bottom: 5px;'>Пример 3: Использование внутри функции / пайплайна</h4><p style='font-size: 0.9rem; color: #94a3b8; margin-bottom: 10px;'>Как эта команда обычно оборачивается в реальном коде.</p><div class='code-block-container' id='code-block-pytorch-type-info-torch-config-environme-e-263-code-3'></div><div style=\"margin-top:40px; padding-top: 20px; border-top: 2px solid #334155;\"><a href=\"https://pytorch.org/docs/stable/index.html\" target=\"_blank\" class=\"ref-link\" style=\"display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.2s;\">📖 Читать официальную документацию →</a></div>",
    "codeBlocks": [
      {
        "type": "runnable",
      ...
      {
        "type": "runnable",
        "initialCode": "import torch\nimport torch.nn as nn\n\n# Практическое применение в пайплайне\nprint('Запуск: Type Info / torch.__config__ / Environme')\ntry:\n    # Инкапсулируем в функцию\n    def process_data():\n        val = Type Info / torch.__config__ / Environment Variables\n        return val\n    \n    out = process_data()\n    print('Успешное выполнение. Тип:', type(out))\nexcept Exception as e:\n    print('Ошибка выполнения:', e)",
        "solution": "",
        "hints": [],
